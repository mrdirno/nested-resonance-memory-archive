...
Hypothesis:
  ...
  Reasoning: Sources provide base energy, recovery accelerates regeneration.
  Expected synergy > 0.1 (mechanisms reinforce survival)
...
Expected Outcomes:
  ...
  - ON-ON (both): mean ≈ 0.35 (synergistic amplification)

  Synergy = 0.35 - (0.07 + 0.05 + 0.08) = 0.15 (SYNERGISTIC)
