...
def run_generation():
    ...
    budget = random.uniform(1897.279452201823, 2845.9191783027345)
    gain_base = random.uniform(884.8226777761079, 1000.0)
    cost_base = random.uniform(2.1101837526229703, 2.5791134754280747)
    ...
    result = {
        ...
        "params_used": {"budget_range": [1897.279452201823, 2845.9191783027345], "gain_range": [884.8226777761079, 1000.0], "cost_range": [2.1101837526229703, 2.5791134754280747], "k": 0.4521598713923174, "epsilon": 0.4026574009126241, "complexity": 2}
    }
