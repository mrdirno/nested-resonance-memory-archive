...
def run_generation():
    ...
    budget = random.uniform(5709.247695876533, 8563.8715438148)
    gain_base = random.uniform(28.824155340690606, 35.22952319417741)
    cost_base = random.uniform(51.51091585451459, 62.957786044406724)
    ...
    result = {
        ...
        "params_used": {"budget_range": [5709.247695876533, 8563.8715438148], "gain_range": [28.824155340690606, 35.22952319417741], "cost_range": [51.51091585451459, 62.957786044406724], "k": 8.276252758266143, "epsilon": 0.7287758911871579, "complexity": 2}
    }
