...
def run_generation():
    ...
    budget = random.uniform(5440.995209638707, 8161.49281445806)
    gain_base = random.uniform(198.20347670067974, 242.24869374527523)
    cost_base = random.uniform(22.16410445084399, 27.08946099547599)
    ...
    result = {
        ...
        "params_used": {"budget_range": [5440.995209638707, 8161.49281445806], "gain_range": [198.20347670067974, 242.24869374527523], "cost_range": [22.16410445084399, 27.08946099547599], "k": 4.552964741471671, "epsilon": 0.5906564314487059, "complexity": 2}
    }
