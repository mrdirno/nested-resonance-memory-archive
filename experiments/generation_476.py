...
def run_generation():
    ...
    budget = random.uniform(6045.792982245181, 9068.68947336777)
    gain_base = random.uniform(310.9313456559014, 380.0272002461017)
    cost_base = random.uniform(44.429070279111215, 54.3021970078026)
    ...
    result = {
        ...
        "params_used": {"budget_range": [6045.792982245181, 9068.68947336777], "gain_range": [310.9313456559014, 380.0272002461017], "cost_range": [44.429070279111215, 54.3021970078026], "k": 6.935734839559108, "epsilon": 0.059237624643426356, "complexity": 2}
    }
