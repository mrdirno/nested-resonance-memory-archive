...
def run_generation():
    ...
    budget = random.uniform(77.37499870067998, 116.06249805101996)
    gain_base = random.uniform(147.1180535714896, 179.81095436515398)
    cost_base = random.uniform(18.70876369555744, 22.866266739014648)
    ...
    result = {
        ...
        "params_used": {"budget_range": [77.37499870067998, 116.06249805101996], "gain_range": [147.1180535714896, 179.81095436515398], "cost_range": [18.70876369555744, 22.866266739014648], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
