...
def run_generation():
    ...
    budget = random.uniform(258.3456498355398, 387.51847475330965)
    gain_base = random.uniform(166.00183974878965, 202.89113747074293)
    cost_base = random.uniform(16.474527648874933, 20.135533793069364)
    ...
    result = {
        ...
        "params_used": {"budget_range": [258.3456498355398, 387.51847475330965], "gain_range": [166.00183974878965, 202.89113747074293], "cost_range": [16.474527648874933, 20.135533793069364], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
