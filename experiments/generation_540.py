...
def run_generation():
    ...
    budget = random.uniform(435.82759114529335, 653.74138671794)
    gain_base = random.uniform(157.12221515213486, 192.0382629637204)
    cost_base = random.uniform(30.22915001358259, 36.94673890548984)
    ...
    result = {
        ...
        "params_used": {"budget_range": [435.82759114529335, 653.74138671794], "gain_range": [157.12221515213486, 192.0382629637204], "cost_range": [30.22915001358259, 36.94673890548984], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
