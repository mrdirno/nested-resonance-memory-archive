...
def run_generation():
    ...
    budget = random.uniform(283.8976024669506, 425.84640370042587)
    gain_base = random.uniform(168.78329025833716, 206.29068809352322)
    cost_base = random.uniform(15.97948979698642, 19.53048752965007)
    ...
    result = {
        ...
        "params_used": {"budget_range": [283.8976024669506, 425.84640370042587], "gain_range": [168.78329025833716, 206.29068809352322], "cost_range": [15.97948979698642, 19.53048752965007], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
