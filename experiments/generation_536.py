...
def run_generation():
    ...
    budget = random.uniform(271.36201901431167, 407.04302852146753)
    gain_base = random.uniform(143.45212445133535, 175.33037432940986)
    cost_base = random.uniform(36.622394303470955, 44.76070414868673)
    ...
    result = {
        ...
        "params_used": {"budget_range": [271.36201901431167, 407.04302852146753], "gain_range": [143.45212445133535, 175.33037432940986], "cost_range": [36.622394303470955, 44.76070414868673], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
