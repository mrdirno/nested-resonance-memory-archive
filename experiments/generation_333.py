...
def run_generation():
    ...
    budget = random.uniform(294.7478183912147, 442.12172758682203)
    gain_base = random.uniform(168.40106006205656, 205.82351785362468)
    cost_base = random.uniform(14.778259740957132, 18.06231746116983)
    ...
    result = {
        ...
        "params_used": {"budget_range": [294.7478183912147, 442.12172758682203], "gain_range": [168.40106006205656, 205.82351785362468], "cost_range": [14.778259740957132, 18.06231746116983], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
