...
def run_generation():
    ...
    budget = random.uniform(1360.242904630827, 2040.3643569462402)
    gain_base = random.uniform(539.1186287445416, 658.9227684655509)
    cost_base = random.uniform(61.49242438748517, 75.1574075847041)
    ...
    result = {
        ...
        "params_used": {"budget_range": [1360.242904630827, 2040.3643569462402], "gain_range": [539.1186287445416, 658.9227684655509], "cost_range": [61.49242438748517, 75.1574075847041], "k": 3.1977982140200343, "epsilon": 0.3284187114965685, "complexity": 2}
    }
