...
def run_generation():
    ...
    budget = random.uniform(71.39153954227118, 107.08730931340676)
    gain_base = random.uniform(126.07950182787575, 154.09716890073702)
    cost_base = random.uniform(20.85536515680905, 25.48989074721106)
    ...
    result = {
        ...
        "params_used": {"budget_range": [71.39153954227118, 107.08730931340676], "gain_range": [126.07950182787575, 154.09716890073702], "cost_range": [20.85536515680905, 25.48989074721106], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
