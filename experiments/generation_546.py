...
def run_generation():
    ...
    budget = random.uniform(262.14203661950444, 393.2130549292566)
    gain_base = random.uniform(636.5316122446036, 777.9830816322933)
    cost_base = random.uniform(5.819086828649483, 7.112217235016034)
    ...
    result = {
        ...
        "params_used": {"budget_range": [262.14203661950444, 393.2130549292566], "gain_range": [636.5316122446036, 777.9830816322933], "cost_range": [5.819086828649483, 7.112217235016034], "k": 7.113091460707711, "epsilon": 0.07428000042569488, "complexity": 2}
    }
