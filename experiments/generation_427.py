...
def run_generation():
    ...
    budget = random.uniform(6477.909827821701, 9716.86474173255)
    gain_base = random.uniform(192.95411502147735, 235.8328072484723)
    cost_base = random.uniform(21.75836751132074, 26.59356029161424)
    ...
    result = {
        ...
        "params_used": {"budget_range": [6477.909827821701, 9716.86474173255], "gain_range": [192.95411502147735, 235.8328072484723], "cost_range": [21.75836751132074, 26.59356029161424], "k": 4.552964741471671, "epsilon": 0.5906564314487059, "complexity": 2}
    }
