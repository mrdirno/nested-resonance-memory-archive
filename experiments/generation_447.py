...
def run_generation():
    ...
    budget = random.uniform(323.70520973889666, 485.557814608345)
    gain_base = random.uniform(187.24512347569797, 228.85515091474196)
    cost_base = random.uniform(14.030483246041117, 17.148368411828034)
    ...
    result = {
        ...
        "params_used": {"budget_range": [323.70520973889666, 485.557814608345], "gain_range": [187.24512347569797, 228.85515091474196], "cost_range": [14.030483246041117, 17.148368411828034], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
