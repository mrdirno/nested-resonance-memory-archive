...
def run_generation():
    ...
    budget = random.uniform(3990.811764681031, 5986.217647021546)
    gain_base = random.uniform(595.3354734015496, 727.6322452685607)
    cost_base = random.uniform(67.31860784375124, 82.27829847569596)
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=9.262558568547654, epsilon=0.6044975830664067))
    ...
    result = {
        ...
        "params_used": {"budget_range": [3990.811764681031, 5986.217647021546], "gain_range": [595.3354734015496, 727.6322452685607], "cost_range": [67.31860784375124, 82.27829847569596], "k": 9.262558568547654, "epsilon": 0.6044975830664067, "complexity": 2}
    }
