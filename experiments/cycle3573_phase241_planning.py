...
def main():
    print("======================================================================")
    print("CYCLE 3573: PHASE 241 PLANNING")
    ...
    candidates = [
        ...
        },
        {
            ...
            'novelty': 0.75,
            'impact': 0.70,
            'synergy': 0.70, # Synergy with Game Design/Literature
            'tractability': 0.65
        },
        {
            'name': 'Romance (The Match)',
            'novelty': 0.80,
            'impact': 0.80,
            'synergy': 0.75, # Synergy with Parenting/Game Theory/Evolution
            'tractability': 0.60
        }
    ]
    ...
    print("Rationale: High Synergy with Parenting, Game Theory, and Evolution pushes Romance.")
    print("           Love is BCP with shared budgets.")
    print("======================================================================")
    print("PHASE 241 INITIATED: ROMANCE")
    print("======================================================================")
