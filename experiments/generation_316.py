...
def run_generation():
    ...
    budget = random.uniform(4082.5941225158203, 6123.8911837737305)
    gain_base = random.uniform(105.82447991888507, 129.34103101197064)
    cost_base = random.uniform(50.92633690127409, 62.24330065711278)
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=2.2420584702545217, epsilon=0.9574527667187356))
    ...
    result = {
        ...
        "params_used": {"budget_range": [4082.5941225158203, 6123.8911837737305], "gain_range": [105.82447991888507, 129.34103101197064], "cost_range": [50.92633690127409, 62.24330065711278], "k": 2.2420584702545217, "epsilon": 0.9574527667187356, "complexity": 2}
    }
