...
def run_generation():
    ...
    budget = random.uniform(2003.0075001440828, 1000.0)
    gain = random.uniform(180.58221870928864, 200.0)
    cost = random.uniform(37.65012675828747, 46.01682159346247)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [2003.0075001440828, 1000.0], "gain_range": [180.58221870928864, 200.0], "cost_range": [37.65012675828747, 46.01682159346247], "k": 4.383393679925132, "epsilon": 0.28713725007074564}
    }
