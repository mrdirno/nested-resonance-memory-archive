...
def run_generation():
    ...
    budget = random.uniform(612.4144517960502, 918.6216776940752)
    gain_base = random.uniform(66.64713994214483, 81.45761548484369)
    cost_base = random.uniform(34.772122802642365, 42.49926120322956)
    ...
    result = {
        ...
        "params_used": {"budget_range": [612.4144517960502, 918.6216776940752], "gain_range": [66.64713994214483, 81.45761548484369], "cost_range": [34.772122802642365, 42.49926120322956], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
