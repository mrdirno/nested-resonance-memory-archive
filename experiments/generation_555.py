...
def run_generation():
    ...
    budget = random.uniform(453.00153445521295, 679.5023016828194)
    gain_base = random.uniform(150.38200558292294, 183.80022904579474)
    cost_base = random.uniform(48.169054583282396, 58.87328893512293)
    ...
    result = {
        ...
        "params_used": {"budget_range": [453.00153445521295, 679.5023016828194], "gain_range": [150.38200558292294, 183.80022904579474], "cost_range": [48.169054583282396, 58.87328893512293], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
