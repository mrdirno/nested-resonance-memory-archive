...
def run_generation():
    ...
    budget = random.uniform(12.428255783606561, 18.64238367540984)
    gain_base = random.uniform(170.1762768060586, 207.99322720740497)
    cost_base = random.uniform(5.2265233759247565, 6.3879730150191465)
    ...
    result = {
        ...
        "params_used": {"budget_range": [12.428255783606561, 18.64238367540984], "gain_range": [170.1762768060586, 207.99322720740497], "cost_range": [5.2265233759247565, 6.3879730150191465], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
