...
def run_generation():
    ...
    budget = random.uniform(781.815755763008, 1172.723633644512)
    gain_base = random.uniform(162.4839551487283, 198.59150073733463)
    cost_base = random.uniform(14.395269415210056, 17.594218174145624)
    ...
    result = {
        ...
        "params_used": {"budget_range": [781.815755763008, 1172.723633644512], "gain_range": [162.4839551487283, 198.59150073733463], "cost_range": [14.395269415210056, 17.594218174145624], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
