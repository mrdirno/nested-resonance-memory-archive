...
def run_generation():
    ...
    budget = random.uniform(160.94554080610757, 241.41831120916132)
    gain_base = random.uniform(78.81779908705646, 96.33286555084679)
    cost_base = random.uniform(39.81821811404945, 48.66671102828266)
    ...
    result = {
        ...
        "params_used": {"budget_range": [160.94554080610757, 241.41831120916132], "gain_range": [78.81779908705646, 96.33286555084679], "cost_range": [39.81821811404945, 48.66671102828266], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
