...
def run_generation():
    ...
    budget = random.uniform(1377.199642208748, 2065.7994633131216)
    gain_base = random.uniform(895.8581543476114, 1000.0)
    cost_base = random.uniform(49.01973174820588, 59.91300547002941)
    ...
    result = {
        ...
        "params_used": {"budget_range": [1377.199642208748, 2065.7994633131216], "gain_range": [895.8581543476114, 1000.0], "cost_range": [49.01973174820588, 59.91300547002941], "k": 2.0902790366501907, "epsilon": 0.9736883768041519, "complexity": 2}
    }
