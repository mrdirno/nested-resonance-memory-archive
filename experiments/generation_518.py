...
def run_generation():
    ...
    budget = random.uniform(523.0495436481793, 784.574315472269)
    gain_base = random.uniform(198.694170028296, 242.84843003458403)
    cost_base = random.uniform(43.724114292726675, 53.44058413555483)
    ...
    result = {
        ...
        "params_used": {"budget_range": [523.0495436481793, 784.574315472269], "gain_range": [198.694170028296, 242.84843003458403], "cost_range": [43.724114292726675, 53.44058413555483], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
