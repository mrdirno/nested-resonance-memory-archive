...
def run_generation():
    ...
    budget = random.uniform(652.4846118794251, 978.7269178191375)
    gain = random.uniform(785.1520683456978, 959.630305755853)
    cost = random.uniform(27.27044119298691, 33.3305392358729)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [652.4846118794251, 978.7269178191375], "gain_range": [785.1520683456978, 959.630305755853], "cost_range": [27.27044119298691, 33.3305392358729], "k": 4.891180113933895, "epsilon": 0.992416018679223}
    }
