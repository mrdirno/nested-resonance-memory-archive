...
def run_generation():
    ...
    budget = random.uniform(5567.699150761251, 8351.548726141875)
    gain_base = random.uniform(606.4916176969369, 741.2675327407007)
    cost_base = random.uniform(76.05105729488383, 92.95129224930247)
    ...
    result = {
        ...
        "params_used": {"budget_range": [5567.699150761251, 8351.548726141875], "gain_range": [606.4916176969369, 741.2675327407007], "cost_range": [76.05105729488383, 92.95129224930247], "k": 9.262558568547654, "epsilon": 0.6044975830664067, "complexity": 2}
    }
