...
def run_generation():
    ...
    budget = random.uniform(572.2629106097238, 858.3943659145857)
    gain_base = random.uniform(153.63341254852637, 187.77417089264333)
    cost_base = random.uniform(14.37726325823647, 17.572210648955686)
    ...
    result = {
        ...
        "params_used": {"budget_range": [572.2629106097238, 858.3943659145857], "gain_range": [153.63341254852637, 187.77417089264333], "cost_range": [14.37726325823647, 17.572210648955686], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
