...
def run_generation():
    ...
    budget = random.uniform(724.0247497766946, 1086.0371246650418)
    gain_base = random.uniform(262.18862060137565, 320.45275851279246)
    cost_base = random.uniform(59.570227141254946, 72.80805539486717)
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=0.9390813052558535, epsilon=0.2058159053431028))
    ...
    result = {
        ...
        "params_used": {"budget_range": [724.0247497766946, 1086.0371246650418], "gain_range": [262.18862060137565, 320.45275851279246], "cost_range": [59.570227141254946, 72.80805539486717], "k": 0.9390813052558535, "epsilon": 0.2058159053431028, "complexity": 2}
    }
