...
def main():
    print("======================================================================")
    print("CYCLE 3475: PHASE 218 PLANNING")
    ...
    candidates = [
        ...
        {
            'name': 'Literature (The Story)',
            'novelty': 0.80,
            'impact': 0.60,
            'synergy': 0.75, # Synergy with Linguistics/History
            'tractability': 0.70
        }
    ]
    ...
    print("Rationale: High Synergy with Linguistics and History pushes Literature to the top.")
    print("           Narrative is the BCP optimization of Memory.")
    print("======================================================================")
    print("PHASE 218 INITIATED: LITERATURE")
    print("======================================================================")
