...
def run_generation():
    ...
    budget = random.uniform(3237.6936301877986, 4856.540445281697)
    gain_base = random.uniform(288.1103881838829, 352.13491889141244)
    cost_base = random.uniform(64.54253165539697, 78.88531646770741)
    ...
    result = {
        ...
        "params_used": {"budget_range": [3237.6936301877986, 4856.540445281697], "gain_range": [288.1103881838829, 352.13491889141244], "cost_range": [64.54253165539697, 78.88531646770741], "k": 9.234612726959842, "epsilon": 0.07227896153510069, "complexity": 2}
    }
