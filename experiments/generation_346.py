...
def run_generation():
    ...
    budget = random.uniform(581.0991764173289, 871.6487646259932)
    gain_base = random.uniform(237.65970943851613, 290.4729782026308)
    cost_base = random.uniform(6.823014960779925, 8.339240507619909)
    ...
    result = {
        ...
        "params_used": {"budget_range": [581.0991764173289, 871.6487646259932], "gain_range": [237.65970943851613, 290.4729782026308], "cost_range": [6.823014960779925, 8.339240507619909], "k": 6.158352340611331, "epsilon": 0.30682498013289633, "complexity": 2}
    }
