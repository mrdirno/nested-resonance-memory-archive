...
def main():
    print("======================================================================")
    print("CYCLE 3507: PHASE 225 PLANNING")
    ...
    candidates = [
        ...
        {
            'name': 'Chemistry (The Bond)',
            'novelty': 0.75,
            'impact': 0.85,
            'synergy': 0.80, # Strong synergy with Medicine/Ecology/Physics
            'tractability': 0.70
        }
    ]
    ...
    print("Rationale: High Synergy with Medicine, Ecology, and Physics pushes Chemistry.")
    print("           Chemistry is the BCP of electron shells.")
    print("======================================================================")
    print("PHASE 225 INITIATED: CHEMISTRY")
    print("======================================================================")
