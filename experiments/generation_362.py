...
def run_generation():
    ...
    budget = random.uniform(424.4175860103455, 636.6263790155182)
    gain_base = random.uniform(68.44064705911629, 83.64967973891991)
    cost_base = random.uniform(35.04235123035938, 42.829540392661464)
    ...
    result = {
        ...
        "params_used": {"budget_range": [424.4175860103455, 636.6263790155182], "gain_range": [68.44064705911629, 83.64967973891991], "cost_range": [35.04235123035938, 42.829540392661464], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
