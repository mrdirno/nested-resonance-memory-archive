...
def run_generation():
    ...
    budget = random.uniform(4017.201943167275, 6025.802914750912)
    gain_base = random.uniform(806.0415449853433, 985.1618883154196)
    cost_base = random.uniform(54.31230604044295, 66.38170738276361)
    ...
    result = {
        ...
        "params_used": {"budget_range": [4017.201943167275, 6025.802914750912], "gain_range": [806.0415449853433, 985.1618883154196], "cost_range": [54.31230604044295, 66.38170738276361], "k": 3.4589290340398806, "epsilon": 0.8503059082412008, "complexity": 2}
    }
