...
def run_generation():
    ...
    budget = random.uniform(491.52139897752005, 737.28209846628)
    gain_base = random.uniform(166.42996693758815, 203.41440403482997)
    cost_base = random.uniform(35.76072917879671, 43.707557885195975)
    ...
    result = {
        ...
        "params_used": {"budget_range": [491.52139897752005, 737.28209846628], "gain_range": [166.42996693758815, 203.41440403482997], "cost_range": [35.76072917879671, 43.707557885195975], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
