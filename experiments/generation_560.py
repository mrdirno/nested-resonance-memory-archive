...
def run_generation():
    ...
    budget = random.uniform(413.2985605396702, 619.9478408095052)
    gain_base = random.uniform(136.22251762978425, 166.49418821418075)
    cost_base = random.uniform(41.13991703822297, 50.28212082449474)
    ...
    result = {
        ...
        "params_used": {"budget_range": [413.2985605396702, 619.9478408095052], "gain_range": [136.22251762978425, 166.49418821418075], "cost_range": [41.13991703822297, 50.28212082449474], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
