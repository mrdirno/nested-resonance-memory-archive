...
def run_generation():
    ...
    result = {
        ...
        "params_used": {"budget_range": [80.0, 120.0], "gain_range": [90.0, 110.00000000000001], "cost_range": [9.0, 11.0], "k": 2.1824892275793393, "epsilon": 0.25356856411991485, "complexity": 2}
    }
