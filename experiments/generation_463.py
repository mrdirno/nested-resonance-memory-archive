...
def run_generation():
    ...
    budget = random.uniform(79.86101782187582, 119.79152673281372)
    gain_base = random.uniform(143.63158914200633, 175.5497200624522)
    cost_base = random.uniform(11.34147186137713, 13.86179894168316)
    ...
    result = {
        ...
        "params_used": {"budget_range": [79.86101782187582, 119.79152673281372], "gain_range": [143.63158914200633, 175.5497200624522], "cost_range": [11.34147186137713, 13.86179894168316], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
