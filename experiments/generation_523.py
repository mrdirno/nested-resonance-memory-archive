...
def run_generation():
    ...
    budget = random.uniform(530.9551090437002, 796.4326635655503)
    gain_base = random.uniform(155.47182935651, 190.02112476906777)
    cost_base = random.uniform(23.491019423752043, 28.71124596236361)
    ...
    result = {
        ...
        "params_used": {"budget_range": [530.9551090437002, 796.4326635655503], "gain_range": [155.47182935651, 190.02112476906777], "cost_range": [23.491019423752043, 28.71124596236361], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
