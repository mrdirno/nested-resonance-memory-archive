...
def run_generation():
    ...
    budget = random.uniform(769.7951437831524, 1154.6927156747286)
    gain = random.uniform(143.9752848108834, 175.9697925466353)
    cost = random.uniform(17.448676208117128, 21.326159809920934)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [769.7951437831524, 1154.6927156747286], "gain_range": [143.9752848108834, 175.9697925466353], "cost_range": [17.448676208117128, 21.326159809920934], "k": 1.0, "epsilon": 0.1}
    }
