...
def run_generation():
    ...
    budget = random.uniform(120.47372550682508, 180.7105882602376)
    gain_base = random.uniform(137.68669981968046, 168.2837442240539)
    cost_base = random.uniform(10.001460474469233, 12.224007246573509)
    ...
    result = {
        ...
        "params_used": {"budget_range": [120.47372550682508, 180.7105882602376], "gain_range": [137.68669981968046, 168.2837442240539], "cost_range": [10.001460474469233, 12.224007246573509], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
