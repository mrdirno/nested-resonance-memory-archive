...
def run_generation():
    ...
    budget = random.uniform(514.1022629408745, 771.1533944113118)
    gain = random.uniform(786.0666256198793, 960.7480979798527)
    cost = random.uniform(25.155332111096403, 30.745405913562273)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [514.1022629408745, 771.1533944113118], "gain_range": [786.0666256198793, 960.7480979798527], "cost_range": [25.155332111096403, 30.745405913562273], "k": 4.891180113933895, "epsilon": 0.992416018679223}
    }
