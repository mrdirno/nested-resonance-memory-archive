...
def run_generation():
    ...
    budget = random.uniform(3405.6995873090937, 5108.54938096364)
    gain_base = random.uniform(114.28681710265747, 139.68388756991467)
    cost_base = random.uniform(53.61194159800429, 65.52570639756081)
    ...
    result = {
        ...
        "params_used": {"budget_range": [3405.6995873090937, 5108.54938096364], "gain_range": [114.28681710265747, 139.68388756991467], "cost_range": [53.61194159800429, 65.52570639756081], "k": 2.2420584702545217, "epsilon": 0.9574527667187356, "complexity": 2}
    }
