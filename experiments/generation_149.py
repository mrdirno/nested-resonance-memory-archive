...
def run_generation():
    ...
    gain_base = random.uniform(90.0, 110.00000000000001)
    cost_base = random.uniform(9.0, 11.0)
    ...
    result = {
        ...
        "params_used": {"budget_range": [80.0, 120.0], "gain_range": [90.0, 110.00000000000001], "cost_range": [9.0, 11.0], "k": 1.4122027531297432, "epsilon": 0.49742664383906676, "complexity": 2}
    }
