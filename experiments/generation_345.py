...
def run_generation():
    ...
    budget = random.uniform(511.87504070540626, 767.8125610581094)
    gain_base = random.uniform(260.0515016432264, 317.8407242306101)
    cost_base = random.uniform(7.320367897581103, 8.947116319265794)
    ...
    result = {
        ...
        "params_used": {"budget_range": [511.87504070540626, 767.8125610581094], "gain_range": [260.0515016432264, 317.8407242306101], "cost_range": [7.320367897581103, 8.947116319265794], "k": 6.158352340611331, "epsilon": 0.30682498013289633, "complexity": 2}
    }
