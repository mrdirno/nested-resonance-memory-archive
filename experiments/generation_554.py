...
def run_generation():
    ...
    budget = random.uniform(459.9944196078143, 689.9916294117213)
    gain_base = random.uniform(152.84145158852309, 186.8062186081949)
    cost_base = random.uniform(45.72052390229606, 55.88064032502852)
    ...
    result = {
        ...
        "params_used": {"budget_range": [459.9944196078143, 689.9916294117213], "gain_range": [152.84145158852309, 186.8062186081949], "cost_range": [45.72052390229606, 55.88064032502852], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
