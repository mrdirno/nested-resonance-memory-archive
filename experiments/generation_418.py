...
def run_generation():
    ...
    budget = random.uniform(2061.7026788019243, 3092.554018202886)
    gain_base = random.uniform(129.94035196096027, 158.81598573006255)
    cost_base = random.uniform(1.6293959014513977, 1.9914838795517082)
    ...
    result = {
        ...
        "params_used": {"budget_range": [2061.7026788019243, 3092.554018202886], "gain_range": [129.94035196096027, 158.81598573006255], "cost_range": [1.6293959014513977, 1.9914838795517082], "k": 7.698825262071338, "epsilon": 0.31888056002057574, "complexity": 2}
    }
