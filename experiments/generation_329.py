...
def run_generation():
    ...
    budget = random.uniform(4373.669292353829, 6560.503938530744)
    gain_base = random.uniform(597.7132708946069, 730.5384422045196)
    cost_base = random.uniform(4.755330376382488, 5.81207046002304)
    ...
    result = {
        ...
        "params_used": {"budget_range": [4373.669292353829, 6560.503938530744], "gain_range": [597.7132708946069, 730.5384422045196], "cost_range": [4.755330376382488, 5.81207046002304], "k": 8.080861805504712, "epsilon": 0.980263816546247, "complexity": 2}
    }
