...
def run_generation():
    ...
    budget = random.uniform(2841.5843824374006, 4262.3765736561)
    gain_base = random.uniform(278.62825899354675, 340.5456498810016)
    cost_base = random.uniform(64.89527903508943, 79.3164521539982)
    ...
    result = {
        ...
        "params_used": {"budget_range": [2841.5843824374006, 4262.3765736561], "gain_range": [278.62825899354675, 340.5456498810016], "cost_range": [64.89527903508943, 79.3164521539982], "k": 9.234612726959842, "epsilon": 0.07227896153510069, "complexity": 2}
    }
