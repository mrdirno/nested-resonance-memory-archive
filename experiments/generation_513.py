...
def run_generation():
    ...
    budget = random.uniform(570.2572524628, 855.3858786942)
    gain_base = random.uniform(181.2369636753045, 221.51184449203885)
    cost_base = random.uniform(39.06416793444699, 47.74509414210188)
    ...
    result = {
        ...
        "params_used": {"budget_range": [570.2572524628, 855.3858786942], "gain_range": [181.2369636753045, 221.51184449203885], "cost_range": [39.06416793444699, 47.74509414210188], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
