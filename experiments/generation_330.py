...
def run_generation():
    ...
    budget = random.uniform(4131.832504737767, 6197.7487571066495)
    gain_base = random.uniform(589.4461025671117, 720.4341253598033)
    cost_base = random.uniform(4.902815651426607, 5.99233024063252)
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=8.080861805504712, epsilon=0.980263816546247))
    ...
    result = {
        ...
        "params_used": {"budget_range": [4131.832504737767, 6197.7487571066495], "gain_range": [589.4461025671117, 720.4341253598033], "cost_range": [4.902815651426607, 5.99233024063252], "k": 8.080861805504712, "epsilon": 0.980263816546247, "complexity": 2}
    }
