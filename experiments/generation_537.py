...
def run_generation():
    ...
    budget = random.uniform(319.5817770705839, 479.37266560587574)
    gain_base = random.uniform(151.559916984787, 185.2398985369619)
    cost_base = random.uniform(36.77527515712614, 44.947558525376394)
    ...
    result = {
        ...
        "params_used": {"budget_range": [319.5817770705839, 479.37266560587574], "gain_range": [151.559916984787, 185.2398985369619], "cost_range": [36.77527515712614, 44.947558525376394], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
