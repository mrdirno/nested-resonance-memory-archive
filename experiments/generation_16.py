...
def run_generation():
    ...
    budget = random.uniform(527.1621454180485, 790.7432181270725)
    gain = random.uniform(803.2556316578277, 981.7568831373451)
    cost = random.uniform(25.599941467406204, 31.288817349052028)
    
    agent = BCPAgent(budget=budget, k=4.891180113933895, epsilon=0.992416018679223)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [527.1621454180485, 790.7432181270725], "gain_range": [803.2556316578277, 981.7568831373451], "cost_range": [25.599941467406204, 31.288817349052028], "k": 4.891180113933895, "epsilon": 0.992416018679223}
    }
