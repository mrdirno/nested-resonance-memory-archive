...
def run_generation():
    ...
    budget = random.uniform(1843.876568635167, 2765.8148529527502)
    gain_base = random.uniform(798.5752989632897, 976.0364765106875)
    cost_base = random.uniform(28.736485436619116, 35.122371089201145)
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=2.5389027477966586, epsilon=0.012098910621484764))
    ...
    result = {
        ...
        "params_used": {"budget_range": [1843.876568635167, 2765.8148529527502], "gain_range": [798.5752989632897, 976.0364765106875], "cost_range": [28.736485436619116, 35.122371089201145], "k": 2.5389027477966586, "epsilon": 0.012098910621484764, "complexity": 2}
    }
