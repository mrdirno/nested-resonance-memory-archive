"""
Cycle 2489: The Drought (Gate 117)
Role: The Evolutionary Biologist
Responsibility: Introduce Scarcity.

Objective:
- Run for 1000 ticks.
- Tick 0-500: Abundance (Seasonality).
- Tick 500-1000: Drought (80% reduction).
- Track Efficiency Evolution.
"""
...
def run_drought():
    ...
    csv_path = results_dir / "cycle2489_drought.csv"
    ...
    print("✅ DROUGHT SIMULATION COMPLETE.")
