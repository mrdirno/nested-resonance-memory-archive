...
def run_generation():
    ...
    budget = random.uniform(441.64138435527167, 662.4620765329074)
    gain_base = random.uniform(168.9988565008339, 206.5541579454637)
    cost_base = random.uniform(32.62774396246508, 39.87835373190177)
    ...
    result = {
        ...
        "params_used": {"budget_range": [441.64138435527167, 662.4620765329074], "gain_range": [168.9988565008339, 206.5541579454637], "cost_range": [32.62774396246508, 39.87835373190177], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
