...
def run_generation():
    ...
    budget = random.uniform(503.1452102086388, 754.7178153129581)
    gain_base = random.uniform(139.83781454899702, 170.91288444877415)
    cost_base = random.uniform(39.125677574553364, 47.820272591120776)
    ...
    result = {
        ...
        "params_used": {"budget_range": [503.1452102086388, 754.7178153129581], "gain_range": [139.83781454899702, 170.91288444877415], "cost_range": [39.125677574553364, 47.820272591120776], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
