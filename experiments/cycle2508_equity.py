...
def run_cycle():
    ...
    # Add Smart Workers (25) - The Shareholders
    for i in range(25):
        ...
        worker.genome[9] = 0.9 # High Innovation (>0.7 triggers Equity)
        ecosystem.add_agent(worker)
        
    # Add Dumb Workers (25) - The Wage Laborers
    for i in range(25):
        ...
        worker.genome[5] = 0.5
        worker.genome[8] = 0.9 # High Trust
        worker.genome[9] = 0.1 # Low Innovation (<=0.7 triggers Wage)
        ecosystem.add_agent(worker)
