...
def run_generation():
    ...
    budget = random.uniform(6452.1402989556755, 9678.210448433512)
    gain_base = random.uniform(206.6726562522505, 252.59991319719506)
    cost_base = random.uniform(22.963468482293155, 28.066461478358303)
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=4.552964741471671, epsilon=0.5906564314487059))
    ...
    result = {
        ...
        "params_used": {"budget_range": [6452.1402989556755, 9678.210448433512], "gain_range": [206.6726562522505, 252.59991319719506], "cost_range": [22.963468482293155, 28.066461478358303], "k": 4.552964741471671, "epsilon": 0.5906564314487059, "complexity": 2}
    }
