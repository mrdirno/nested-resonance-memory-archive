...
def run_generation():
    ...
    budget = random.uniform(5097.526221563088, 7646.2893323446315)
    gain_base = random.uniform(301.1613913864745, 368.08614502791335)
    cost_base = random.uniform(45.581932371408335, 55.71125067616575)
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=6.935734839559108, epsilon=0.059237624643426356))
    ...
    result = {
        ...
        "params_used": {"budget_range": [5097.526221563088, 7646.2893323446315], "gain_range": [301.1613913864745, 368.08614502791335], "cost_range": [45.581932371408335, 55.71125067616575], "k": 6.935734839559108, "epsilon": 0.059237624643426356, "complexity": 2}
    }
