...
def run_generation():
    ...
    budget = random.uniform(553.8135895966569, 830.7203843949854)
    gain_base = random.uniform(101.05482332619277, 123.51145073201339)
    cost_base = random.uniform(47.018597859967734, 57.467175162182784)
    ...
    result = {
        ...
        "params_used": {"budget_range": [553.8135895966569, 830.7203843949854], "gain_range": [101.05482332619277, 123.51145073201339], "cost_range": [47.018597859967734, 57.467175162182784], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
