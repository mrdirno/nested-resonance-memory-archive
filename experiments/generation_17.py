...
def run_generation():
    ...
    budget = random.uniform(588.9562155920862, 883.4343233881293)
    gain = random.uniform(861.672793230731, 1000.0)
    cost = random.uniform(25.314545923837105, 30.940000573578686)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [588.9562155920862, 883.4343233881293], "gain_range": [861.672793230731, 1000.0], "cost_range": [25.314545923837105, 30.940000573578686], "k": 4.891180113933895, "epsilon": 0.992416018679223}
    }
