...
def run_generation():
    ...
    budget = random.uniform(1077.5218242293265, 1616.2827363439894)
    gain_base = random.uniform(121.26304569943632, 148.21038918819994)
    cost_base = random.uniform(50.990157972625745, 62.3213041887648)
    ...
    result = {
        ...
        "params_used": {"budget_range": [1077.5218242293265, 1616.2827363439894], "gain_range": [121.26304569943632, 148.21038918819994], "cost_range": [50.990157972625745, 62.3213041887648], "k": 1.022852120251879, "epsilon": 0.6565268865173267, "complexity": 2}
    }
