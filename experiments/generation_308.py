...
def run_generation():
    ...
    budget = random.uniform(1110.2797420982993, 1665.4196131474487)
    gain_base = random.uniform(134.6988841908724, 164.63196956662182)
    cost_base = random.uniform(55.27158717867663, 67.55416210727145)
    ...
    result = {
        ...
        "params_used": {"budget_range": [1110.2797420982993, 1665.4196131474487], "gain_range": [134.6988841908724, 164.63196956662182], "cost_range": [55.27158717867663, 67.55416210727145], "k": 1.022852120251879, "epsilon": 0.6565268865173267, "complexity": 2}
    }
