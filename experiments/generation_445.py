...
def run_generation():
    ...
    budget = random.uniform(298.7802547923003, 448.1703821884504)
    gain_base = random.uniform(174.1173305651414, 212.8100706907284)
    cost_base = random.uniform(15.582689712008484, 19.04550964801037)
    ...
    result = {
        ...
        "params_used": {"budget_range": [298.7802547923003, 448.1703821884504], "gain_range": [174.1173305651414, 212.8100706907284], "cost_range": [15.582689712008484, 19.04550964801037], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
