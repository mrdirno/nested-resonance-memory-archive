...
def run_generation():
    ...
    budget = random.uniform(3887.081858923384, 5830.622788385075)
    gain = random.uniform(562.4463528388085, 687.4344312474326)
    cost = random.uniform(80.21772176204941, 98.04388215361595)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [3887.081858923384, 5830.622788385075], "gain_range": [562.4463528388085, 687.4344312474326], "cost_range": [80.21772176204941, 98.04388215361595], "k": 9.505937517777465, "epsilon": 0.0955725859361949}
    }
