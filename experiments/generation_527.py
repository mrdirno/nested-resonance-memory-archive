...
def run_generation():
    ...
    budget = random.uniform(2463.40946408492, 3695.1141961273797)
    gain_base = random.uniform(260.150331006464, 317.9615156745671)
    cost_base = random.uniform(67.30352915683926, 82.25986896947022)
    ...
    result = {
        ...
        "params_used": {"budget_range": [2463.40946408492, 3695.1141961273797], "gain_range": [260.150331006464, 317.9615156745671], "cost_range": [67.30352915683926, 82.25986896947022], "k": 9.234612726959842, "epsilon": 0.07227896153510069, "complexity": 2}
    }
