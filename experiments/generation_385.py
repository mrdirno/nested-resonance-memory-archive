...
def run_generation():
    ...
    budget = random.uniform(755.8812116074266, 1133.8218174111398)
    gain_base = random.uniform(153.9507631317466, 188.16204382769033)
    cost_base = random.uniform(14.206271409887718, 17.36322061208499)
    ...
    result = {
        ...
        "params_used": {"budget_range": [755.8812116074266, 1133.8218174111398], "gain_range": [153.9507631317466, 188.16204382769033], "cost_range": [14.206271409887718, 17.36322061208499], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
