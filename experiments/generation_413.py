...
def run_generation():
    ...
    budget = random.uniform(129.6962079078415, 194.54431186176222)
    gain_base = random.uniform(135.99961421230068, 166.22175070392305)
    cost_base = random.uniform(9.540891613059653, 11.661089749295131)
    ...
    result = {
        ...
        "params_used": {"budget_range": [129.6962079078415, 194.54431186176222], "gain_range": [135.99961421230068, 166.22175070392305], "cost_range": [9.540891613059653, 11.661089749295131], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
