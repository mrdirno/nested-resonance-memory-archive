...
def run_generation():
    ...
    budget = random.uniform(429.10593303586586, 643.6588995537987)
    gain_base = random.uniform(135.9497444576052, 166.16079878151746)
    cost_base = random.uniform(40.09967847464726, 49.01071813567999)
    ...
    result = {
        ...
        "params_used": {"budget_range": [429.10593303586586, 643.6588995537987], "gain_range": [135.9497444576052, 166.16079878151746], "cost_range": [40.09967847464726, 49.01071813567999], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
