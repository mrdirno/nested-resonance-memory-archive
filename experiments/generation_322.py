...
def run_generation():
    ...
    budget = random.uniform(633.5580211677342, 950.3370317516011)
    gain_base = random.uniform(102.35992857844779, 125.10657937365843)
    cost_base = random.uniform(39.62544375699724, 48.43109792521886)
    ...
    result = {
        ...
        "params_used": {"budget_range": [633.5580211677342, 950.3370317516011], "gain_range": [102.35992857844779, 125.10657937365843], "cost_range": [39.62544375699724, 48.43109792521886], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
