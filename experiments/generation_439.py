...
def run_generation():
    ...
    budget = random.uniform(4316.574433586125, 6474.861650379187)
    gain_base = random.uniform(891.1021512146151, 1000.0)
    cost_base = random.uniform(40.7580588027274, 49.81540520333348)
    ...
    result = {
        ...
        "params_used": {"budget_range": [4316.574433586125, 6474.861650379187], "gain_range": [891.1021512146151, 1000.0], "cost_range": [40.7580588027274, 49.81540520333348], "k": 3.3136398384246877, "epsilon": 0.47667923498748715, "complexity": 2}
    }
