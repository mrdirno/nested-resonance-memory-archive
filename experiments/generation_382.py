...
def run_generation():
    ...
    budget = random.uniform(622.5915412671225, 933.8873119006835)
    gain_base = random.uniform(174.74724449117286, 213.57996548921128)
    cost_base = random.uniform(16.76184969127523, 20.486705178225282)
    ...
    result = {
        ...
        "params_used": {"budget_range": [622.5915412671225, 933.8873119006835], "gain_range": [174.74724449117286, 213.57996548921128], "cost_range": [16.76184969127523, 20.486705178225282], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
