...
def run_generation():
    ...
    budget = random.uniform(77.19916054279169, 115.79874081418752)
    gain_base = random.uniform(147.1782712892569, 179.8845537979807)
    cost_base = random.uniform(11.406628104868993, 13.941434350395438)
    ...
    result = {
        ...
        "params_used": {"budget_range": [77.19916054279169, 115.79874081418752], "gain_range": [147.1782712892569, 179.8845537979807], "cost_range": [11.406628104868993, 13.941434350395438], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
