...
def run_generation():
    ...
    budget = random.uniform(512.1624805969134, 768.24372089537)
    gain_base = random.uniform(809.9655978761083, 989.9579529596879)
    cost_base = random.uniform(64.63107052121285, 78.99353063703792)
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=7.315991030871151, epsilon=0.8239356293125044))
    ...
    result = {
        ...
        "params_used": {"budget_range": [512.1624805969134, 768.24372089537], "gain_range": [809.9655978761083, 989.9579529596879], "cost_range": [64.63107052121285, 78.99353063703792], "k": 7.315991030871151, "epsilon": 0.8239356293125044, "complexity": 2}
    }
