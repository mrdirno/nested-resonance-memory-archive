...
def run_generation():
    ...
    budget = random.uniform(13.326984759063478, 19.990477138595217)
    gain_base = random.uniform(167.80178817911704, 205.09107444114306)
    cost_base = random.uniform(4.77742115754954, 5.839070303671661)
    ...
    result = {
        ...
        "params_used": {"budget_range": [13.326984759063478, 19.990477138595217], "gain_range": [167.80178817911704, 205.09107444114306], "cost_range": [4.77742115754954, 5.839070303671661], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
