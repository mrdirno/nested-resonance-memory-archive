...
def run_generation():
    ...
    budget = random.uniform(7228.625865040103, 10000.0)
    gain_base = random.uniform(302.93624758574134, 370.2554137159061)
    cost_base = random.uniform(44.07172653744343, 53.865443545764194)
    ...
    result = {
        ...
        "params_used": {"budget_range": [7228.625865040103, 10000.0], "gain_range": [302.93624758574134, 370.2554137159061], "cost_range": [44.07172653744343, 53.865443545764194], "k": 6.935734839559108, "epsilon": 0.059237624643426356, "complexity": 2}
    }
