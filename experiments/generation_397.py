...
def run_generation():
    ...
    budget = random.uniform(875.3513607079835, 1313.027041061975)
    gain_base = random.uniform(346.28364860701174, 423.23557051968106)
    cost_base = random.uniform(71.03833417576372, 86.82463065926677)
    ...
    result = {
        ...
        "params_used": {"budget_range": [875.3513607079835, 1313.027041061975], "gain_range": [346.28364860701174, 423.23557051968106], "cost_range": [71.03833417576372, 86.82463065926677], "k": 0.5044925026778514, "epsilon": 0.7786510323888909, "complexity": 2}
    }
