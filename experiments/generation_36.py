...
def run_generation():
    ...
    budget = random.uniform(4402.5425190311735, 6603.81377854676)
    gain = random.uniform(528.3426226954838, 645.7520944055914)
    cost = random.uniform(73.06882705793741, 89.3063441819235)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [4402.5425190311735, 6603.81377854676], "gain_range": [528.3426226954838, 645.7520944055914], "cost_range": [73.06882705793741, 89.3063441819235], "k": 9.505937517777465, "epsilon": 0.0955725859361949}
    }
