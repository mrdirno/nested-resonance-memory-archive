...
def run_generation():
    ...
    budget = random.uniform(5945.39859947556, 8918.09789921334)
    gain_base = random.uniform(195.65650619920316, 239.13572979902608)
    cost_base = random.uniform(70.03332003092392, 85.5962800377959)
    ...
    result = {
        ...
        "params_used": {"budget_range": [5945.39859947556, 8918.09789921334], "gain_range": [195.65650619920316, 239.13572979902608], "cost_range": [70.03332003092392, 85.5962800377959], "k": 0.22255275219284712, "epsilon": 0.4857845429736557, "complexity": 2}
    }
