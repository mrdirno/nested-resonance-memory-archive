...
def run_generation():
    ...
    budget = random.uniform(3396.280544620652, 5094.420816930978)
    gain_base = random.uniform(877.9668622914446, 1000.0)
    cost_base = random.uniform(53.66740442446981, 65.5934942965742)
    ...
    result = {
        ...
        "params_used": {"budget_range": [3396.280544620652, 5094.420816930978], "gain_range": [877.9668622914446, 1000.0], "cost_range": [53.66740442446981, 65.5934942965742], "k": 3.4589290340398806, "epsilon": 0.8503059082412008, "complexity": 2}
    }
