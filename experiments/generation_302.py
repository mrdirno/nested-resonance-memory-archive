...
def run_generation():
    ...
    budget = random.uniform(653.2327361520948, 979.8491042281422)
    gain_base = random.uniform(154.17411163240953, 188.43502532850056)
    cost_base = random.uniform(20.31511174694573, 24.829581024044778)
    ...
    result = {
        ...
        "params_used": {"budget_range": [653.2327361520948, 979.8491042281422], "gain_range": [154.17411163240953, 188.43502532850056], "cost_range": [20.31511174694573, 24.829581024044778], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
