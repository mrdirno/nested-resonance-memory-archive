...
def run_generation():
    ...
    budget = random.uniform(2996.2941452832356, 4494.441217924853)
    gain_base = random.uniform(268.63560099751965, 328.3324012191907)
    cost_base = random.uniform(68.12065692222397, 83.25858068271819)
    ...
    result = {
        ...
        "params_used": {"budget_range": [2996.2941452832356, 4494.441217924853], "gain_range": [268.63560099751965, 328.3324012191907], "cost_range": [68.12065692222397, 83.25858068271819], "k": 9.234612726959842, "epsilon": 0.07227896153510069, "complexity": 2}
    }
