...
def run_generation():
    ...
    budget = random.uniform(299.58040562791894, 449.3706084418784)
    gain = random.uniform(133.64683624521967, 163.34613318860184)
    cost = random.uniform(19.7829614572464, 24.17917511441227)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [299.58040562791894, 449.3706084418784], "gain_range": [133.64683624521967, 163.34613318860184], "cost_range": [19.7829614572464, 24.17917511441227], "k": 1.0, "epsilon": 0.1}
    }
