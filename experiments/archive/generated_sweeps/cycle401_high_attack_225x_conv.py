#!/usr/bin/env python3
"""
CYCLE 401: HIGH ATTACK + 2.25× CONVERSION - 40 CYCLES
...
Purpose:
  Characterize conversion overshoot at 0.75× attack.

Background:
  At 0.75× attack:
  - C376: 1.5× conv - 90%
  - C379: 2.0× conv - 90%
  - C400: 2.5× conv - 80% (overshoot!)

  C401: 2.25× conv - expect 85%?
...
CYCLE_ID = "C401"
CYCLE_NAME = "High Attack 2.25x Conv"
MODE = "HIGH_ATK_225XCONV"
...
def run_experiment(seed: int, cycles: int) -> dict:
    """Run high attack + 2.25× conversion experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c401_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 401: HIGH ATTACK + 2.25× CONVERSION - 40 CYCLES")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c401_high_attack_225x_conv_results.json"
