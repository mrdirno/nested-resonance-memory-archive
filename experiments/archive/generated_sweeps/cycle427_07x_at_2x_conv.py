#!/usr/bin/env python3
"""
CYCLE 427: 0.7× ATTACK AT 2.0× CONVERSION
...
Purpose:
  Fill phase diagram grid.

Background:
  At 0.71875× + 2.0× conv: 70%
  At 0.75× + 2.0× conv: 95%

  C427: 0.7× + 2.0× - fill grid

Design:
  - K declines from 600 to 200 over 40 cycles
  - Attack: 0.7×, Conversion: 2.0×
  - 20 seeds
"""
...
SEEDS = list(range(6520, 6540))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run 0.7× attack at 2.0× conversion experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c427_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 427: 0.7× ATTACK AT 2.0× CONVERSION")
    ...
    print(f"Attack: 0.7×, Conversion: 2.0×")
    print("=" * 80)
    print()
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c427_07x_at_2x_conv_results.json"
