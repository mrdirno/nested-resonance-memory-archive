#!/usr/bin/env python3
"""
CYCLE 410: NOTCH AT 2.0× CONVERSION
...
Purpose:
  Test if resonance notch exists at different conversion levels.

Background:
  At 2.5× conversion, notch at 0.6875× (90%)
  At 2.0× conversion, 0.5× attack gives 100%

  C410: 0.6875× attack + 2.0× conv - notch at lower conv?
...
# 0.6875× attack + 2.0× conversion
BASE_PARAMS = [
    {"f": 0.1, "e_con": 0.2, "e_rech": 0.4},
    {"attack": 0.0020625, "h": 0.02, "e_con": 0.3, "e_gain": 0.5, "conv": 0.6},
    {"attack": 0.0034375, "h": 0.03, "e_con": 0.4, "e_gain": 0.6, "conv": 0.5},
    {"attack": 0.0055, "h": 0.04, "e_con": 0.5, "e_gain": 0.8, "conv": 0.4},
    {"attack": 0.00825, "h": 0.05, "e_con": 0.6, "e_gain": 1.0, "conv": 0.3},
    {"attack": 0.0103125, "h": 0.06, "e_con": 0.7, "e_gain": 1.2, "conv": 0.24},
    {"attack": 0.012375, "h": 0.07, "e_con": 0.8, "e_gain": 1.4, "conv": 0.2}
]

SEEDS = list(range(6180, 6200))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run notch at 2.0× conversion experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c410_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 410: NOTCH AT 2.0× CONVERSION")
    ...
    print(f"Attack: 0.6875×, Conversion: 2.0×")
    print("=" * 80)
    print()
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c410_notch_at_2x_conv_results.json"
