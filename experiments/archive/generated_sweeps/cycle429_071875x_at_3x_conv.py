#!/usr/bin/env python3
"""
CYCLE 429: 0.71875× ATTACK AT 3.0× CONVERSION
...
Purpose:
  Complete phase diagram grid - last value.

Background:
  At 0.71875× + 2.0× conv: 70%
  At 0.71875× + 2.5× conv: 100%

  C429: 0.71875× + 3.0× - complete grid

Design:
  - K declines from 600 to 200 over 40 cycles
  - Attack: 0.71875×, Conversion: 3.0×
  - 20 seeds
"""
...
CYCLE_ID = "C429"
CYCLE_NAME = "0.71875x at 3x Conv"
MODE = "071875X_3XCONV"
...
# 0.71875× attack + 3.0× conversion
BASE_PARAMS = [
    {"f": 0.1, "e_con": 0.2, "e_rech": 0.4},
    {"attack": 0.00215625, "h": 0.02, "e_con": 0.3, "e_gain": 0.5, "conv": 0.9},
    {"attack": 0.00359375, "h": 0.03, "e_con": 0.4, "e_gain": 0.6, "conv": 0.75},
    {"attack": 0.00575, "h": 0.04, "e_con": 0.5, "e_gain": 0.8, "conv": 0.6},
    {"attack": 0.008625, "h": 0.05, "e_con": 0.6, "e_gain": 1.0, "conv": 0.45},
    {"attack": 0.01078125, "h": 0.06, "e_con": 0.7, "e_gain": 1.2, "conv": 0.36},
    {"attack": 0.0129375, "h": 0.07, "e_con": 0.8, "e_gain": 1.4, "conv": 0.3}
]

SEEDS = list(range(6560, 6580))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run 0.71875× attack at 3.0× conversion experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c429_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 429: 0.71875× ATTACK AT 3.0× CONVERSION")
    ...
    print(f"Attack: 0.71875×, Conversion: 3.0×")
    print("=" * 80)
    print()
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c429_071875x_at_3x_conv_results.json"
