#!/usr/bin/env python3
"""
CYCLE 367: 1.25× ATTACK RATE - 45 CYCLES
...
Purpose:
  Pinpoint crossover between 40 and 50 cycles.

Background:
  C363: 40 cycles, 1.25× attack - 60% survival
  C365: 50 cycles, 1.25× attack - 45% survival
  C367: 45 cycles, 1.25× attack - test midpoint

Design:
  - K declines from 600 to 200 over 45 cycles
  - Rate: 8.9 K/cycle
...
CYCLE_ID = "C367"
CYCLE_NAME = "1.25x Attack Rate 45 Cycles"
MODE = "125_ATTACK_45"
...
SEEDS = list(range(5320, 5340))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run 1.25× attack at 45 cycles."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c367_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 367: 1.25× ATTACK RATE - 45 CYCLES")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c367_125attack_45cycles_results.json"
