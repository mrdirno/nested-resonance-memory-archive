...
Purpose:
  Test if redundancy at L5 addresses the residual 5% risk.

Research Question:
  Is the 5% system-wide risk in the second-to-top level?

Background:
  C325-326: N=2/3 at L6 gives 95% ceiling
  C327: Test if N=3 at L5 improves beyond 95%
...
CYCLE_ID = "C327"
CYCLE_NAME = "L5 Redundancy Test"
MODE = "L5_REDUNDANCY"

CYCLES = 30000
K = 600
INITIAL = [300, 30, 10, 5, 3, 3, 2]  # L5 at N=3, L6 at N=2
...
SEEDS = list(range(3400, 3420))  # 20 seeds


def run_experiment(seed: int, cycles: int) -> dict:
    """Run L5 redundancy experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c327_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 327: L5 REDUNDANCY TEST")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c327_l5_redundancy_results.json"
