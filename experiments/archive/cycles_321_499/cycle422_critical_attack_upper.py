#!/usr/bin/env python3
"""
CYCLE 422: CRITICAL ATTACK UPPER BOUND
...
Purpose:
  Narrow down critical attack value.

Background:
  At 0.734375× + 2.5× conv: 95%
  At 0.75× + 2.5× conv: 80%

  C422: 0.7421875× + 2.5× - closer to transition?
...
CYCLE_ID = "C422"
CYCLE_NAME = "Critical Attack Upper"
MODE = "CRITICAL_ATTACK_UP"
...
# 0.7421875× attack + 2.5× conversion
BASE_PARAMS = [
    {"f": 0.1, "e_con": 0.2, "e_rech": 0.4},
    {"attack": 0.0022265625, "h": 0.02, "e_con": 0.3, "e_gain": 0.5, "conv": 0.75},
    {"attack": 0.0037109375, "h": 0.03, "e_con": 0.4, "e_gain": 0.6, "conv": 0.625},
    {"attack": 0.0059375, "h": 0.04, "e_con": 0.5, "e_gain": 0.8, "conv": 0.5},
    {"attack": 0.00890625, "h": 0.05, "e_con": 0.6, "e_gain": 1.0, "conv": 0.375},
    {"attack": 0.01113281, "h": 0.06, "e_con": 0.7, "e_gain": 1.2, "conv": 0.3},
    {"attack": 0.01335938, "h": 0.07, "e_con": 0.8, "e_gain": 1.4, "conv": 0.25}
]

SEEDS = list(range(6420, 6440))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run critical attack upper bound experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c422_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 422: CRITICAL ATTACK UPPER BOUND")
    ...
    print(f"Attack: 0.7421875×, Conversion: 2.5×")
    print("=" * 80)
    print()
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c422_critical_attack_upper_results.json"
