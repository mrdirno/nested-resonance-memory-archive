#!/usr/bin/env python3
"""
CYCLE 348: THRESHOLD TEST K=201
...
Purpose:
  Final pinpoint of critical K threshold.

Background:
  C340: K=600→200 - 0% survival
  C347: K=600→202 - 90% survival
  C348: K=600→201 - exact boundary
"""
...
CYCLE_ID = "C348"
CYCLE_NAME = "Threshold Test K=201"
MODE = "THRESHOLD_201"
...
def run_experiment(seed: int, cycles: int) -> dict:
    ...
    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c348_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 348: THRESHOLD TEST K=201")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c348_threshold_201_results.json"
