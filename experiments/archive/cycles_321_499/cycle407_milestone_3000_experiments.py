#!/usr/bin/env python3
"""
CYCLE 407: 3000 EXPERIMENT MILESTONE - BOUNDARY REFINEMENT
...
Purpose:
  MILESTONE: Reach 3000 total experiments
  Refine overshoot boundary at 0.7× attack.

Background:
  Overshoot boundary at 2.5× conversion:
  - C405: 0.625× attack - 100%
  - C406: 0.6875× attack - 90%
  - C400: 0.75× attack - 80%

  C407: 0.7× attack - expect ~85%?

Design:
  - K declines from 600 to 200 over 40 cycles
  - Attack: 0.7×, Conversion: 2.5×
  - 20 seeds
...
# 0.7× attack + 2.5× conversion
BASE_PARAMS = [
    {"f": 0.1, "e_con": 0.2, "e_rech": 0.4},
    {"attack": 0.0021, "h": 0.02, "e_con": 0.3, "e_gain": 0.5, "conv": 0.75},
    {"attack": 0.0035, "h": 0.03, "e_con": 0.4, "e_gain": 0.6, "conv": 0.625},
    {"attack": 0.0056, "h": 0.04, "e_con": 0.5, "e_gain": 0.8, "conv": 0.5},
    {"attack": 0.0084, "h": 0.05, "e_con": 0.6, "e_gain": 1.0, "conv": 0.375},
    {"attack": 0.0105, "h": 0.06, "e_con": 0.7, "e_gain": 1.2, "conv": 0.3},
    {"attack": 0.0126, "h": 0.07, "e_con": 0.8, "e_gain": 1.4, "conv": 0.25}
]

SEEDS = list(range(6120, 6140))
...
def run_experiment(seed: int, cycles: int) -> dict:
    ...
    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c407_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 407: 3000 EXPERIMENT MILESTONE")
    ...
    print(f"Attack: 0.7×, Conversion: 2.5×")
    print("=" * 80)
    print()
    ...
    print("\n" + "=" * 80)
    print("MILESTONE REACHED: 3000+ EXPERIMENTS!")
    print("=" * 80)
    ...
    output = {
        ...
        "milestone": "3000 experiments",
        "results": results
    }

    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c407_milestone_3000_experiments_results.json"
    with open(output_path, 'w') as f:
        json.dump(output, f, indent=2)

    print(f"\nResults saved to: {output_path}")
    print("\n" + "=" * 80)
    print("C407 COMPLETE - 3000+ EXPERIMENTS MILESTONE!")
    print("=" * 80)
