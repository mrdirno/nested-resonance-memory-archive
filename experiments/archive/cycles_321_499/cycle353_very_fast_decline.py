...
Purpose:
  Test very fast rate decline to find collapse transition.

Background:
  C340: Instant (0 cycles) - 0% survival
  C352: Fast (1000 cycles) - 85% survival
  C353: Very fast (100 cycles) - test transition

Design:
  - K declines from 600 to 200 over 100 cycles
  - Rate: 4 K/cycle
  - 20 seeds
"""
...
CYCLE_ID = "C353"
CYCLE_NAME = "Very Fast K Decline"
MODE = "VERY_FAST_DECLINE"

CYCLES = 30000
K_START = 600
K_END = 200
DECLINE_CYCLES = 100  # Very fast
...
SEEDS = list(range(5040, 5060))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run very fast decline experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c353_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 353: VERY FAST K DECLINE")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c353_very_fast_decline_results.json"
