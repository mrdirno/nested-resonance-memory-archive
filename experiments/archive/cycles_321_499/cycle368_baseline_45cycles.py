#!/usr/bin/env python3
"""
CYCLE 368: BASELINE ATTACK - 45 CYCLES
...
Purpose:
  Compare with 1.25× attack at 45 cycles to find crossover.

Background:
  C359: 40 cycles, 1.0× attack - 50% survival
  C367: 45 cycles, 1.25× attack - 55% survival
  C355: 50 cycles, 1.0× attack - 80% survival
  C368: 45 cycles, 1.0× attack - pinpoint crossover

Design:
  - K declines from 600 to 200 over 45 cycles
  - Rate: 8.9 K/cycle
  - Attack rates: 1.0× baseline
  - 20 seeds
"""
...
CYCLE_ID = "C368"
CYCLE_NAME = "Baseline Attack 45 Cycles"
MODE = "BASELINE_45"
...
SEEDS = list(range(5340, 5360))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run baseline attack at 45 cycles."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c368_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 368: BASELINE ATTACK - 45 CYCLES")
    ...
    print(f"Attack rates: 1.0× baseline")
    print("=" * 80)
    print()
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c368_baseline_45cycles_results.json"
