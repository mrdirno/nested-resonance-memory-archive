#!/usr/bin/env python3
"""
CYCLE 391: BASELINE CONFIGURATION - SLOW DECLINE (60 CYCLES)
...
Purpose:
  Compare baseline with optimal at slow decline.

Background:
  C389: Optimal (0.5× atk + 2.0× conv) at 60 cycles - 100%
  C391: Baseline at 60 cycles - expect ~80%?
...
CYCLE_ID = "C391"
CYCLE_NAME = "Baseline Slow Decline"
MODE = "BASE_SLOW_DECLINE"
...
SEEDS = list(range(5800, 5820))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run baseline config at slow decline."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c391_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 391: BASELINE CONFIGURATION - SLOW DECLINE (60 CYCLES)")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c391_baseline_slow_decline_results.json"
