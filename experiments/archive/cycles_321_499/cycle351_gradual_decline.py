...
Purpose:
  Test if gradual K decline allows survival vs sudden collapse.

Research Question:
  Does slow K decline (600→200 over 20000 cycles) allow system to track
  and avoid collapse, unlike sudden drop?

Background:
  C340: Sudden K=600→200 - 0% survival
  C351: Gradual K=600→200 - test adaptation

Design:
  - K starts at 600
  - Linear decline to 200 over 20000 cycles
  - Tests if tracking can avoid collapse
  - 20 seeds
"""
...
CYCLE_ID = "C351"
CYCLE_NAME = "Gradual K Decline"
MODE = "GRADUAL_DECLINE"

CYCLES = 30000
K_START = 600
K_END = 200
DECLINE_CYCLES = 20000  # Gradual over 20k cycles
...
def run_experiment(seed: int, cycles: int) -> dict:
    """Run gradual decline experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c351_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 351: GRADUAL K DECLINE")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c351_gradual_decline_results.json"
