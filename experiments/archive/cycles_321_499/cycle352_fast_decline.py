...
Purpose:
  Test intermediate rate decline between tracking and collapse.

Background:
  C340: Instant (0 cycles) - 0% survival
  C351: Slow (20000 cycles) - 85% survival
  C352: Fast (1000 cycles) - test transition

Design:
  - K declines from 600 to 200 over 1000 cycles
  - Rate: 0.4 K/cycle
  - 20 seeds
"""
...
CYCLE_ID = "C352"
CYCLE_NAME = "Fast K Decline"
MODE = "FAST_DECLINE"

CYCLES = 30000
K_START = 600
K_END = 200
DECLINE_CYCLES = 1000  # Fast decline
...
SEEDS = list(range(5020, 5040))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run fast decline experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c352_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 352: FAST K DECLINE")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c352_fast_decline_results.json"
