#!/usr/bin/env python3
"""
CYCLE 330: STRONG SUBOPTIMALITY TEST
...
Purpose:
  Test if strong suboptimality (0.5×) triggers directional selection.

Research Question:
  Is 0.5× outside the viable zone, creating selection pressure?

Background:
  C328: Stabilizing selection at optimum (1.0)
  C329: No evolution from mild suboptimality (0.7)
  C330: Strong suboptimality (0.5) - outside viable zone?

Design:
  - 7 populations
  - Initial trait = 0.5 (strongly suboptimal)
  - K=600, L6=N=2
  - 9 seeds
  - Total: 9 experiments
"""
...
CYCLE_ID = "C330"
CYCLE_NAME = "Strong Suboptimality Test"
MODE = "STRONG_SUBOPT"

CYCLES = 30000
K = 600
INITIAL = [300, 30, 10, 5, 3, 2, 2]
INITIAL_TRAIT = 0.5  # Strongly suboptimal
...
SEEDS = list(range(3700, 3709))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run strong suboptimality experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c330_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 330: STRONG SUBOPTIMALITY TEST")
    ...
    print(f"Starting trait: {INITIAL_TRAIT} (strongly suboptimal)")
    print("=" * 80)
    print()
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c330_strong_suboptimality_results.json"
