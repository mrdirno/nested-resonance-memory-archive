#!/usr/bin/env python3
"""
CYCLE 324: EIGHT-TROPHIC STATISTICAL CHARACTERIZATION
...
Purpose:
  Statistical characterization of bifurcation at eight trophic levels.

Research Question:
  What is the stability rate at eight levels compared to seven (85%)?

Background:
  C323: Seven-trophic 85% at K=600
  C324: Eight-trophic at K=1200 with 20 seeds
...
CYCLE_ID = "C324"
CYCLE_NAME = "Eight-Trophic Statistical"
MODE = "EIGHT_STAT"

CYCLES = 30000
K = 1200
INITIAL = [600, 60, 20, 10, 6, 4, 2, 1]
...
SEEDS = list(range(3100, 3120))  # 20 seeds


def run_experiment(seed: int, cycles: int) -> dict:
    """Run eight-trophic statistical experiment."""

    n_levels = 8

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c324_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 324: EIGHT-TROPHIC STATISTICAL CHARACTERIZATION")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c324_eight_statistical_results.json"
