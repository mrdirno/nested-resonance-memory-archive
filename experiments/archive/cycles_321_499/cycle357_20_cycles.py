...
Purpose:
  Narrow critical rate between 10 and 30 cycles.

Background:
  C354: 10 cycles - 25% survival
  C356: 30 cycles - 45% survival
  C357: 20 cycles - test midpoint
...
CYCLE_ID = "C357"
CYCLE_NAME = "20-Cycle K Decline"
MODE = "20_CYCLE_DECLINE"
...
SEEDS = list(range(5120, 5140))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run 20-cycle decline experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c357_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 357: 20-CYCLE K DECLINE")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c357_20_cycles_results.json"
