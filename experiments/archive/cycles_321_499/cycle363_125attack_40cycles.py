#!/usr/bin/env python3
"""
CYCLE 363: 1.25× ATTACK RATE - 40 CYCLES
...
Purpose:
  Complete the attack rate response curve.

Background:
  C361: 0.5× attack - 5% survival
  C362: 0.75× attack - 35% survival
  C359: 1.0× attack - 50% survival
  C363: 1.25× attack - test transition
  C360: 1.5× attack - 20% survival
...
CYCLE_ID = "C363"
CYCLE_NAME = "1.25x Attack Rate 40 Cycles"
MODE = "125_ATTACK_40"
...
SEEDS = list(range(5240, 5260))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run 1.25× attack rate experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c363_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 363: 1.25× ATTACK RATE - 40 CYCLES")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c363_125attack_40cycles_results.json"
