#!/usr/bin/env python3
"""
CYCLE 325: N=2 TOP PREDATOR TEST
...
Purpose:
  Test if N=2 at top increases stability from 85%.

Research Question:
  Does redundancy at top eliminate the 15% extinction risk?

Background:
  C323: Seven-trophic 85% with N=1 at L6
  C324: Eight-trophic 85% with N=1 at L7
  C325: Test N=2 at top

Design:
  - 7 populations (K=600)
  - L6 starts at N=2 instead of N=1
  - 20 seeds
...
CYCLE_ID = "C325"
CYCLE_NAME = "N=2 Top Predator"
MODE = "N2_TOP"

CYCLES = 30000
K = 600
INITIAL = [300, 30, 10, 5, 3, 2, 2]  # L6 at N=2
...
SEEDS = list(range(3200, 3220))  # 20 seeds


def run_experiment(seed: int, cycles: int) -> dict:
    """Run N=2 top predator experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c325_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 325: N=2 TOP PREDATOR TEST")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c325_n2_top_results.json"
