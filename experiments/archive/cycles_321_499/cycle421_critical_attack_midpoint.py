#!/usr/bin/env python3
"""
CYCLE 421: CRITICAL ATTACK MIDPOINT
...
Purpose:
  Locate critical attack value for phase transition.

Background:
  At 0.71875× + 2.5× conv: 100% (recovery mode)
  At 0.75× + 2.5× conv: 80% (overshoot mode)

  C421: 0.734375× + 2.5× - which mode dominates?
...
CYCLE_ID = "C421"
CYCLE_NAME = "Critical Attack Midpoint"
MODE = "CRITICAL_ATTACK_MID"
...
# 0.734375× attack + 2.5× conversion
BASE_PARAMS = [
    {"f": 0.1, "e_con": 0.2, "e_rech": 0.4},
    {"attack": 0.002203125, "h": 0.02, "e_con": 0.3, "e_gain": 0.5, "conv": 0.75},
    {"attack": 0.003671875, "h": 0.03, "e_con": 0.4, "e_gain": 0.6, "conv": 0.625},
    {"attack": 0.005875, "h": 0.04, "e_con": 0.5, "e_gain": 0.8, "conv": 0.5},
    {"attack": 0.0088125, "h": 0.05, "e_con": 0.6, "e_gain": 1.0, "conv": 0.375},
    {"attack": 0.011015625, "h": 0.06, "e_con": 0.7, "e_gain": 1.2, "conv": 0.3},
    {"attack": 0.01321875, "h": 0.07, "e_con": 0.8, "e_gain": 1.4, "conv": 0.25}
]

SEEDS = list(range(6400, 6420))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run critical attack midpoint experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c421_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 421: CRITICAL ATTACK MIDPOINT")
    ...
    print(f"Attack: 0.734375×, Conversion: 2.5×")
    print("=" * 80)
    print()
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c421_critical_attack_midpoint_results.json"
