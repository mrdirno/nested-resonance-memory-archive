#!/usr/bin/env python3
"""
CYCLE 344: THRESHOLD TEST K=225
...
Purpose:
  Narrow critical K threshold between 200 and 250.

Background:
  C340: K=600→200 - 0% survival
  C343: K=600→250 - 90% survival
  C344: K=600→225 - test midpoint
"""
...
CYCLE_ID = "C344"
CYCLE_NAME = "Threshold Test K=225"
MODE = "THRESHOLD_225"
...
def run_experiment(seed: int, cycles: int) -> dict:
    ...
    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c344_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 344: THRESHOLD TEST K=225")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c344_threshold_225_results.json"
