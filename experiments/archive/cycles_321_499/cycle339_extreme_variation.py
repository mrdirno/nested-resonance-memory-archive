#!/usr/bin/env python3
"""
CYCLE 339: EXTREME ENVIRONMENTAL VARIATION
...
Purpose:
  Test extreme environmental variation to find breakdown threshold.

Research Question:
  At what point does the paradoxical stabilization fail?

Background:
  C337: K ± 200 (33%) → 85% coexist
  C338: K ± 400 (67%) → 100% coexist
  C339: K ± 500 (83%) → ?

Design:
  - K oscillates: 100 to 1100
  - K_mean = 600, K_amplitude = 500
  - Period = 5000 cycles
  - 20 seeds
...
CYCLE_ID = "C339"
CYCLE_NAME = "Extreme Environmental Variation"
MODE = "EXTREME_VAR"

CYCLES = 30000
K_MEAN = 600
K_AMPLITUDE = 500  # K varies from 100 to 1100
PERIOD = 5000
...
SEEDS = list(range(4600, 4620))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run extreme variation experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c339_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 339: EXTREME ENVIRONMENTAL VARIATION")
    ...
    print(f"K oscillates: {K_MEAN} ± {K_AMPLITUDE} (100-1100)")
    print("=" * 80)
    print()
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c339_extreme_variation_results.json"
