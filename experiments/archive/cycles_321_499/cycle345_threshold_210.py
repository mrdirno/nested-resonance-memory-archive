#!/usr/bin/env python3
"""
CYCLE 345: THRESHOLD TEST K=210
...
Purpose:
  Find exact critical K threshold near 200.

Background:
  C340: K=600→200 - 0% survival
  C344: K=600→225 - 85% survival
  C345: K=600→210 - test near threshold
"""
...
CYCLE_ID = "C345"
CYCLE_NAME = "Threshold Test K=210"
MODE = "THRESHOLD_210"
...
def run_experiment(seed: int, cycles: int) -> dict:
    ...
    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c345_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 345: THRESHOLD TEST K=210")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c345_threshold_210_results.json"
