#!/usr/bin/env python3
"""
CYCLE 255: MECHANISM VALIDATION - H1 × H2 Factorial Interaction
...
CYCLES = 3000
MAX_AGENTS = 100
RESULTS_FILE = Path(__file__).parent / "results" / "cycle255_h1h2_mechanism_validation_results.json"
...
def main():
    ...
    output = {
        'metadata': {
            'cycle': 255,
            'experiment': 'h1h2_mechanism_validation',
