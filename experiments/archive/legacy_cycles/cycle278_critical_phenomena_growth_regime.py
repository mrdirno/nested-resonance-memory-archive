...
- E_consume = 0.4, E_recharge = 0.6 (Optimal growth regime, E_net = +0.2)
...
# Experiment metadata
CYCLE_ID = "C278"
CYCLE_NAME = "Critical Phenomena Near f_crit (Growth Regime)"
AUTHOR = "Aldrin Payopay <aldrin.gdf@gmail.com>"
...
# Optimal Growth Regime parameters (E_net = +0.2)
ENERGY_PARAMS = {
    "E_consume": 0.4,
    "E_recharge": 0.6,
    "net_energy": +0.2
...
def run_single_experiment(
    ...
    db_path = RESULTS_DIR / f"c278_CRITICAL_{freq_pct}pct_seed{seed}.db"
...
def run_campaign():
    ...
    results_file = RESULTS_DIR / "c278_critical_phenomena_results.json"
