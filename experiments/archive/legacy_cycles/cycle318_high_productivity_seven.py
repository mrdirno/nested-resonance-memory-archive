#!/usr/bin/env python3
"""
CYCLE 318: HIGH PRODUCTIVITY SEVEN-TROPHIC
...
Purpose:
  Test whether higher productivity stabilizes seven levels.

Research Question:
  Does doubling K (600→1200) stabilize seven-level chains?

Background:
  C317: Seven-trophic at 67% stability (K=600)
  C318: Test K=1200 for higher energy base
...
CYCLE_ID = "C318"
CYCLE_NAME = "High Productivity Seven-Trophic"
MODE = "HIGH_PROD_SEVEN"

CYCLES = 30000

# Scaled initial populations for K=1200
INITIAL_K600 = [300, 30, 10, 5, 3, 2, 1]
INITIAL_K1200 = [600, 60, 20, 10, 6, 4, 2]
...
CONDITIONS = [
    {"name": "K600_seven", "K": 600, "initial": INITIAL_K600},
    {"name": "K1200_seven", "K": 1200, "initial": INITIAL_K1200}
]
SEEDS = [2500, 2501, 2502]


def run_experiment(condition: dict, seed: int, cycles: int) -> dict:
    """Run high productivity experiment."""
    ...
    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c318_{label}_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 318: HIGH PRODUCTIVITY SEVEN-TROPHIC")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c318_high_prod_seven_results.json"
