...
def run_generation():
    ...
    budget = random.uniform(4515.814173778096, 6773.721260667145)
    gain_base = random.uniform(275.4299074850558, 336.636553592846)
    cost_base = random.uniform(41.24292004397181, 50.40801338707666)
    ...
    result = {
        ...
        "params_used": {"budget_range": [4515.814173778096, 6773.721260667145], "gain_range": [275.4299074850558, 336.636553592846], "cost_range": [41.24292004397181, 50.40801338707666], "k": 6.935734839559108, "epsilon": 0.059237624643426356, "complexity": 2}
    }
