...
def run_generation():
    ...
    budget = random.uniform(354.8505905885689, 532.2758858828532)
    gain_base = random.uniform(130.2347134680047, 159.1757609053391)
    cost_base = random.uniform(42.17599183626179, 51.54843446654218)
    ...
    result = {
        ...
        "params_used": {"budget_range": [354.8505905885689, 532.2758858828532], "gain_range": [130.2347134680047, 159.1757609053391], "cost_range": [42.17599183626179, 51.54843446654218], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
