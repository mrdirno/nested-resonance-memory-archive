...
def run_generation():
    ...
    budget = random.uniform(576.9278069208284, 865.3917103812427)
    gain_base = random.uniform(106.16487542972675, 129.75706996966602)
    cost_base = random.uniform(39.29183233032923, 48.02335062595795)
    ...
    result = {
        ...
        "params_used": {"budget_range": [576.9278069208284, 865.3917103812427], "gain_range": [106.16487542972675, 129.75706996966602], "cost_range": [39.29183233032923, 48.02335062595795], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
