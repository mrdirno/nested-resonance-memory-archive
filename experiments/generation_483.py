...
def run_generation():
    ...
    budget = random.uniform(76.63988563859526, 114.95982845789287)
    gain_base = random.uniform(117.55909123370094, 143.68333373007894)
    cost_base = random.uniform(21.47034887661792, 26.241537515866348)
    ...
    result = {
        ...
        "params_used": {"budget_range": [76.63988563859526, 114.95982845789287], "gain_range": [117.55909123370094, 143.68333373007894], "cost_range": [21.47034887661792, 26.241537515866348], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
