...
def run_generation():
    ...
    budget = random.uniform(4485.925230920818, 6728.887846381226)
    gain_base = random.uniform(270.08730206002843, 330.10670251781255)
    cost_base = random.uniform(39.35327475910109, 48.09844692779022)
    ...
    result = {
        ...
        "params_used": {"budget_range": [4485.925230920818, 6728.887846381226], "gain_range": [270.08730206002843, 330.10670251781255], "cost_range": [39.35327475910109, 48.09844692779022], "k": 6.935734839559108, "epsilon": 0.059237624643426356, "complexity": 2}
    }
