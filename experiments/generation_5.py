...
def run_generation():
    ...
    budget = random.uniform(618.630305441156, 756.1037066503019)
    gain = random.uniform(127.07386380817923, 155.31250020999684)
    cost = random.uniform(34.652421405821315, 42.35295949600383)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [618.630305441156, 756.1037066503019], "gain_range": [127.07386380817923, 155.31250020999684], "cost_range": [34.652421405821315, 42.35295949600383], "k": 1.0, "epsilon": 0.1}
    }
