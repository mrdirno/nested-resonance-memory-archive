...
def run_generation():
    ...
    budget = random.uniform(4715.43563788458, 7073.15345682687)
    gain_base = random.uniform(180.8831879727167, 221.07945196665375)
    cost_base = random.uniform(74.76991877518884, 91.38545628078637)
    ...
    result = {
        ...
        "params_used": {"budget_range": [4715.43563788458, 7073.15345682687], "gain_range": [180.8831879727167, 221.07945196665375], "cost_range": [74.76991877518884, 91.38545628078637], "k": 0.22255275219284712, "epsilon": 0.4857845429736557, "complexity": 2}
    }
