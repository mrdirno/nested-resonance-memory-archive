...
def run_generation():
    ...
    gain = random.uniform(10.0, 1000.0)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [1.0, 10000.0], "gain_range": [10.0, 1000.0], "cost_range": [1.0, 100.0], "k": 4.891180113933895, "epsilon": 0.992416018679223}
    }
