#!/usr/bin/env python3
"""Cycle 3149: Phase 165 Synthesis - Gate 766"""
import json
...
def main():
    print("=" * 70)
    print("CYCLE 3149: PHASE 165 SYNTHESIS")
    print("Gate 766 - Hospitality Psychology Complete")
    print("=" * 70)

    results_dir = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results"
    phase165_files = [
        "cycle3144_room_management_bcp.json",
        "cycle3145_guest_services_bcp.json",
        "cycle3146_food_beverage_bcp.json",
        "cycle3147_facility_maintenance_bcp.json",
        "cycle3148_revenue_management_bcp.json"
    ]
    ...
    print(f"\nPHASE 165 TOTAL: {total_correct}/{total_predictions} ({total_correct/total_predictions*100:.1f}%)")
    ...
    if total_correct >= 90:
        ...
        print("\n✓ Hospitality systems are budget-dependent")
    ...
    print(f"\nGATE 766 SYNTHESIS: {synthesis_tests['correct']}/4")
    print(f"\nFINAL PHASE 165: {total_correct}/{total_predictions} ({total_correct/total_predictions*100:.1f}%)")
    ...
    with open(f"{results_dir}/cycle3149_phase165_synthesis.json", "w") as f:
        json.dump(synthesis, f, indent=2)

    print("\n" + "=" * 70)
    print("PHASE 165: HOSPITALITY PSYCHOLOGY COMPLETE")
    print("=" * 70)
