...
def run_generation():
    ...
    budget = random.uniform(689.4389456391968, 1034.158418458795)
    gain = random.uniform(97.83694453324726, 119.57848776285778)
    cost = random.uniform(36.743926561859894, 44.90924357560654)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [689.4389456391968, 1034.158418458795], "gain_range": [97.83694453324726, 119.57848776285778], "cost_range": [36.743926561859894, 44.90924357560654], "k": 1.0, "epsilon": 0.1}
    }
