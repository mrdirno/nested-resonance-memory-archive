...
def run_generation():
    ...
    budget = random.uniform(557.385311059324, 836.0779665889858)
    gain_base = random.uniform(121.88200793047913, 148.96689858169674)
    cost_base = random.uniform(29.96223741559035, 36.62051239683265)
    ...
    result = {
        ...
        "params_used": {"budget_range": [557.385311059324, 836.0779665889858], "gain_range": [121.88200793047913, 148.96689858169674], "cost_range": [29.96223741559035, 36.62051239683265], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
