...
def run_generation():
    ...
    budget = random.uniform(201.60738967464215, 302.41108451196317)
    gain_base = random.uniform(107.57932798249917, 131.48584531194342)
    cost_base = random.uniform(33.89278361523246, 41.42451330750634)
    ...
    result = {
        ...
        "params_used": {"budget_range": [201.60738967464215, 302.41108451196317], "gain_range": [107.57932798249917, 131.48584531194342], "cost_range": [33.89278361523246, 41.42451330750634], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
