...
def run_generation():
    ...
    budget = random.uniform(209.62574776153852, 314.43862164230774)
    gain_base = random.uniform(48.55737319608417, 59.34790057299177)
    cost_base = random.uniform(22.92380066088597, 28.017978585527295)
    ...
    result = {
        ...
        "params_used": {"budget_range": [209.62574776153852, 314.43862164230774], "gain_range": [48.55737319608417, 59.34790057299177], "cost_range": [22.92380066088597, 28.017978585527295], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
