...
def run_generation():
    ...
    budget = random.uniform(2197.822809738925, 3296.734214608388)
    gain_base = random.uniform(116.15768316432724, 141.97050164528886)
    cost_base = random.uniform(1.646506139282466, 2.0123963924563473)
    ...
    result = {
        ...
        "params_used": {"budget_range": [2197.822809738925, 3296.734214608388], "gain_range": [116.15768316432724, 141.97050164528886], "cost_range": [1.646506139282466, 2.0123963924563473], "k": 7.698825262071338, "epsilon": 0.31888056002057574, "complexity": 2}
    }
