...
def run_generation():
    ...
    budget = random.uniform(360.01971071856906, 540.0295660778536)
    gain_base = random.uniform(145.72328057245727, 178.1062318107811)
    cost_base = random.uniform(32.344941124191116, 39.53270581845581)
    ...
    result = {
        ...
        "params_used": {"budget_range": [360.01971071856906, 540.0295660778536], "gain_range": [145.72328057245727, 178.1062318107811], "cost_range": [32.344941124191116, 39.53270581845581], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
