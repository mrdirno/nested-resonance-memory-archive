...
def run_generation():
    ...
    budget = random.uniform(741.3400142399713, 1112.010021359957)
    gain = random.uniform(53.21737694432535, 65.043460709731)
    cost = random.uniform(14.049524395763422, 17.171640928155295)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [741.3400142399713, 1112.010021359957], "gain_range": [53.21737694432535, 65.043460709731], "cost_range": [14.049524395763422, 17.171640928155295], "k": 1.0, "epsilon": 0.1}
    }
