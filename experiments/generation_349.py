...
def run_generation():
    ...
    budget = random.uniform(457.4532590411067, 686.17988856166)
    gain_base = random.uniform(234.96911606364662, 287.18447518890144)
    cost_base = random.uniform(5.986239124701637, 7.3165144857464455)
    ...
    result = {
        ...
        "params_used": {"budget_range": [457.4532590411067, 686.17988856166], "gain_range": [234.96911606364662, 287.18447518890144], "cost_range": [5.986239124701637, 7.3165144857464455], "k": 6.158352340611331, "epsilon": 0.30682498013289633, "complexity": 2}
    }
