...
def run_generation():
    ...
    budget = random.uniform(509.68511982080975, 764.5276797312146)
    gain_base = random.uniform(48.02427907204488, 58.69634108805486)
    cost_base = random.uniform(10.991943551079281, 13.434597673541345)
    ...
    result = {
        ...
        "params_used": {"budget_range": [509.68511982080975, 764.5276797312146], "gain_range": [48.02427907204488, 58.69634108805486], "cost_range": [10.991943551079281, 13.434597673541345], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
