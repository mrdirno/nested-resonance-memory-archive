...
def run_generation():
    ...
    budget = random.uniform(1913.5460005006407, 2870.319000750961)
    gain_base = random.uniform(820.0663520803109, 1000.0)
    cost_base = random.uniform(2.0691959528466164, 2.52901727570142)
    ...
    result = {
        ...
        "params_used": {"budget_range": [1913.5460005006407, 2870.319000750961], "gain_range": [820.0663520803109, 1000.0], "cost_range": [2.0691959528466164, 2.52901727570142], "k": 0.4521598713923174, "epsilon": 0.4026574009126241, "complexity": 2}
    }
