...
def run_generation():
    ...
    budget = random.uniform(1144.6071846089487, 1716.9107769134228)
    gain_base = random.uniform(855.289052025319, 1000.0)
    cost_base = random.uniform(44.42626069288764, 54.29876306908489)
    ...
    result = {
        ...
        "params_used": {"budget_range": [1144.6071846089487, 1716.9107769134228], "gain_range": [855.289052025319, 1000.0], "cost_range": [44.42626069288764, 54.29876306908489], "k": 2.0902790366501907, "epsilon": 0.9736883768041519, "complexity": 2}
    }
