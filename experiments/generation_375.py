...
def run_generation():
    ...
    budget = random.uniform(6865.586132605484, 10000.0)
    gain_base = random.uniform(614.3381131604438, 750.8576938627647)
    cost_base = random.uniform(88.17044055259024, 100.0)
    ...
    result = {
        ...
        "params_used": {"budget_range": [6865.586132605484, 10000.0], "gain_range": [614.3381131604438, 750.8576938627647], "cost_range": [88.17044055259024, 100.0], "k": 9.262558568547654, "epsilon": 0.6044975830664067, "complexity": 2}
    }
