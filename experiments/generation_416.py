...
def run_generation():
    ...
    budget = random.uniform(2225.7201697153528, 3338.580254573029)
    gain_base = random.uniform(125.35616199074555, 153.2130868775779)
    cost_base = random.uniform(1.6383317265206854, 2.0024054435252823)
    ...
    result = {
        ...
        "params_used": {"budget_range": [2225.7201697153528, 3338.580254573029], "gain_range": [125.35616199074555, 153.2130868775779], "cost_range": [1.6383317265206854, 2.0024054435252823], "k": 7.698825262071338, "epsilon": 0.31888056002057574, "complexity": 2}
    }
