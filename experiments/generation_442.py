...
def run_generation():
    ...
    budget = random.uniform(296.7211507439175, 445.0817261158762)
    gain_base = random.uniform(153.54473282849872, 187.66578456816512)
    cost_base = random.uniform(19.16416343081992, 23.422866415446567)
    ...
    result = {
        ...
        "params_used": {"budget_range": [296.7211507439175, 445.0817261158762], "gain_range": [153.54473282849872, 187.66578456816512], "cost_range": [19.16416343081992, 23.422866415446567], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
