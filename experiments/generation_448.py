...
def run_generation():
    ...
    budget = random.uniform(316.74341567703385, 475.1151235155507)
    gain_base = random.uniform(181.584144229411, 221.93617628039124)
    cost_base = random.uniform(14.32799132154229, 17.511989392996135)
    ...
    result = {
        ...
        "params_used": {"budget_range": [316.74341567703385, 475.1151235155507], "gain_range": [181.584144229411, 221.93617628039124], "cost_range": [14.32799132154229, 17.511989392996135], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
