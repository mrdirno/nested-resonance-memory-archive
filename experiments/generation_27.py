...
def run_generation():
    ...
    budget = random.uniform(351.43861295109707, 527.1579194266455)
    gain = random.uniform(124.56157570572043, 152.2419258625472)
    cost = random.uniform(21.802578638772875, 26.647596114055737)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [351.43861295109707, 527.1579194266455], "gain_range": [124.56157570572043, 152.2419258625472], "cost_range": [21.802578638772875, 26.647596114055737], "k": 1.0, "epsilon": 0.1}
    }
