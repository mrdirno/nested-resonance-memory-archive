...
def run_generation():
    ...
    budget = random.uniform(862.3003343271993, 1293.4505014907988)
    gain_base = random.uniform(353.34362766891513, 431.864433817563)
    cost_base = random.uniform(65.5733021075556, 80.14514702034575)
    ...
    result = {
        ...
        "params_used": {"budget_range": [862.3003343271993, 1293.4505014907988], "gain_range": [353.34362766891513, 431.864433817563], "cost_range": [65.5733021075556, 80.14514702034575], "k": 0.5044925026778514, "epsilon": 0.7786510323888909, "complexity": 2}
    }
