...
def run_generation():
    ...
    budget = random.uniform(2545.9830218998904, 3818.9745328498348)
    gain_base = random.uniform(795.1734489965673, 971.8786598846934)
    cost_base = random.uniform(2.0677307967739016, 2.527226529390324)
    ...
    result = {
        ...
        "params_used": {"budget_range": [2545.9830218998904, 3818.9745328498348], "gain_range": [795.1734489965673, 971.8786598846934], "cost_range": [2.0677307967739016, 2.527226529390324], "k": 0.4521598713923174, "epsilon": 0.4026574009126241, "complexity": 2}
    }
