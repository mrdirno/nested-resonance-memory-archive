...
def run_generation():
    ...
    budget = random.uniform(486.796704504435, 730.1950567566524)
    gain_base = random.uniform(178.20191901891846, 217.80234546756702)
    cost_base = random.uniform(43.32322636755061, 52.95061000478408)
    ...
    result = {
        ...
        "params_used": {"budget_range": [486.796704504435, 730.1950567566524], "gain_range": [178.20191901891846, 217.80234546756702], "cost_range": [43.32322636755061, 52.95061000478408], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
