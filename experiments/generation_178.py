...
def run_generation():
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=2.7893880547222842, epsilon=0.5631495752193476))
    ...
    result = {
        ...
        "params_used": {"budget_range": [1.0, 10000.0], "gain_range": [10.0, 1000.0], "cost_range": [1.0, 100.0], "k": 2.7893880547222842, "epsilon": 0.5631495752193476, "complexity": 2}
    }
