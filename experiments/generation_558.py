...
def run_generation():
    ...
    budget = random.uniform(371.9143465019422, 557.8715197529133)
    gain_base = random.uniform(127.50410340747379, 155.83834860913464)
    cost_base = random.uniform(44.977957771498446, 54.9730594984981)
    ...
    result = {
        ...
        "params_used": {"budget_range": [371.9143465019422, 557.8715197529133], "gain_range": [127.50410340747379, 155.83834860913464], "cost_range": [44.977957771498446, 54.9730594984981], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
