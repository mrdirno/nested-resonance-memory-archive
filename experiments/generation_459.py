...
def run_generation():
    ...
    budget = random.uniform(3926.5304897505303, 5889.795734625795)
    gain_base = random.uniform(391.9846843692705, 479.0923920068862)
    cost_base = random.uniform(68.25323198421985, 83.42061686960204)
    ...
    result = {
        ...
        "params_used": {"budget_range": [3926.5304897505303, 5889.795734625795], "gain_range": [391.9846843692705, 479.0923920068862], "cost_range": [68.25323198421985, 83.42061686960204], "k": 4.5140714246268105, "epsilon": 0.29271990739874953, "complexity": 2}
    }
