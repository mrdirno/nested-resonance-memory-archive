...
def run_generation():
    ...
    budget = random.uniform(6887.204883729422, 10000.0)
    gain_base = random.uniform(183.23738548686808, 223.9568044839499)
    cost_base = random.uniform(67.30729583045503, 82.26447268166726)
    ...
    result = {
        ...
        "params_used": {"budget_range": [6887.204883729422, 10000.0], "gain_range": [183.23738548686808, 223.9568044839499], "cost_range": [67.30729583045503, 82.26447268166726], "k": 0.22255275219284712, "epsilon": 0.4857845429736557, "complexity": 2}
    }
