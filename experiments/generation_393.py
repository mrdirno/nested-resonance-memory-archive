...
def run_generation():
    ...
    budget = random.uniform(648.0718707639046, 972.1078061458568)
    gain_base = random.uniform(146.52475116242348, 179.08580697629537)
    cost_base = random.uniform(20.919387579821716, 25.568140375337656)
    ...
    result = {
        ...
        "params_used": {"budget_range": [648.0718707639046, 972.1078061458568], "gain_range": [146.52475116242348, 179.08580697629537], "cost_range": [20.919387579821716, 25.568140375337656], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
