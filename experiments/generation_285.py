...
def run_generation():
    ...
    budget = random.uniform(16.934526722961717, 25.40179008444257)
    gain_base = random.uniform(148.18312506067002, 181.1127084074856)
    cost_base = random.uniform(4.726579305394737, 5.776930262149124)
    ...
    result = {
        ...
        "params_used": {"budget_range": [16.934526722961717, 25.40179008444257], "gain_range": [148.18312506067002, 181.1127084074856], "cost_range": [4.726579305394737, 5.776930262149124], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
