...
def run_generation():
    ...
    budget = random.uniform(704.5813983068495, 1056.872097460274)
    gain = random.uniform(97.09702112118715, 118.67413692589543)
    cost = random.uniform(32.65831730962887, 39.91572115621307)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [704.5813983068495, 1056.872097460274], "gain_range": [97.09702112118715, 118.67413692589543], "cost_range": [32.65831730962887, 39.91572115621307], "k": 1.0, "epsilon": 0.1}
    }
