...
def run_generation():
    ...
    budget = random.uniform(5234.165220925413, 7851.247831388118)
    gain_base = random.uniform(180.59496146207877, 220.72717512031852)
    cost_base = random.uniform(69.8526100738485, 85.3754123124815)
    ...
    result = {
        ...
        "params_used": {"budget_range": [5234.165220925413, 7851.247831388118], "gain_range": [180.59496146207877, 220.72717512031852], "cost_range": [69.8526100738485, 85.3754123124815], "k": 0.22255275219284712, "epsilon": 0.4857845429736557, "complexity": 2}
    }
