...
def run_generation():
    ...
    budget = random.uniform(24.23928568237432, 36.358928523561474)
    gain_base = random.uniform(137.93091852421207, 168.58223375181475)
    cost_base = random.uniform(20.66077813413754, 25.252062163945887)
    ...
    result = {
        ...
        "params_used": {"budget_range": [24.23928568237432, 36.358928523561474], "gain_range": [137.93091852421207, 168.58223375181475], "cost_range": [20.66077813413754, 25.252062163945887], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
