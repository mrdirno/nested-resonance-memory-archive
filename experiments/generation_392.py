...
def run_generation():
    ...
    budget = random.uniform(540.3185789267407, 810.4778683901109)
    gain_base = random.uniform(143.31956774181626, 175.16836057333097)
    cost_base = random.uniform(19.582814525747228, 23.93455108702439)
    ...
    result = {
        ...
        "params_used": {"budget_range": [540.3185789267407, 810.4778683901109], "gain_range": [143.31956774181626, 175.16836057333097], "cost_range": [19.582814525747228, 23.93455108702439], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
