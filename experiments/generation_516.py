...
def run_generation():
    ...
    budget = random.uniform(581.162459331081, 871.7436889966214)
    gain_base = random.uniform(197.48379039231563, 241.36907714616353)
    cost_base = random.uniform(46.240718233158915, 56.51643339608312)
    ...
    result = {
        ...
        "params_used": {"budget_range": [581.162459331081, 871.7436889966214], "gain_range": [197.48379039231563, 241.36907714616353], "cost_range": [46.240718233158915, 56.51643339608312], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
