...
def run_generation():
    ...
    budget = random.uniform(421.16346248167906, 631.7451937225185)
    gain_base = random.uniform(170.31704124982292, 208.16527263867246)
    cost_base = random.uniform(32.54327436041735, 39.775113107176765)
    ...
    result = {
        ...
        "params_used": {"budget_range": [421.16346248167906, 631.7451937225185], "gain_range": [170.31704124982292, 208.16527263867246], "cost_range": [32.54327436041735, 39.775113107176765], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
