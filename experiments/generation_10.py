...
def run_generation():
    ...
    budget = random.uniform(784.8713476969759, 1000.0)
    gain = random.uniform(178.60879399797255, 200.0)
    cost = random.uniform(43.73897245161077, 50.0)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [784.8713476969759, 1000.0], "gain_range": [178.60879399797255, 200.0], "cost_range": [43.73897245161077, 50.0], "k": 4.383393679925132, "epsilon": 0.28713725007074564}
    }
