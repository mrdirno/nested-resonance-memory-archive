...
def run_generation():
    ...
    budget = random.uniform(622.6520672561419, 933.9781008842126)
    gain = random.uniform(84.33517345594518, 103.0763231128219)
    cost = random.uniform(36.12525136969552, 44.153085007405636)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [622.6520672561419, 933.9781008842126], "gain_range": [84.33517345594518, 103.0763231128219], "cost_range": [36.12525136969552, 44.153085007405636], "k": 1.0, "epsilon": 0.1}
    }
