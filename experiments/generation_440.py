...
def run_generation():
    ...
    budget = random.uniform(3873.8575424245464, 5810.78631363682)
    gain_base = random.uniform(884.6053386976633, 1000.0)
    cost_base = random.uniform(40.50474622089712, 49.50580093665204)
    ...
    result = {
        ...
        "params_used": {"budget_range": [3873.8575424245464, 5810.78631363682], "gain_range": [884.6053386976633, 1000.0], "cost_range": [40.50474622089712, 49.50580093665204], "k": 3.3136398384246877, "epsilon": 0.47667923498748715, "complexity": 2}
    }
