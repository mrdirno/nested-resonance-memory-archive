...
def run_generation():
    ...
    budget = random.uniform(2581.8692567178005, 3872.8038850767007)
    gain_base = random.uniform(270.9834335934719, 331.2019743920212)
    cost_base = random.uniform(69.32947718855013, 84.7360276748946)
    ...
    result = {
        ...
        "params_used": {"budget_range": [2581.8692567178005, 3872.8038850767007], "gain_range": [270.9834335934719, 331.2019743920212], "cost_range": [69.32947718855013, 84.7360276748946], "k": 9.234612726959842, "epsilon": 0.07227896153510069, "complexity": 2}
    }
