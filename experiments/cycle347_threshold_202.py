#!/usr/bin/env python3
"""
CYCLE 347: THRESHOLD TEST K=202
...
Purpose:
  Find exact critical K threshold between 200 and 205.

Background:
  C340: K=600→200 - 0% survival
  C346: K=600→205 - 100% survival
  C347: K=600→202 - test near boundary
"""
...
CYCLE_ID = "C347"
CYCLE_NAME = "Threshold Test K=202"
MODE = "THRESHOLD_202"
...
def run_experiment(seed: int, cycles: int) -> dict:
    ...
    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c347_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 347: THRESHOLD TEST K=202")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c347_threshold_202_results.json"
