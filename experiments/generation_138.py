...
def run_generation():
    ...
    result = {
        ...
        "params_used": {"budget_range": [80.0, 120.0], "gain_range": [90.0, 110.00000000000001], "cost_range": [9.0, 11.0], "k": 3.804268757118855, "epsilon": 0.1992453737201945, "complexity": 2}
    }
