...
def run_generation():
    ...
    budget = random.uniform(3889.859922306755, 5834.789883460132)
    gain_base = random.uniform(125.36022452635487, 153.21805219887818)
    cost_base = random.uniform(27.405153980819573, 33.49518819877948)
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=0.6192317898817267, epsilon=0.31052203786747046))
    ...
    result = {
        ...
        "params_used": {"budget_range": [3889.859922306755, 5834.789883460132], "gain_range": [125.36022452635487, 153.21805219887818], "cost_range": [27.405153980819573, 33.49518819877948], "k": 0.6192317898817267, "epsilon": 0.31052203786747046, "complexity": 2}
    }
