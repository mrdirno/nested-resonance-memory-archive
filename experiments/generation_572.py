...
def run_generation():
    ...
    budget = random.uniform(547.1682954511973, 820.7524431767959)
    gain_base = random.uniform(123.40591221489629, 150.82944826265103)
    cost_base = random.uniform(39.79552920336589, 48.6389801374472)
    ...
    result = {
        ...
        "params_used": {"budget_range": [547.1682954511973, 820.7524431767959], "gain_range": [123.40591221489629, 150.82944826265103], "cost_range": [39.79552920336589, 48.6389801374472], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
