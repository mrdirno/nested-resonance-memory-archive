...
def run_generation():
    ...
    budget = random.uniform(5420.196988971248, 8130.295483456871)
    gain_base = random.uniform(119.04397254501959, 145.49818866613506)
    cost_base = random.uniform(27.59066998930795, 33.72192998693194)
    ...
    result = {
        ...
        "params_used": {"budget_range": [5420.196988971248, 8130.295483456871], "gain_range": [119.04397254501959, 145.49818866613506], "cost_range": [27.59066998930795, 33.72192998693194], "k": 0.6192317898817267, "epsilon": 0.31052203786747046, "complexity": 2}
    }
