...
def run_generation():
    ...
    budget = random.uniform(253.48561929228046, 380.2284289384207)
    gain_base = random.uniform(665.4440872172573, 813.3205510433145)
    cost_base = random.uniform(5.9091550213934525, 7.2223005817031085)
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=7.113091460707711, epsilon=0.07428000042569488))
    ...
    result = {
        ...
        "params_used": {"budget_range": [253.48561929228046, 380.2284289384207], "gain_range": [665.4440872172573, 813.3205510433145], "cost_range": [5.9091550213934525, 7.2223005817031085], "k": 7.113091460707711, "epsilon": 0.07428000042569488, "complexity": 2}
    }
