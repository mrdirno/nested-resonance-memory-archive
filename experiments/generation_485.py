...
def run_generation():
    ...
    budget = random.uniform(79.62626350578789, 119.43939525868181)
    gain_base = random.uniform(124.68961900772479, 152.39842323166363)
    cost_base = random.uniform(21.678644794165425, 26.496121415091075)
    ...
    result = {
        ...
        "params_used": {"budget_range": [79.62626350578789, 119.43939525868181], "gain_range": [124.68961900772479, 152.39842323166363], "cost_range": [21.678644794165425, 26.496121415091075], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
