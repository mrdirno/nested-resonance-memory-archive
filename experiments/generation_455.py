...
def run_generation():
    ...
    budget = random.uniform(5399.45491942276, 8099.182379134139)
    gain_base = random.uniform(367.9579821172974, 449.726422587808)
    cost_base = random.uniform(72.69647495022407, 88.85124716138498)
    ...
    result = {
        ...
        "params_used": {"budget_range": [5399.45491942276, 8099.182379134139], "gain_range": [367.9579821172974, 449.726422587808], "cost_range": [72.69647495022407, 88.85124716138498], "k": 4.5140714246268105, "epsilon": 0.29271990739874953, "complexity": 2}
    }
