...
def run_generation():
    ...
    budget = random.uniform(443.0310565924545, 664.5465848886817)
    gain_base = random.uniform(143.46017039038625, 175.34020825491655)
    cost_base = random.uniform(38.28909265492406, 46.797779911573855)
    ...
    result = {
        ...
        "params_used": {"budget_range": [443.0310565924545, 664.5465848886817], "gain_range": [143.46017039038625, 175.34020825491655], "cost_range": [38.28909265492406, 46.797779911573855], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
