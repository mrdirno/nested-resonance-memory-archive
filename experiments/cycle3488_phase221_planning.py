...
def main():
    print("======================================================================")
    print("CYCLE 3488: PHASE 221 PLANNING")
    ...
    candidates = [
        ...
        {
            'name': 'Ecology (The Web)',
            'novelty': 0.75,
            'impact': 0.85,
            'synergy': 0.65, # Strong synergy with Swarm/Collective
            'tractability': 0.70
        },
        {
    ...
    print("Rationale: High Synergy with recent Collective/Swarm phases pushes Ecology.")
    print("           Ecology is the study of energy budgets in competition.")
    print("======================================================================")
    print("PHASE 221 INITIATED: ECOLOGY")
    print("======================================================================")
