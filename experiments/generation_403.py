...
def run_generation():
    ...
    budget = random.uniform(276.904241380454, 415.3563620706809)
    gain_base = random.uniform(56.696875909021145, 69.2961816665814)
    cost_base = random.uniform(14.869929838554752, 18.17435869156692)
    ...
    result = {
        ...
        "params_used": {"budget_range": [276.904241380454, 415.3563620706809], "gain_range": [56.696875909021145, 69.2961816665814], "cost_range": [14.869929838554752, 18.17435869156692], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
