...
def run_generation():
    ...
    budget = random.uniform(3955.944075410261, 5933.916113115391)
    gain_base = random.uniform(897.4722355284467, 1000.0)
    cost_base = random.uniform(53.467312407394246, 65.3489373868152)
    ...
    result = {
        ...
        "params_used": {"budget_range": [3955.944075410261, 5933.916113115391], "gain_range": [897.4722355284467, 1000.0], "cost_range": [53.467312407394246, 65.3489373868152], "k": 3.4589290340398806, "epsilon": 0.8503059082412008, "complexity": 2}
    }
