...
def run_generation():
    ...
    budget = random.uniform(4346.644949160819, 6519.967423741228)
    gain_base = random.uniform(410.92840131819196, 502.2458238333458)
    cost_base = random.uniform(73.57229158004412, 89.92168970894282)
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=4.5140714246268105, epsilon=0.29271990739874953))
    ...
    result = {
        ...
        "params_used": {"budget_range": [4346.644949160819, 6519.967423741228], "gain_range": [410.92840131819196, 502.2458238333458], "cost_range": [73.57229158004412, 89.92168970894282], "k": 4.5140714246268105, "epsilon": 0.29271990739874953, "complexity": 2}
    }
