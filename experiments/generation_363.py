...
def run_generation():
    ...
    budget = random.uniform(397.69708473939994, 596.5456271090999)
    gain_base = random.uniform(62.774179671123235, 76.72399737581729)
    cost_base = random.uniform(37.92394964323526, 46.35149400839865)
    ...
    result = {
        ...
        "params_used": {"budget_range": [397.69708473939994, 596.5456271090999], "gain_range": [62.774179671123235, 76.72399737581729], "cost_range": [37.92394964323526, 46.35149400839865], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
