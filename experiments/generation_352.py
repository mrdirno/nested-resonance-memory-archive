...
def run_generation():
    ...
    budget = random.uniform(612.948519365795, 919.4227790486924)
    gain_base = random.uniform(123.87502709502927, 151.40281089392468)
    cost_base = random.uniform(33.04843938391091, 40.392537024780005)
    ...
    result = {
        ...
        "params_used": {"budget_range": [612.948519365795, 919.4227790486924], "gain_range": [123.87502709502927, 151.40281089392468], "cost_range": [33.04843938391091, 40.392537024780005], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
