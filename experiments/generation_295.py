...
def run_generation():
    ...
    budget = random.uniform(5210.902590476817, 7816.353885715225)
    gain_base = random.uniform(25.769305012746425, 31.49581723780119)
    cost_base = random.uniform(51.75035997480487, 63.25043996920596)
    ...
    result = {
        ...
        "params_used": {"budget_range": [5210.902590476817, 7816.353885715225], "gain_range": [25.769305012746425, 31.49581723780119], "cost_range": [51.75035997480487, 63.25043996920596], "k": 8.276252758266143, "epsilon": 0.7287758911871579, "complexity": 2}
    }
