...
def run_generation():
    ...
    budget = random.uniform(267.38001952677314, 401.0700292901597)
    gain_base = random.uniform(131.323051166654, 160.50595142591047)
    cost_base = random.uniform(35.10691774208103, 42.90845501809904)
    ...
    result = {
        ...
        "params_used": {"budget_range": [267.38001952677314, 401.0700292901597], "gain_range": [131.323051166654, 160.50595142591047], "cost_range": [35.10691774208103, 42.90845501809904], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
