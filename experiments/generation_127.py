...
def run_generation():
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=8.862851293125338, epsilon=0.651073988836379))
    ...
    result = {
        ...
        "params_used": {"budget_range": [1.0, 10000.0], "gain_range": [10.0, 1000.0], "cost_range": [1.0, 100.0], "k": 8.862851293125338, "epsilon": 0.651073988836379, "complexity": 2}
    }
