...
def run_generation():
    ...
    budget = random.uniform(2167.8871553375657, 3251.830733006348)
    gain_base = random.uniform(855.4686291084236, 1000.0)
    cost_base = random.uniform(2.1630158993334425, 2.643686099185319)
    ...
    result = {
        ...
        "params_used": {"budget_range": [2167.8871553375657, 3251.830733006348], "gain_range": [855.4686291084236, 1000.0], "cost_range": [2.1630158993334425, 2.643686099185319], "k": 0.4521598713923174, "epsilon": 0.4026574009126241, "complexity": 2}
    }
