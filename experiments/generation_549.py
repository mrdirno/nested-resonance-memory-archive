...
def run_generation():
    ...
    budget = random.uniform(275.86215935445637, 413.7932390316845)
    gain_base = random.uniform(633.5114560293142, 774.291779591384)
    cost_base = random.uniform(6.145576222370456, 7.511259827341669)
    ...
    result = {
        ...
        "params_used": {"budget_range": [275.86215935445637, 413.7932390316845], "gain_range": [633.5114560293142, 774.291779591384], "cost_range": [6.145576222370456, 7.511259827341669], "k": 7.113091460707711, "epsilon": 0.07428000042569488, "complexity": 2}
    }
