...
def run_generation():
    ...
    budget = random.uniform(907.4386220584195, 1361.157933087629)
    gain_base = random.uniform(372.02871196844717, 454.70175907254657)
    cost_base = random.uniform(61.710584156669455, 75.42404730259601)
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=0.5044925026778514, epsilon=0.7786510323888909))
    ...
    result = {
        ...
        "params_used": {"budget_range": [907.4386220584195, 1361.157933087629], "gain_range": [372.02871196844717, 454.70175907254657], "cost_range": [61.710584156669455, 75.42404730259601], "k": 0.5044925026778514, "epsilon": 0.7786510323888909, "complexity": 2}
    }
