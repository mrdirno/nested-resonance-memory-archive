...
def run_generation():
    ...
    budget = random.uniform(617.6220061548138, 926.4330092322207)
    gain_base = random.uniform(60.66184873828873, 74.14225956901957)
    cost_base = random.uniform(35.99997183988824, 43.99996558208563)
    ...
    result = {
        ...
        "params_used": {"budget_range": [617.6220061548138, 926.4330092322207], "gain_range": [60.66184873828873, 74.14225956901957], "cost_range": [35.99997183988824, 43.99996558208563], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
