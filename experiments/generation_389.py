...
def run_generation():
    ...
    budget = random.uniform(664.0669603199856, 996.1004404799783)
    gain_base = random.uniform(152.03243457576687, 185.8174200370484)
    cost_base = random.uniform(14.124242672202483, 17.26296326602526)
    ...
    result = {
        ...
        "params_used": {"budget_range": [664.0669603199856, 996.1004404799783], "gain_range": [152.03243457576687, 185.8174200370484], "cost_range": [14.124242672202483, 17.26296326602526], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
