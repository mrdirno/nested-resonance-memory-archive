...
def run_generation():
    ...
    budget = random.uniform(2124.9680197191924, 3187.4520295787884)
    gain_base = random.uniform(861.2714093135679, 1000.0)
    cost_base = random.uniform(28.62417466740664, 34.985102371274785)
    ...
    result = {
        ...
        "params_used": {"budget_range": [2124.9680197191924, 3187.4520295787884], "gain_range": [861.2714093135679, 1000.0], "cost_range": [28.62417466740664, 34.985102371274785], "k": 2.5389027477966586, "epsilon": 0.012098910621484764, "complexity": 2}
    }
