...
def run_generation():
    ...
    budget = random.uniform(1800.8531726826257, 2701.2797590239384)
    gain_base = random.uniform(136.74341411098135, 167.1308394689772)
    cost_base = random.uniform(1.592713722807828, 1.9466501056540124)
    ...
    result = {
        ...
        "params_used": {"budget_range": [1800.8531726826257, 2701.2797590239384], "gain_range": [136.74341411098135, 167.1308394689772], "cost_range": [1.592713722807828, 1.9466501056540124], "k": 7.698825262071338, "epsilon": 0.31888056002057574, "complexity": 2}
    }
