...
Testing if dead zone patterns extend to N_DEPTHS=6.
"""
...
def main():
    print(f"CYCLE 1834: Six Depths Extension | {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    print("=" * 80)
    print(f"Testing dead zone patterns with N_DEPTHS={N_DEPTHS}")
    print("=" * 80)

    seeds = list(range(1834001, 1834021))  # 20 seeds

    # Test key dead zone N values
    ...
    # Compare with 5 depths
    print("\n" + "=" * 80)
    print("COMPARISON: Expected patterns (from 5 depths)")
    print("=" * 80)
    print("\n| N | 5 Depths | 6 Depths |")
    print("|---|----------|----------|")
    print("| 14 | low prob | ? |")
