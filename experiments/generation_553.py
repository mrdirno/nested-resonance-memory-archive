...
def run_generation():
    ...
    budget = random.uniform(491.93627097046556, 737.9044064556983)
    gain_base = random.uniform(165.65777002716774, 202.4706078109828)
    cost_base = random.uniform(43.394726479535365, 53.037999030543226)
    ...
    result = {
        ...
        "params_used": {"budget_range": [491.93627097046556, 737.9044064556983], "gain_range": [165.65777002716774, 202.4706078109828], "cost_range": [43.394726479535365, 53.037999030543226], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
