...
def run_generation():
    ...
    budget = random.uniform(804.5718142603232, 1206.8577213904846)
    gain_base = random.uniform(254.8148253976079, 311.4403421526319)
    cost_base = random.uniform(64.54307559246843, 78.88598127968363)
    ...
    result = {
        ...
        "params_used": {"budget_range": [804.5718142603232, 1206.8577213904846], "gain_range": [254.8148253976079, 311.4403421526319], "cost_range": [64.54307559246843, 78.88598127968363], "k": 0.9390813052558535, "epsilon": 0.2058159053431028, "complexity": 2}
    }
