...
def run_generation():
    ...
    budget = random.uniform(430.5463500958594, 645.8195251437891)
    gain_base = random.uniform(230.35731598947353, 281.547830653801)
    cost_base = random.uniform(6.408341203710028, 7.832417026756701)
    ...
    result = {
        ...
        "params_used": {"budget_range": [430.5463500958594, 645.8195251437891], "gain_range": [230.35731598947353, 281.547830653801], "cost_range": [6.408341203710028, 7.832417026756701], "k": 6.158352340611331, "epsilon": 0.30682498013289633, "complexity": 2}
    }
