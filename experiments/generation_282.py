...
def run_generation():
    ...
    budget = random.uniform(15.781414676348035, 23.672122014522053)
    gain_base = random.uniform(165.7334266651629, 202.56307703519911)
    cost_base = random.uniform(4.507003223701819, 5.508559495635557)
    ...
    result = {
        ...
        "params_used": {"budget_range": [15.781414676348035, 23.672122014522053], "gain_range": [165.7334266651629, 202.56307703519911], "cost_range": [4.507003223701819, 5.508559495635557], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
