...
def run_generation():
    ...
    budget = random.uniform(82.10127027311627, 123.1519054096744)
    gain_base = random.uniform(135.6072973495397, 165.74225231610407)
    cost_base = random.uniform(18.491817556829318, 22.601110347235835)
    ...
    result = {
        ...
        "params_used": {"budget_range": [82.10127027311627, 123.1519054096744], "gain_range": [135.6072973495397, 165.74225231610407], "cost_range": [18.491817556829318, 22.601110347235835], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
