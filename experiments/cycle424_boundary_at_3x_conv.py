#!/usr/bin/env python3
"""
CYCLE 424: BOUNDARY AT 3.0× CONVERSION
...
Purpose:
  Test boundary behavior at higher conversion.

Background:
  At 2.5× conversion: 0.75× = 80% (overshoot)
  Prediction: Higher conversion should increase overshoot

  C424: 0.75× + 3.0× - more severe overshoot?
...
CYCLE_ID = "C424"
CYCLE_NAME = "Boundary at 3x Conv"
MODE = "BOUNDARY_3XCONV"
...
# 0.75× attack + 3.0× conversion
BASE_PARAMS = [
    {"f": 0.1, "e_con": 0.2, "e_rech": 0.4},
    {"attack": 0.00225, "h": 0.02, "e_con": 0.3, "e_gain": 0.5, "conv": 0.9},
    {"attack": 0.00375, "h": 0.03, "e_con": 0.4, "e_gain": 0.6, "conv": 0.75},
    {"attack": 0.006, "h": 0.04, "e_con": 0.5, "e_gain": 0.8, "conv": 0.6},
    {"attack": 0.009, "h": 0.05, "e_con": 0.6, "e_gain": 1.0, "conv": 0.45},
    {"attack": 0.01125, "h": 0.06, "e_con": 0.7, "e_gain": 1.2, "conv": 0.36},
    {"attack": 0.0135, "h": 0.07, "e_con": 0.8, "e_gain": 1.4, "conv": 0.3}
]

SEEDS = list(range(6460, 6480))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run boundary at 3.0× conversion experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c424_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 424: BOUNDARY AT 3.0× CONVERSION")
    ...
    print(f"Attack: 0.75×, Conversion: 3.0×")
    print("=" * 80)
    print()
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c424_boundary_at_3x_conv_results.json"
