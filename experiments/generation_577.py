...
def run_generation():
    ...
    budget = random.uniform(1.0, 10000.0)
    gain_base = random.uniform(10.0, 1000.0)
    cost_base = random.uniform(1.0, 100.0)
    ...
    result = {
        ...
        "params_used": {"budget_range": [1.0, 10000.0], "gain_range": [10.0, 1000.0], "cost_range": [1.0, 100.0], "k": 2.5389027477966586, "epsilon": 0.012098910621484764, "complexity": 2}
    }
