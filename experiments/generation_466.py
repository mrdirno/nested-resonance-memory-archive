...
def run_generation():
    ...
    budget = random.uniform(4042.423582897589, 6063.635374346382)
    gain_base = random.uniform(849.9444738461234, 1000.0)
    cost_base = random.uniform(53.548717981244614, 65.44843308818787)
    ...
    result = {
        ...
        "params_used": {"budget_range": [4042.423582897589, 6063.635374346382], "gain_range": [849.9444738461234, 1000.0], "cost_range": [53.548717981244614, 65.44843308818787], "k": 3.4589290340398806, "epsilon": 0.8503059082412008, "complexity": 2}
    }
