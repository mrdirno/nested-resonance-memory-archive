...
def run_generation():
    ...
    budget = random.uniform(5578.401468177367, 8367.602202266049)
    gain_base = random.uniform(671.39636874092, 820.5955617944579)
    cost_base = random.uniform(4.834574977461011, 5.908924972452347)
    ...
    result = {
        ...
        "params_used": {"budget_range": [5578.401468177367, 8367.602202266049], "gain_range": [671.39636874092, 820.5955617944579], "cost_range": [4.834574977461011, 5.908924972452347], "k": 8.080861805504712, "epsilon": 0.980263816546247, "complexity": 2}
    }
