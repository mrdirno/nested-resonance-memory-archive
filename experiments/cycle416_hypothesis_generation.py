...
META = MetaController()
HYPOTHESIS = HypothesisEngine(MEMORY) # Pass MEMORY instance
...
async def main():
    ...
    print("Starting Autonomous Scientist Coordinator (Cycle 416)...")
    ...
    while True:
        ...
        if hypothesis and hypothesis["type"] == "optimal_target_point":
            ...
            # Reset perturbation timer for the new target
            EYES.perturbation_timer = 0
