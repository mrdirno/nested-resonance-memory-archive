...
def main():
    print("======================================================================")
    print("CYCLE 3502: PHASE 224 PLANNING")
    ...
    candidates = [
        ...
        },
        {
            ...
            'novelty': 0.80,
            'impact': 0.60,
            'synergy': 0.65, # Synergy with Ecology/Architecture
            'tractability': 0.65
        },
        {
            ...
            'novelty': 0.70,
            'impact': 0.95,
            'synergy': 0.80, # Strong synergy with Ecology/Biology
            'tractability': 0.75
        }
    ]
    ...
    print("Rationale: High Synergy with Biological and Ecological phases pushes Medicine.")
    print("           The Body is the original Budget Constraint.")
    print("======================================================================")
    print("PHASE 224 INITIATED: MEDICINE")
    print("======================================================================")
