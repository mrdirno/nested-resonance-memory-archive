...
def run_generation():
    ...
    budget = random.uniform(366.1185785229627, 549.1778677844441)
    gain_base = random.uniform(158.92750830029564, 194.24473236702804)
    cost_base = random.uniform(34.35168299266583, 41.98539032436935)
    ...
    result = {
        ...
        "params_used": {"budget_range": [366.1185785229627, 549.1778677844441], "gain_range": [158.92750830029564, 194.24473236702804], "cost_range": [34.35168299266583, 41.98539032436935], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
