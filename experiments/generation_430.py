...
def run_generation():
    ...
    budget = random.uniform(5877.436963913535, 8816.155445870301)
    gain_base = random.uniform(203.3018842965338, 248.4800808068747)
    cost_base = random.uniform(21.674545955857294, 26.491111723825583)
    ...
    result = {
        ...
        "params_used": {"budget_range": [5877.436963913535, 8816.155445870301], "gain_range": [203.3018842965338, 248.4800808068747], "cost_range": [21.674545955857294, 26.491111723825583], "k": 4.552964741471671, "epsilon": 0.5906564314487059, "complexity": 2}
    }
