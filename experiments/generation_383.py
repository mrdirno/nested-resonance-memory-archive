...
def run_generation():
    ...
    budget = random.uniform(636.4356585752354, 954.653487862853)
    gain_base = random.uniform(162.97253936081785, 199.1886592187774)
    cost_base = random.uniform(15.41671355228377, 18.84264989723572)
    ...
    result = {
        ...
        "params_used": {"budget_range": [636.4356585752354, 954.653487862853], "gain_range": [162.97253936081785, 199.1886592187774], "cost_range": [15.41671355228377, 18.84264989723572], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
