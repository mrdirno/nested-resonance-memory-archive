...
def run_generation():
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=0.45151579196146197, epsilon=0.6733956916353335))
    ...
    result = {
        ...
        "params_used": {"budget_range": [1.0, 10000.0], "gain_range": [10.0, 1000.0], "cost_range": [1.0, 100.0], "k": 0.45151579196146197, "epsilon": 0.6733956916353335, "complexity": 2}
    }
