...
def run_generation():
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=9.326007818685829, epsilon=0.2342000484301907))
    ...
    result = {
        ...
        "params_used": {"budget_range": [1.0, 10000.0], "gain_range": [10.0, 1000.0], "cost_range": [1.0, 100.0], "k": 9.326007818685829, "epsilon": 0.2342000484301907, "complexity": 2}
    }
