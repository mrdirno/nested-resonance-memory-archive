...
def run_generation():
    ...
    budget = random.uniform(6846.023470765798, 10000.0)
    gain_base = random.uniform(729.5393827155798, 891.6592455412642)
    cost_base = random.uniform(4.787129061343478, 5.850935519419807)
    ...
    result = {
        ...
        "params_used": {"budget_range": [6846.023470765798, 10000.0], "gain_range": [729.5393827155798, 891.6592455412642], "cost_range": [4.787129061343478, 5.850935519419807], "k": 8.080861805504712, "epsilon": 0.980263816546247, "complexity": 2}
    }
