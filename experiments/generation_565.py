...
def run_generation():
    ...
    budget = random.uniform(1134.0017956435963, 1701.0026934653943)
    gain_base = random.uniform(627.763692656157, 767.2667354686364)
    cost_base = random.uniform(53.99255746274862, 65.99090356558165)
    ...
    result = {
        ...
        "params_used": {"budget_range": [1134.0017956435963, 1701.0026934653943], "gain_range": [627.763692656157, 767.2667354686364], "cost_range": [53.99255746274862, 65.99090356558165], "k": 3.1977982140200343, "epsilon": 0.3284187114965685, "complexity": 2}
    }
