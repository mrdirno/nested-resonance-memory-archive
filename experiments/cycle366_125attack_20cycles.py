#!/usr/bin/env python3
"""
CYCLE 366: 1.25× ATTACK RATE - 20 CYCLES
...
Purpose:
  Test if 1.25× attack helps at very fast decline.

Background:
  C357: 20 cycles, 1.0× attack - 25% survival
  C364: 30 cycles, 1.25× attack - 50% survival
  C366: 20 cycles, 1.25× attack - test pattern

Design:
  - K declines from 600 to 200 over 20 cycles
  - Rate: 20 K/cycle
...
CYCLE_ID = "C366"
CYCLE_NAME = "1.25x Attack Rate 20 Cycles"
MODE = "125_ATTACK_20"
...
SEEDS = list(range(5300, 5320))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run 1.25× attack at 20 cycles."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c366_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 366: 1.25× ATTACK RATE - 20 CYCLES")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c366_125attack_20cycles_results.json"
