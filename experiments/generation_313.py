...
def run_generation():
    ...
    budget = random.uniform(609.0558561085608, 913.5837841628412)
    gain_base = random.uniform(44.477745027900866, 54.36168836743439)
    cost_base = random.uniform(11.567171082570631, 14.137653545364104)
    ...
    result = {
        ...
        "params_used": {"budget_range": [609.0558561085608, 913.5837841628412], "gain_range": [44.477745027900866, 54.36168836743439], "cost_range": [11.567171082570631, 14.137653545364104], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
