...
def run_generation():
    ...
    budget = random.uniform(64.97464624134084, 97.46196936201126)
    gain_base = random.uniform(136.3556960635927, 166.65696185550217)
    cost_base = random.uniform(19.940947596876473, 24.372269285071248)
    ...
    result = {
        ...
        "params_used": {"budget_range": [64.97464624134084, 97.46196936201126], "gain_range": [136.3556960635927, 166.65696185550217], "cost_range": [19.940947596876473, 24.372269285071248], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
