...
def run_generation():
    ...
    budget = random.uniform(798.9966809716211, 1198.4950214574317)
    gain_base = random.uniform(243.9238440646281, 298.12914274565657)
    cost_base = random.uniform(62.221957513672805, 76.04905918337788)
    ...
    result = {
        ...
        "params_used": {"budget_range": [798.9966809716211, 1198.4950214574317], "gain_range": [243.9238440646281, 298.12914274565657], "cost_range": [62.221957513672805, 76.04905918337788], "k": 0.9390813052558535, "epsilon": 0.2058159053431028, "complexity": 2}
    }
