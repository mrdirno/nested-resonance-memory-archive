...
def run_generation():
    ...
    budget = random.uniform(6429.740439317423, 9644.610658976133)
    gain = random.uniform(514.6615172028602, 629.0307432479402)
    cost = random.uniform(75.12015746679029, 91.81352579274369)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [6429.740439317423, 9644.610658976133], "gain_range": [514.6615172028602, 629.0307432479402], "cost_range": [75.12015746679029, 91.81352579274369], "k": 9.505937517777465, "epsilon": 0.0955725859361949}
    }
