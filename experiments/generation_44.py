...
def run_generation():
    ...
    budget = random.uniform(660.0415505368121, 990.062325805218)
    gain = random.uniform(90.80656598010961, 110.98580286457842)
    cost = random.uniform(33.91237417958254, 41.44845733060089)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [660.0415505368121, 990.062325805218], "gain_range": [90.80656598010961, 110.98580286457842], "cost_range": [33.91237417958254, 41.44845733060089], "k": 1.0, "epsilon": 0.1}
    }
