...
def main():
    print("======================================================================")
    print("CYCLE 3536: PHASE 232 PLANNING")
    ...
    candidates = [
        ...
        },
        {
            ...
            'novelty': 0.60,
            'impact': 0.90,
            'synergy': 0.85, # Synergy with Economy/Urban/Warfare
            'tractability': 0.70
        },
        {
            'name': 'Epidemiology (The Plague)',
            'novelty': 0.75,
            'impact': 0.95,
            'synergy': 0.80, # Synergy with Medicine/Ecology
            'tractability': 0.65
        }
    ]
    ...
    print("Rationale: High Synergy with Medicine, Ecology, and Warfare pushes Epidemiology.")
    print("           A pandemic is a BCP audit of a population.")
    print("======================================================================")
    print("PHASE 232 INITIATED: EPIDEMIOLOGY")
    print("======================================================================")
