...
def run_generation():
    ...
    budget = random.uniform(12.300726029623366, 18.451089044435047)
    gain_base = random.uniform(167.96247764343403, 205.28747267530827)
    cost_base = random.uniform(4.825218787833342, 5.8974896295740855)
    ...
    result = {
        ...
        "params_used": {"budget_range": [12.300726029623366, 18.451089044435047], "gain_range": [167.96247764343403, 205.28747267530827], "cost_range": [4.825218787833342, 5.8974896295740855], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
