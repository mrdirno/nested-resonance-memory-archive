...
def run_generation():
    ...
    budget = random.uniform(1342.8600449641976, 2014.2900674462962)
    gain_base = random.uniform(39.08268453056899, 47.767725537362104)
    cost_base = random.uniform(11.847457575312268, 14.48022592538166)
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=1.338505834999901, epsilon=0.1924359646469713))
    ...
    result = {
        ...
        "params_used": {"budget_range": [1342.8600449641976, 2014.2900674462962], "gain_range": [39.08268453056899, 47.767725537362104], "cost_range": [11.847457575312268, 14.48022592538166], "k": 1.338505834999901, "epsilon": 0.1924359646469713, "complexity": 3}
    }
