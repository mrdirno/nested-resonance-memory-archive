...
def run_generation():
    ...
    budget = random.uniform(1328.650025856432, 1992.9750387846475)
    gain_base = random.uniform(869.0091562103821, 1000.0)
    cost_base = random.uniform(50.76578699244836, 62.047072990770225)
    ...
    result = {
        ...
        "params_used": {"budget_range": [1328.650025856432, 1992.9750387846475], "gain_range": [869.0091562103821, 1000.0], "cost_range": [50.76578699244836, 62.047072990770225], "k": 2.0902790366501907, "epsilon": 0.9736883768041519, "complexity": 2}
    }
