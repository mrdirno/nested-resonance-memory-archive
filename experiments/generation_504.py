...
def run_generation():
    ...
    budget = random.uniform(235.87334559883644, 353.8100183982546)
    gain_base = random.uniform(118.69831820126156, 145.07572224598636)
    cost_base = random.uniform(32.174067433450666, 39.3238601964397)
    ...
    result = {
        ...
        "params_used": {"budget_range": [235.87334559883644, 353.8100183982546], "gain_range": [118.69831820126156, 145.07572224598636], "cost_range": [32.174067433450666, 39.3238601964397], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
