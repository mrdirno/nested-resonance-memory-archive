...
def run_generation():
    ...
    budget = random.uniform(273.2884389462223, 409.9326584193334)
    gain_base = random.uniform(53.81388266252805, 65.77252325420096)
    cost_base = random.uniform(16.335696245331718, 19.965850966516545)
    ...
    result = {
        ...
        "params_used": {"budget_range": [273.2884389462223, 409.9326584193334], "gain_range": [53.81388266252805, 65.77252325420096], "cost_range": [16.335696245331718, 19.965850966516545], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
