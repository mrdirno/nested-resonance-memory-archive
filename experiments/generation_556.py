...
def run_generation():
    ...
    budget = random.uniform(373.741675839106, 560.6125137586589)
    gain_base = random.uniform(135.477548834963, 165.5836707982881)
    cost_base = random.uniform(47.95681499349366, 58.61388499204781)
    ...
    result = {
        ...
        "params_used": {"budget_range": [373.741675839106, 560.6125137586589], "gain_range": [135.477548834963, 165.5836707982881], "cost_range": [47.95681499349366, 58.61388499204781], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
