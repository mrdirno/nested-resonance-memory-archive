...
def run_generation():
    ...
    budget = random.uniform(1268.3643252055176, 1902.5464878082762)
    gain_base = random.uniform(899.2237576743923, 1000.0)
    cost_base = random.uniform(43.885197049465255, 53.637463060457534)
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=2.0902790366501907, epsilon=0.9736883768041519))
    ...
    result = {
        ...
        "params_used": {"budget_range": [1268.3643252055176, 1902.5464878082762], "gain_range": [899.2237576743923, 1000.0], "cost_range": [43.885197049465255, 53.637463060457534], "k": 2.0902790366501907, "epsilon": 0.9736883768041519, "complexity": 2}
    }
