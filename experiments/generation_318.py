...
def run_generation():
    ...
    budget = random.uniform(3182.222528368942, 4773.333792553413)
    gain_base = random.uniform(110.41425224532999, 134.95075274429223)
    cost_base = random.uniform(51.60926581120619, 63.0779915470298)
    ...
    result = {
        ...
        "params_used": {"budget_range": [3182.222528368942, 4773.333792553413], "gain_range": [110.41425224532999, 134.95075274429223], "cost_range": [51.60926581120619, 63.0779915470298], "k": 2.2420584702545217, "epsilon": 0.9574527667187356, "complexity": 2}
    }
