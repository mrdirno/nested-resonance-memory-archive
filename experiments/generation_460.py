...
def run_generation():
    ...
    budget = random.uniform(4177.910925589817, 6266.866388384725)
    gain_base = random.uniform(402.6719831289514, 492.1546460464962)
    cost_base = random.uniform(64.44799862192039, 78.76977609345826)
    ...
    result = {
        ...
        "params_used": {"budget_range": [4177.910925589817, 6266.866388384725], "gain_range": [402.6719831289514, 492.1546460464962], "cost_range": [64.44799862192039, 78.76977609345826], "k": 4.5140714246268105, "epsilon": 0.29271990739874953, "complexity": 2}
    }
