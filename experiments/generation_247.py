...
def run_generation():
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=0.8186329884725384, epsilon=0.4083744389550644))
    ...
    result = {
        ...
        "params_used": {"budget_range": [1.0, 10000.0], "gain_range": [10.0, 1000.0], "cost_range": [1.0, 100.0], "k": 0.8186329884725384, "epsilon": 0.4083744389550644, "complexity": 2}
    }
