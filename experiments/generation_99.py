...
def run_generation():
    ...
    result = {
        ...
        "params_used": {"budget_range": [80.0, 120.0], "gain_range": [90.0, 110.00000000000001], "cost_range": [9.0, 11.0], "k": 1.7876849238272468, "epsilon": 0.826558351662993, "complexity": 2}
    }
