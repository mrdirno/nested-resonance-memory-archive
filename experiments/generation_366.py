...
def run_generation():
    ...
    budget = random.uniform(5898.877126950211, 8848.315690425316)
    gain_base = random.uniform(196.88474422050555, 240.63690960284015)
    cost_base = random.uniform(68.26820531086621, 83.43891760216981)
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=0.22255275219284712, epsilon=0.4857845429736557))
    ...
    result = {
        ...
        "params_used": {"budget_range": [5898.877126950211, 8848.315690425316], "gain_range": [196.88474422050555, 240.63690960284015], "cost_range": [68.26820531086621, 83.43891760216981], "k": 0.22255275219284712, "epsilon": 0.4857845429736557, "complexity": 2}
    }
