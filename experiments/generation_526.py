...
def run_generation():
    ...
    budget = random.uniform(2421.767882490281, 3632.6518237354217)
    gain_base = random.uniform(258.3495371593634, 315.7605454169997)
    cost_base = random.uniform(63.082135612795305, 77.10038797119427)
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=9.234612726959842, epsilon=0.07227896153510069))
    ...
    result = {
        ...
        "params_used": {"budget_range": [2421.767882490281, 3632.6518237354217], "gain_range": [258.3495371593634, 315.7605454169997], "cost_range": [63.082135612795305, 77.10038797119427], "k": 9.234612726959842, "epsilon": 0.07227896153510069, "complexity": 2}
    }
