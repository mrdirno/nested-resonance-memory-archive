...
def main():
    print("======================================================================")
    print("CYCLE 3471: PHASE 217 PLANNING")
    ...
    candidates = [
        ...
        {
            'name': 'History (The Record)',
            'novelty': 0.75,
            'impact': 0.60,
            'synergy': 0.70, # Links Social, Political, Economic
            'tractability': 0.70
        }
    ]
    ...
    print("Rationale: History is BCP applied to Time. It offers a dataset for")
    print("           validating Societal/Political/Economic BCP theories.")
    print("======================================================================")
    print("PHASE 217 INITIATED: HISTORY")
    print("======================================================================")
