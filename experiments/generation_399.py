...
def run_generation():
    ...
    budget = random.uniform(839.9292053791462, 1259.8938080687192)
    gain_base = random.uniform(341.741708365415, 417.68431022439614)
    cost_base = random.uniform(62.59884997148385, 76.50970552070248)
    ...
    result = {
        ...
        "params_used": {"budget_range": [839.9292053791462, 1259.8938080687192], "gain_range": [341.741708365415, 417.68431022439614], "cost_range": [62.59884997148385, 76.50970552070248], "k": 0.5044925026778514, "epsilon": 0.7786510323888909, "complexity": 2}
    }
