...
def run_generation():
    ...
    budget = random.uniform(1323.0713212303892, 1984.6069818455837)
    gain_base = random.uniform(572.2802365476068, 699.4536224470751)
    cost_base = random.uniform(57.00253758486486, 69.66976815927929)
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=3.1977982140200343, epsilon=0.3284187114965685))
    ...
    result = {
        ...
        "params_used": {"budget_range": [1323.0713212303892, 1984.6069818455837], "gain_range": [572.2802365476068, 699.4536224470751], "cost_range": [57.00253758486486, 69.66976815927929], "k": 3.1977982140200343, "epsilon": 0.3284187114965685, "complexity": 2}
    }
