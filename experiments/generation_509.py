...
def run_generation():
    ...
    budget = random.uniform(137.96434696261568, 206.9465204439235)
    gain_base = random.uniform(97.74367463762059, 119.4644912237585)
    cost_base = random.uniform(35.91023460763233, 43.89028674266174)
    ...
    result = {
        ...
        "params_used": {"budget_range": [137.96434696261568, 206.9465204439235], "gain_range": [97.74367463762059, 119.4644912237585], "cost_range": [35.91023460763233, 43.89028674266174], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
