...
def run_generation():
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=6.39743900186803, epsilon=0.44602016694137836))
    ...
    result = {
        ...
        "params_used": {"budget_range": [1.0, 10000.0], "gain_range": [10.0, 1000.0], "cost_range": [1.0, 100.0], "k": 6.39743900186803, "epsilon": 0.44602016694137836, "complexity": 2}
    }
