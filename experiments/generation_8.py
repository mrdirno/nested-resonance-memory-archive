...
def run_generation():
    ...
    budget = random.uniform(916.1696174822009, 1000.0)
    gain = random.uniform(170.80233547503929, 200.0)
    cost = random.uniform(38.64810848666646, 47.23657703925901)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [916.1696174822009, 1000.0], "gain_range": [170.80233547503929, 200.0], "cost_range": [38.64810848666646, 47.23657703925901], "k": 4.383393679925132, "epsilon": 0.28713725007074564}
    }
