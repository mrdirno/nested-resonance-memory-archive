...
def run_generation():
    ...
    budget = random.uniform(502.02250707779314, 753.0337606166896)
    gain_base = random.uniform(106.72571434289941, 130.44253975243262)
    cost_base = random.uniform(33.8759074532097, 41.4038868872563)
    ...
    result = {
        ...
        "params_used": {"budget_range": [502.02250707779314, 753.0337606166896], "gain_range": [106.72571434289941, 130.44253975243262], "cost_range": [33.8759074532097, 41.4038868872563], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
