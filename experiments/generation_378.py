...
def run_generation():
    ...
    budget = random.uniform(5266.173496202487, 7899.260244303729)
    gain_base = random.uniform(566.8757802495385, 692.848175860547)
    cost_base = random.uniform(68.72763735793097, 84.00044565969341)
    ...
    result = {
        ...
        "params_used": {"budget_range": [5266.173496202487, 7899.260244303729], "gain_range": [566.8757802495385, 692.848175860547], "cost_range": [68.72763735793097, 84.00044565969341], "k": 9.262558568547654, "epsilon": 0.6044975830664067, "complexity": 2}
    }
