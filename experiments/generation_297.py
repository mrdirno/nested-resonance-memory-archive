...
def run_generation():
    ...
    budget = random.uniform(5364.255176892506, 8046.382765338758)
    gain_base = random.uniform(26.78339978393567, 32.735266402588046)
    cost_base = random.uniform(54.524056987831365, 66.64051409623833)
    ...
    result = {
        ...
        "params_used": {"budget_range": [5364.255176892506, 8046.382765338758], "gain_range": [26.78339978393567, 32.735266402588046], "cost_range": [54.524056987831365, 66.64051409623833], "k": 8.276252758266143, "epsilon": 0.7287758911871579, "complexity": 2}
    }
