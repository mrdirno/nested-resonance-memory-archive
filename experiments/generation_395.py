...
def run_generation():
    ...
    budget = random.uniform(764.8654817278814, 1147.298222591822)
    gain_base = random.uniform(381.03349431914296, 465.70760416784145)
    cost_base = random.uniform(65.06382632858337, 79.5224544016019)
    ...
    result = {
        ...
        "params_used": {"budget_range": [764.8654817278814, 1147.298222591822], "gain_range": [381.03349431914296, 465.70760416784145], "cost_range": [65.06382632858337, 79.5224544016019], "k": 0.5044925026778514, "epsilon": 0.7786510323888909, "complexity": 2}
    }
