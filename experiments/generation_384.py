...
def run_generation():
    ...
    budget = random.uniform(637.2028531522474, 955.8042797283708)
    gain_base = random.uniform(156.58781162033264, 191.3851030915177)
    cost_base = random.uniform(14.51560878545336, 17.741299626665217)
    ...
    result = {
        ...
        "params_used": {"budget_range": [637.2028531522474, 955.8042797283708], "gain_range": [156.58781162033264, 191.3851030915177], "cost_range": [14.51560878545336, 17.741299626665217], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
