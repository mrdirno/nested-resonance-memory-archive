...
def run_generation():
    ...
    budget = random.uniform(525.433938485338, 788.1509077280069)
    gain_base = random.uniform(234.9863511757702, 287.2055403259414)
    cost_base = random.uniform(6.633175198931819, 8.10721413202778)
    ...
    result = {
        ...
        "params_used": {"budget_range": [525.433938485338, 788.1509077280069], "gain_range": [234.9863511757702, 287.2055403259414], "cost_range": [6.633175198931819, 8.10721413202778], "k": 6.158352340611331, "epsilon": 0.30682498013289633, "complexity": 2}
    }
