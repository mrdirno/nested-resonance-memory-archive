...
def run_generation():
    ...
    budget = random.uniform(6416.419624628333, 9624.629436942498)
    gain_base = random.uniform(215.84273325582996, 263.8077850904588)
    cost_base = random.uniform(66.58525334347081, 81.38197630868655)
    ...
    result = {
        ...
        "params_used": {"budget_range": [6416.419624628333, 9624.629436942498], "gain_range": [215.84273325582996, 263.8077850904588], "cost_range": [66.58525334347081, 81.38197630868655], "k": 0.22255275219284712, "epsilon": 0.4857845429736557, "complexity": 2}
    }
