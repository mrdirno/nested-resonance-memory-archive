...
def run_generation():
    ...
    budget = random.uniform(804.1480134781613, 1206.2220202172418)
    gain_base = random.uniform(253.9350713359508, 310.36508718838434)
    cost_base = random.uniform(60.37827567263697, 73.7956702665563)
    ...
    result = {
        ...
        "params_used": {"budget_range": [804.1480134781613, 1206.2220202172418], "gain_range": [253.9350713359508, 310.36508718838434], "cost_range": [60.37827567263697, 73.7956702665563], "k": 0.9390813052558535, "epsilon": 0.2058159053431028, "complexity": 2}
    }
