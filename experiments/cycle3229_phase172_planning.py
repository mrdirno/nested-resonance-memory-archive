...
# Context: 
#   Phase 171 (Telecom) -> Validated Churn.
#   Phase 170 (Logistics) -> Validated Routing.
#   Phase 169 (Energy) -> Validated Demand Response.
# -----------------------------------------------------------------------------
...
def main():
    ...
    candidates = [
        {"name": "Environmental",   "novelty": 0.90, "impact": 0.95, "tractability": 0.50}, # High Risk/Reward
        {"name": "Real Estate",     "novelty": 0.70, "impact": 0.85, "tractability": 0.80}, 
        {"name": "Agriculture",     "novelty": 0.85, "impact": 0.85, "tractability": 0.65}, 
        {"name": "Healthcare Ops",  "novelty": 0.80, "impact": 0.95, "tractability": 0.60}, 
