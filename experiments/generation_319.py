...
def run_generation():
    ...
    budget = random.uniform(3750.2635906584037, 5625.395385987606)
    gain_base = random.uniform(118.7539625457327, 145.14373200033998)
    cost_base = random.uniform(52.26609579531335, 63.88078374982742)
    ...
    result = {
        ...
        "params_used": {"budget_range": [3750.2635906584037, 5625.395385987606], "gain_range": [118.7539625457327, 145.14373200033998], "cost_range": [52.26609579531335, 63.88078374982742], "k": 2.2420584702545217, "epsilon": 0.9574527667187356, "complexity": 2}
    }
