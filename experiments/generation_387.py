...
def run_generation():
    ...
    budget = random.uniform(654.6321655508619, 981.9482483262929)
    gain_base = random.uniform(157.30291612532844, 192.25911970873477)
    cost_base = random.uniform(14.304197432586548, 17.48290797316134)
    ...
    result = {
        ...
        "params_used": {"budget_range": [654.6321655508619, 981.9482483262929], "gain_range": [157.30291612532844, 192.25911970873477], "cost_range": [14.304197432586548, 17.48290797316134], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
