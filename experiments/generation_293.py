...
def run_generation():
    ...
    budget = random.uniform(238.17286149155527, 357.2592922373329)
    gain_base = random.uniform(44.809974642013046, 54.767746784682615)
    cost_base = random.uniform(20.712237989112815, 25.314957542248997)
    ...
    result = {
        ...
        "params_used": {"budget_range": [238.17286149155527, 357.2592922373329], "gain_range": [44.809974642013046, 54.767746784682615], "cost_range": [20.712237989112815, 25.314957542248997], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
