...
def run_generation():
    ...
    budget = random.uniform(4841.716093521813, 7262.574140282719)
    gain_base = random.uniform(410.70151398064246, 501.9685170874519)
    cost_base = random.uniform(71.8084725088093, 87.76591084410026)
    ...
    result = {
        ...
        "params_used": {"budget_range": [4841.716093521813, 7262.574140282719], "gain_range": [410.70151398064246, 501.9685170874519], "cost_range": [71.8084725088093, 87.76591084410026], "k": 4.5140714246268105, "epsilon": 0.29271990739874953, "complexity": 2}
    }
