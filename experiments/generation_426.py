...
def run_generation():
    ...
    budget = random.uniform(5956.730115477691, 8935.095173216534)
    gain_base = random.uniform(195.82310009027003, 239.3393445547745)
    cost_base = random.uniform(23.769256471239984, 29.05131346484887)
    ...
    result = {
        ...
        "params_used": {"budget_range": [5956.730115477691, 8935.095173216534], "gain_range": [195.82310009027003, 239.3393445547745], "cost_range": [23.769256471239984, 29.05131346484887], "k": 4.552964741471671, "epsilon": 0.5906564314487059, "complexity": 2}
    }
