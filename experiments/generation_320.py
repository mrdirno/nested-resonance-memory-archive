...
def run_generation():
    ...
    budget = random.uniform(3838.1463476758104, 5757.219521513715)
    gain_base = random.uniform(127.66982426487368, 156.0408963237345)
    cost_base = random.uniform(47.880530699601685, 58.52064863284651)
    ...
    result = {
        ...
        "params_used": {"budget_range": [3838.1463476758104, 5757.219521513715], "gain_range": [127.66982426487368, 156.0408963237345], "cost_range": [47.880530699601685, 58.52064863284651], "k": 2.2420584702545217, "epsilon": 0.9574527667187356, "complexity": 2}
    }
