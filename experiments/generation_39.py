...
def run_generation():
    ...
    budget = random.uniform(6546.128457358614, 9819.192686037919)
    gain = random.uniform(488.19088280376565, 596.677745649047)
    cost = random.uniform(74.82360499787768, 91.45107277518385)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [6546.128457358614, 9819.192686037919], "gain_range": [488.19088280376565, 596.677745649047], "cost_range": [74.82360499787768, 91.45107277518385], "k": 9.505937517777465, "epsilon": 0.0955725859361949}
    }
