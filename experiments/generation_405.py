...
def run_generation():
    ...
    budget = random.uniform(704.5951475856449, 1056.8927213784673)
    gain_base = random.uniform(289.0510533132144, 353.284620716151)
    cost_base = random.uniform(62.668258551460355, 76.59453822956266)
    ...
    result = {
        ...
        "params_used": {"budget_range": [704.5951475856449, 1056.8927213784673], "gain_range": [289.0510533132144, 353.284620716151], "cost_range": [62.668258551460355, 76.59453822956266], "k": 0.9390813052558535, "epsilon": 0.2058159053431028, "complexity": 2}
    }
