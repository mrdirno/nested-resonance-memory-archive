...
def run_generation():
    ...
    budget = random.uniform(700.534970450746, 1050.8024556761188)
    gain_base = random.uniform(141.4796679285026, 172.91959413483653)
    cost_base = random.uniform(20.3245697803233, 24.841140842617367)
    ...
    result = {
        ...
        "params_used": {"budget_range": [700.534970450746, 1050.8024556761188], "gain_range": [141.4796679285026, 172.91959413483653], "cost_range": [20.3245697803233, 24.841140842617367], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
