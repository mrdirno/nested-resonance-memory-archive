...
def run_generation():
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=1.6095232162879767, epsilon=0.8291829254782863))
    ...
    result = {
        ...
        "params_used": {"budget_range": [1.0, 10000.0], "gain_range": [10.0, 1000.0], "cost_range": [1.0, 100.0], "k": 1.6095232162879767, "epsilon": 0.8291829254782863, "complexity": 2}
    }
