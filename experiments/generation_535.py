...
def run_generation():
    ...
    budget = random.uniform(327.9028113926056, 491.8542170889084)
    gain_base = random.uniform(157.0952642769892, 192.00532300520905)
    cost_base = random.uniform(34.028417073591356, 41.59028753438944)
    ...
    result = {
        ...
        "params_used": {"budget_range": [327.9028113926056, 491.8542170889084], "gain_range": [157.0952642769892, 192.00532300520905], "cost_range": [34.028417073591356, 41.59028753438944], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
