...
def run_generation():
    ...
    budget = random.uniform(3544.7285151715223, 5317.0927727572835)
    gain_base = random.uniform(862.5141041483363, 1000.0)
    cost_base = random.uniform(57.46800894581976, 70.23867760044638)
    ...
    result = {
        ...
        "params_used": {"budget_range": [3544.7285151715223, 5317.0927727572835], "gain_range": [862.5141041483363, 1000.0], "cost_range": [57.46800894581976, 70.23867760044638], "k": 3.4589290340398806, "epsilon": 0.8503059082412008, "complexity": 2}
    }
