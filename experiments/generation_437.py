...
def run_generation():
    ...
    budget = random.uniform(3624.07031100452, 5436.1054665067795)
    gain_base = random.uniform(864.893579081686, 1000.0)
    cost_base = random.uniform(43.79156071969846, 53.52301865740923)
    ...
    result = {
        ...
        "params_used": {"budget_range": [3624.07031100452, 5436.1054665067795], "gain_range": [864.893579081686, 1000.0], "cost_range": [43.79156071969846, 53.52301865740923], "k": 3.3136398384246877, "epsilon": 0.47667923498748715, "complexity": 2}
    }
