...
def run_generation():
    ...
    budget = random.uniform(265.2745767687435, 397.9118651531152)
    gain_base = random.uniform(639.9112427149578, 782.1137410960595)
    cost_base = random.uniform(5.966863363269516, 7.292832999551631)
    ...
    result = {
        ...
        "params_used": {"budget_range": [265.2745767687435, 397.9118651531152], "gain_range": [639.9112427149578, 782.1137410960595], "cost_range": [5.966863363269516, 7.292832999551631], "k": 7.113091460707711, "epsilon": 0.07428000042569488, "complexity": 2}
    }
