...
def run_generation():
    ...
    budget = random.uniform(591.0832569096681, 886.624885364502)
    gain_base = random.uniform(198.03847096873884, 242.04702007290302)
    cost_base = random.uniform(42.64718473768791, 52.124336901618555)
    ...
    result = {
        ...
        "params_used": {"budget_range": [591.0832569096681, 886.624885364502], "gain_range": [198.03847096873884, 242.04702007290302], "cost_range": [42.64718473768791, 52.124336901618555], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
