...
def run_generation():
    ...
    budget = random.uniform(94.6649397187211, 141.99740957808163)
    gain_base = random.uniform(141.73869716858394, 173.23618542826927)
    cost_base = random.uniform(17.625267083979118, 21.541993102641147)
    ...
    result = {
        ...
        "params_used": {"budget_range": [94.6649397187211, 141.99740957808163], "gain_range": [141.73869716858394, 173.23618542826927], "cost_range": [17.625267083979118, 21.541993102641147], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
