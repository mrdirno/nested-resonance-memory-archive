...
def run_generation():
    ...
    budget = random.uniform(794.7944731218936, 1192.1917096828404)
    gain = random.uniform(88.18950813350303, 107.78717660761481)
    cost = random.uniform(32.64608309501923, 39.90076822724573)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [794.7944731218936, 1192.1917096828404], "gain_range": [88.18950813350303, 107.78717660761481], "cost_range": [32.64608309501923, 39.90076822724573], "k": 1.0, "epsilon": 0.1}
    }
