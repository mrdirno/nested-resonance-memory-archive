...
def run_generation():
    ...
    budget = random.uniform(11.149114916120306, 16.723672374180456)
    gain_base = random.uniform(163.6349760118723, 199.9983040145106)
    cost_base = random.uniform(4.7036960848209635, 5.748961881447845)
    ...
    result = {
        ...
        "params_used": {"budget_range": [11.149114916120306, 16.723672374180456], "gain_range": [163.6349760118723, 199.9983040145106], "cost_range": [4.7036960848209635, 5.748961881447845], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
