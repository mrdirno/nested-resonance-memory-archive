...
def run_generation():
    ...
    budget = random.uniform(155.24523632405086, 232.86785448607625)
    gain_base = random.uniform(101.18216714128536, 123.66709317268213)
    cost_base = random.uniform(33.67080699694678, 41.153208551823845)
    ...
    result = {
        ...
        "params_used": {"budget_range": [155.24523632405086, 232.86785448607625], "gain_range": [101.18216714128536, 123.66709317268213], "cost_range": [33.67080699694678, 41.153208551823845], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
