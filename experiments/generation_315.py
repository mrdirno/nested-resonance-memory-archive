...
def run_generation():
    ...
    budget = random.uniform(3841.546933494421, 5762.320400241631)
    gain_base = random.uniform(104.82565972321756, 128.12025077282146)
    cost_base = random.uniform(52.31981304704829, 63.94643816861458)
    ...
    result = {
        ...
        "params_used": {"budget_range": [3841.546933494421, 5762.320400241631], "gain_range": [104.82565972321756, 128.12025077282146], "cost_range": [52.31981304704829, 63.94643816861458], "k": 2.2420584702545217, "epsilon": 0.9574527667187356, "complexity": 2}
    }
