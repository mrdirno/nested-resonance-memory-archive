...
def run_generation():
    ...
    budget = random.uniform(422.0202850088722, 633.0304275133083)
    gain_base = random.uniform(117.3857333810701, 143.4714519101968)
    cost_base = random.uniform(37.0731480165387, 45.311625353547306)
    ...
    result = {
        ...
        "params_used": {"budget_range": [422.0202850088722, 633.0304275133083], "gain_range": [117.3857333810701, 143.4714519101968], "cost_range": [37.0731480165387, 45.311625353547306], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
