...
def run_generation():
    ...
    budget = random.uniform(1362.124375901787, 2043.1865638526806)
    gain_base = random.uniform(877.887295733679, 1000.0)
    cost_base = random.uniform(53.839227120961965, 65.80349981450907)
    ...
    result = {
        ...
        "params_used": {"budget_range": [1362.124375901787, 2043.1865638526806], "gain_range": [877.887295733679, 1000.0], "cost_range": [53.839227120961965, 65.80349981450907], "k": 2.0902790366501907, "epsilon": 0.9736883768041519, "complexity": 2}
    }
