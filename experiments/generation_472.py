...
def run_generation():
    ...
    budget = random.uniform(497.3277673475871, 745.9916510213806)
    gain_base = random.uniform(136.150037893304, 166.40560186959377)
    cost_base = random.uniform(39.22846182599041, 47.94589778732161)
    ...
    result = {
        ...
        "params_used": {"budget_range": [497.3277673475871, 745.9916510213806], "gain_range": [136.150037893304, 166.40560186959377], "cost_range": [39.22846182599041, 47.94589778732161], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
