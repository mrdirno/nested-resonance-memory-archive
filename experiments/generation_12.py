...
def run_generation():
    ...
    budget = random.uniform(234.41349979111334, 351.62024968667)
    gain = random.uniform(46.211051750704364, 56.480174361972004)
    cost = random.uniform(26.545663429727398, 32.4446997474446)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [234.41349979111334, 351.62024968667], "gain_range": [46.211051750704364, 56.480174361972004], "cost_range": [26.545663429727398, 32.4446997474446], "k": 1.0, "epsilon": 0.1}
    }
