...
def run_generation():
    ...
    budget = random.uniform(385.92129967150055, 578.8819495072507)
    gain_base = random.uniform(161.27016380687022, 197.10797798617472)
    cost_base = random.uniform(30.597480518853153, 37.39692063415386)
    ...
    result = {
        ...
        "params_used": {"budget_range": [385.92129967150055, 578.8819495072507], "gain_range": [161.27016380687022, 197.10797798617472], "cost_range": [30.597480518853153, 37.39692063415386], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
