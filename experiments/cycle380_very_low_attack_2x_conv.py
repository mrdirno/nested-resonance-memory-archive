#!/usr/bin/env python3
"""
CYCLE 380: VERY LOW ATTACK + 2.0× CONVERSION - 40 CYCLES
...
Purpose:
  Test if 0.5× attack works with 2.0× conversion.

Background:
  C379: 0.75× attack + 2.0× conv - 90%
  C378: 0.5× attack + 1.5× conv - 75%
  C380: 0.5× attack + 2.0× conv - expect ~75-90%?
...
CYCLE_ID = "C380"
CYCLE_NAME = "Very Low Attack 2x Conv"
MODE = "VLOW_ATK_2XCONV"
...
SEEDS = list(range(5580, 5600))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run very low attack + 2.0× conversion experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c380_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 380: VERY LOW ATTACK + 2.0× CONVERSION - 40 CYCLES")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c380_very_low_attack_2x_conv_results.json"
