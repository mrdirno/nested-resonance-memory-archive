...
def run_generation():
    ...
    budget = random.uniform(626.0537027460854, 939.0805541191279)
    gain_base = random.uniform(103.1179520637794, 126.03305252239706)
    cost_base = random.uniform(35.03624112456236, 42.82207248557622)
    ...
    result = {
        ...
        "params_used": {"budget_range": [626.0537027460854, 939.0805541191279], "gain_range": [103.1179520637794, 126.03305252239706], "cost_range": [35.03624112456236, 42.82207248557622], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
