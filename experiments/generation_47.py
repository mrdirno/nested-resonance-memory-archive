...
def run_generation():
    ...
    budget = random.uniform(605.5705673306727, 908.3558509960089)
    gain = random.uniform(92.4583561552141, 113.00465752303947)
    cost = random.uniform(37.91515182951537, 46.34074112496324)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [605.5705673306727, 908.3558509960089], "gain_range": [92.4583561552141, 113.00465752303947], "cost_range": [37.91515182951537, 46.34074112496324], "k": 1.0, "epsilon": 0.1}
    }
