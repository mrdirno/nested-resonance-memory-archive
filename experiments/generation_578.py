...
def run_generation():
    ...
    budget = random.uniform(1727.6834978341053, 2591.5252467511577)
    gain_base = random.uniform(883.0913292595229, 1000.0)
    cost_base = random.uniform(31.358267495807155, 38.3267713837643)
    ...
    result = {
        ...
        "params_used": {"budget_range": [1727.6834978341053, 2591.5252467511577], "gain_range": [883.0913292595229, 1000.0], "cost_range": [31.358267495807155, 38.3267713837643], "k": 2.5389027477966586, "epsilon": 0.012098910621484764, "complexity": 2}
    }
