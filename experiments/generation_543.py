...
def run_generation():
    ...
    budget = random.uniform(870.847547427742, 1306.271321141613)
    gain_base = random.uniform(113.70342269000737, 138.97084995445346)
    cost_base = random.uniform(41.58546136216371, 50.8266749982001)
    ...
    result = {
        ...
        "params_used": {"budget_range": [870.847547427742, 1306.271321141613], "gain_range": [113.70342269000737, 138.97084995445346], "cost_range": [41.58546136216371, 50.8266749982001], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
