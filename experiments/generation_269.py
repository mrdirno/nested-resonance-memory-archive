...
def run_generation():
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=3.9819117776430484, epsilon=0.8497626951018439))
    ...
    result = {
        ...
        "params_used": {"budget_range": [1.0, 10000.0], "gain_range": [10.0, 1000.0], "cost_range": [1.0, 100.0], "k": 3.9819117776430484, "epsilon": 0.8497626951018439, "complexity": 3}
    }
