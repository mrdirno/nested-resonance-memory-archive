...
def run_generation():
    ...
    budget = random.uniform(3993.8931127435494, 5990.839669115324)
    gain_base = random.uniform(803.8760332063474, 982.5151516966469)
    cost_base = random.uniform(57.25851850394307, 69.98263372704153)
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=3.4589290340398806, epsilon=0.8503059082412008))
    ...
    result = {
        ...
        "params_used": {"budget_range": [3993.8931127435494, 5990.839669115324], "gain_range": [803.8760332063474, 982.5151516966469], "cost_range": [57.25851850394307, 69.98263372704153], "k": 3.4589290340398806, "epsilon": 0.8503059082412008, "complexity": 2}
    }
