...
def run_generation():
    ...
    budget = random.uniform(483.77801230668587, 725.6670184600288)
    gain_base = random.uniform(213.36680280274982, 260.78164787002754)
    cost_base = random.uniform(47.55126675434935, 58.11821492198254)
    ...
    result = {
        ...
        "params_used": {"budget_range": [483.77801230668587, 725.6670184600288], "gain_range": [213.36680280274982, 260.78164787002754], "cost_range": [47.55126675434935, 58.11821492198254], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
