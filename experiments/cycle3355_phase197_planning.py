...
def main():
    log("PHASE 197 PLANNING INITIATED")
    ...
    with open("data/results/cycle3355_phase197_planning.json", "w") as f:
        json.dump(output, f, indent=2)
        
    log("Planning Complete. Proceeding to Phase 197.")
