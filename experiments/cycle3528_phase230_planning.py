...
def main():
    print("======================================================================")
    print("CYCLE 3528: PHASE 230 PLANNING")
    ...
    candidates = [
        ...
        },
        {
            ...
            'novelty': 0.85,
            'impact': 0.50,
            'synergy': 0.65, # Synergy with Linguistics/Literature
            'tractability': 0.75
        },
        {
            ...
            'novelty': 0.75,
            'impact': 0.80,
            'synergy': 0.70, # Synergy with Education/Biology
            'tractability': 0.65
        }
    ]
    ...
    print("Rationale: High Novelty and Synergy with Linguistics/Literature pushes Comedy.")
    print("           Laughter is the release of Budget Tension (Relief Theory).")
    print("======================================================================")
    print("PHASE 230 INITIATED: COMEDY")
    print("======================================================================")
