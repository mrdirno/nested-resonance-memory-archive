...
def run_generation():
    ...
    budget = random.uniform(1205.5013560862972, 1808.2520341294457)
    gain_base = random.uniform(130.19001504329108, 159.12112949735578)
    cost_base = random.uniform(55.736042727925714, 68.1218300007981)
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=1.022852120251879, epsilon=0.6565268865173267))
    ...
    result = {
        ...
        "params_used": {"budget_range": [1205.5013560862972, 1808.2520341294457], "gain_range": [130.19001504329108, 159.12112949735578], "cost_range": [55.736042727925714, 68.1218300007981], "k": 1.022852120251879, "epsilon": 0.6565268865173267, "complexity": 2}
    }
