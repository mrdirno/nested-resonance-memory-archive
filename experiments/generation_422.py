...
def run_generation():
    ...
    budget = random.uniform(137.7703012766053, 206.6554519149079)
    gain_base = random.uniform(84.27919050212131, 103.00789950259271)
    cost_base = random.uniform(37.72791370002021, 46.11189452224692)
    ...
    result = {
        ...
        "params_used": {"budget_range": [137.7703012766053, 206.6554519149079], "gain_range": [84.27919050212131, 103.00789950259271], "cost_range": [37.72791370002021, 46.11189452224692], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
