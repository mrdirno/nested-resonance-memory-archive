...
def run_generation():
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=3.4575001097713773, epsilon=0.5917094325175557))
    ...
    result = {
        ...
        "params_used": {"budget_range": [1.0, 10000.0], "gain_range": [10.0, 1000.0], "cost_range": [1.0, 100.0], "k": 3.4575001097713773, "epsilon": 0.5917094325175557, "complexity": 2}
    }
