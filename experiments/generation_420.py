...
def run_generation():
    ...
    budget = random.uniform(1813.6933700152076, 2720.5400550228114)
    gain_base = random.uniform(131.15239920809765, 160.29737680989712)
    cost_base = random.uniform(1.6278457896143042, 1.9895892984174828)
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=7.698825262071338, epsilon=0.31888056002057574))
    ...
    result = {
        ...
        "params_used": {"budget_range": [1813.6933700152076, 2720.5400550228114], "gain_range": [131.15239920809765, 160.29737680989712], "cost_range": [1.6278457896143042, 1.9895892984174828], "k": 7.698825262071338, "epsilon": 0.31888056002057574, "complexity": 2}
    }
