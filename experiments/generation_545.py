...
def run_generation():
    ...
    budget = random.uniform(318.86346689180766, 478.29520033771144)
    gain_base = random.uniform(698.8561689734912, 854.1575398564894)
    cost_base = random.uniform(6.290829069027629, 7.688791084367104)
    ...
    result = {
        ...
        "params_used": {"budget_range": [318.86346689180766, 478.29520033771144], "gain_range": [698.8561689734912, 854.1575398564894], "cost_range": [6.290829069027629, 7.688791084367104], "k": 7.113091460707711, "epsilon": 0.07428000042569488, "complexity": 2}
    }
