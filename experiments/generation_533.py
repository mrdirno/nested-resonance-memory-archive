...
def run_generation():
    ...
    budget = random.uniform(364.1750401797409, 546.2625602696113)
    gain_base = random.uniform(145.93050852960135, 178.35951042506835)
    cost_base = random.uniform(32.32337691997427, 39.506349568857445)
    ...
    result = {
        ...
        "params_used": {"budget_range": [364.1750401797409, 546.2625602696113], "gain_range": [145.93050852960135, 178.35951042506835], "cost_range": [32.32337691997427, 39.506349568857445], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
