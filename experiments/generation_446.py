...
def run_generation():
    ...
    budget = random.uniform(342.36313689754843, 513.5447053463226)
    gain_base = random.uniform(182.98649690054643, 223.65016287844566)
    cost_base = random.uniform(14.938508353944052, 18.258176877042732)
    ...
    result = {
        ...
        "params_used": {"budget_range": [342.36313689754843, 513.5447053463226], "gain_range": [182.98649690054643, 223.65016287844566], "cost_range": [14.938508353944052, 18.258176877042732], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
