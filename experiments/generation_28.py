...
def run_generation():
    ...
    budget = random.uniform(313.13446951716173, 469.7017042757425)
    gain = random.uniform(126.36523251144662, 154.4463952917681)
    cost = random.uniform(23.044923661863706, 28.16601780894453)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [313.13446951716173, 469.7017042757425], "gain_range": [126.36523251144662, 154.4463952917681], "cost_range": [23.044923661863706, 28.16601780894453], "k": 1.0, "epsilon": 0.1}
    }
