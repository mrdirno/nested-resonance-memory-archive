...
def run_generation():
    ...
    budget = random.uniform(242.7510260513418, 364.1265390770127)
    gain = random.uniform(50.142245169009634, 61.28496631767844)
    cost = random.uniform(25.96354960539573, 31.733227295483672)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [242.7510260513418, 364.1265390770127], "gain_range": [50.142245169009634, 61.28496631767844], "cost_range": [25.96354960539573, 31.733227295483672], "k": 1.0, "epsilon": 0.1}
    }
