...
def run_generation():
    ...
    budget = random.uniform(5263.449909310677, 7895.1748639660145)
    gain_base = random.uniform(121.765069624305, 148.8239739852617)
    cost_base = random.uniform(25.797941842769827, 31.53081780782979)
    ...
    result = {
        ...
        "params_used": {"budget_range": [5263.449909310677, 7895.1748639660145], "gain_range": [121.765069624305, 148.8239739852617], "cost_range": [25.797941842769827, 31.53081780782979], "k": 0.6192317898817267, "epsilon": 0.31052203786747046, "complexity": 2}
    }
