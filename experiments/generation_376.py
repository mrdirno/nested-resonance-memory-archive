...
def run_generation():
    ...
    budget = random.uniform(6487.445654834834, 9731.168482252251)
    gain_base = random.uniform(627.1344264892932, 766.4976323758029)
    cost_base = random.uniform(80.18898944444138, 98.00876487653947)
    ...
    result = {
        ...
        "params_used": {"budget_range": [6487.445654834834, 9731.168482252251], "gain_range": [627.1344264892932, 766.4976323758029], "cost_range": [80.18898944444138, 98.00876487653947], "k": 9.262558568547654, "epsilon": 0.6044975830664067, "complexity": 2}
    }
