...
def run_generation():
    ...
    budget = random.uniform(85.79019907927443, 128.68529861891165)
    gain_base = random.uniform(110.67003011616846, 135.26337014198367)
    cost_base = random.uniform(21.865026858720423, 26.72392171621385)
    ...
    result = {
        ...
        "params_used": {"budget_range": [85.79019907927443, 128.68529861891165], "gain_range": [110.67003011616846, 135.26337014198367], "cost_range": [21.865026858720423, 26.72392171621385], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
