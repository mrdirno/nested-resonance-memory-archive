...
# Experiment metadata
CYCLE_ID = "C279"
CYCLE_NAME = "Spawn Viability Threshold Test"
AUTHOR = "Aldrin Payopay <aldrin.gdf@gmail.com>"
...
# Spawn viability threshold test conditions
# Hypothesis: Threshold is at E_consume = spawn_energy
SPAWN_ENERGIES = [0.3, 0.5, 0.7]

# For each spawn energy, test E_consume at: spawn-0.1, spawn, spawn+0.1
# E_recharge = 1.0 for all (ensures net > 0 for below-threshold)
ENERGY_CONDITIONS = {}
...
# Single frequency (0.5% - middle of working range)
FREQUENCIES = [0.005]  # 0.5%
...
def run_single_experiment(
    ...
    db_path = RESULTS_DIR / f"c279_SPAWN_THRESHOLD_{energy_label}_f{freq_pct}pct_seed{seed}.db"
    ...
    for cycle in range(cycles):
        ...
        if np.random.random() < f_intra:
            ...
            if agents:
                ...
                # Use spawn_energy from params (default 0.5 for backward compatibility)
...
def run_campaign():
    ...
    results_file = RESULTS_DIR / "c279_spawn_viability_threshold_results.json"
