...
def run_generation():
    ...
    budget = random.uniform(4770.090520123265, 7155.135780184897)
    gain_base = random.uniform(114.28601691126968, 139.6829095582185)
    cost_base = random.uniform(25.85062062430342, 31.59520298525974)
    ...
    result = {
        ...
        "params_used": {"budget_range": [4770.090520123265, 7155.135780184897], "gain_range": [114.28601691126968, 139.6829095582185], "cost_range": [25.85062062430342, 31.59520298525974], "k": 0.6192317898817267, "epsilon": 0.31052203786747046, "complexity": 2}
    }
