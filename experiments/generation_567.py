...
def run_generation():
    ...
    budget = random.uniform(1524.8599414582052, 2287.2899121873074)
    gain_base = random.uniform(584.473676440239, 714.3567156491811)
    cost_base = random.uniform(53.81372957443178, 65.77233614652773)
    ...
    result = {
        ...
        "params_used": {"budget_range": [1524.8599414582052, 2287.2899121873074], "gain_range": [584.473676440239, 714.3567156491811], "cost_range": [53.81372957443178, 65.77233614652773], "k": 3.1977982140200343, "epsilon": 0.3284187114965685, "complexity": 2}
    }
