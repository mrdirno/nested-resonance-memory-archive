...
def run_generation():
    ...
    budget = random.uniform(427.68562877421346, 641.5284431613202)
    gain_base = random.uniform(209.34458681037572, 255.86560610157034)
    cost_base = random.uniform(44.260716751589605, 54.09643158527619)
    ...
    result = {
        ...
        "params_used": {"budget_range": [427.68562877421346, 641.5284431613202], "gain_range": [209.34458681037572, 255.86560610157034], "cost_range": [44.260716751589605, 54.09643158527619], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
