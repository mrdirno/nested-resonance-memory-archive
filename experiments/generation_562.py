...
def run_generation():
    ...
    budget = random.uniform(25.780877877592072, 38.67131681638811)
    gain_base = random.uniform(136.45725915490328, 166.78109452265957)
    cost_base = random.uniform(19.451185982922645, 23.773671756905458)
    ...
    result = {
        ...
        "params_used": {"budget_range": [25.780877877592072, 38.67131681638811], "gain_range": [136.45725915490328, 166.78109452265957], "cost_range": [19.451185982922645, 23.773671756905458], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
