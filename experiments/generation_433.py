...
def run_generation():
    ...
    budget = random.uniform(344.80893109847636, 517.2133966477145)
    gain_base = random.uniform(120.85057200434183, 147.70625467197334)
    cost_base = random.uniform(37.91346875790062, 46.338684037434085)
    ...
    result = {
        ...
        "params_used": {"budget_range": [344.80893109847636, 517.2133966477145], "gain_range": [120.85057200434183, 147.70625467197334], "cost_range": [37.91346875790062, 46.338684037434085], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
