...
def run_generation():
    ...
    budget = random.uniform(658.291436894977, 987.4371553424654)
    gain_base = random.uniform(168.80423201956683, 206.3162835794706)
    cost_base = random.uniform(14.633816082790172, 17.8857752122991)
    ...
    result = {
        ...
        "params_used": {"budget_range": [658.291436894977, 987.4371553424654], "gain_range": [168.80423201956683, 206.3162835794706], "cost_range": [14.633816082790172, 17.8857752122991], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
