...
def run_generation():
    ...
    budget = random.uniform(176.21438845339273, 264.3215826800891)
    gain_base = random.uniform(99.84609211930034, 122.03411259025597)
    cost_base = random.uniform(35.53095951727471, 43.42672829889131)
    ...
    result = {
        ...
        "params_used": {"budget_range": [176.21438845339273, 264.3215826800891], "gain_range": [99.84609211930034, 122.03411259025597], "cost_range": [35.53095951727471, 43.42672829889131], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
