...
def run_generation():
    ...
    budget = random.uniform(5142.3911742127, 7713.586761319049)
    gain_base = random.uniform(614.5715622875723, 751.1430205736996)
    cost_base = random.uniform(5.019799145363071, 6.135310066554865)
    ...
    result = {
        ...
        "params_used": {"budget_range": [5142.3911742127, 7713.586761319049], "gain_range": [614.5715622875723, 751.1430205736996], "cost_range": [5.019799145363071, 6.135310066554865], "k": 8.080861805504712, "epsilon": 0.980263816546247, "complexity": 2}
    }
