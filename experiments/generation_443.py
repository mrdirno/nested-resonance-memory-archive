...
def run_generation():
    ...
    budget = random.uniform(244.78663254834657, 367.1799488225198)
    gain_base = random.uniform(151.47026933960495, 185.1303291928505)
    cost_base = random.uniform(17.54957777544364, 21.44948394776445)
    ...
    result = {
        ...
        "params_used": {"budget_range": [244.78663254834657, 367.1799488225198], "gain_range": [151.47026933960495, 185.1303291928505], "cost_range": [17.54957777544364, 21.44948394776445], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
