...
def run_generation():
    ...
    budget = random.uniform(5972.99433453999, 8959.491501809984)
    gain = random.uniform(539.7449448981731, 659.6882659866561)
    cost = random.uniform(68.49253474865993, 83.71309802613993)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [5972.99433453999, 8959.491501809984], "gain_range": [539.7449448981731, 659.6882659866561], "cost_range": [68.49253474865993, 83.71309802613993], "k": 9.505937517777465, "epsilon": 0.0955725859361949}
    }
