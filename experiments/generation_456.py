...
def run_generation():
    ...
    budget = random.uniform(5086.327938873055, 7629.491908309583)
    gain_base = random.uniform(390.9467480391451, 477.8238031589552)
    cost_base = random.uniform(75.82881587732733, 92.67966385006673)
    ...
    result = {
        ...
        "params_used": {"budget_range": [5086.327938873055, 7629.491908309583], "gain_range": [390.9467480391451, 477.8238031589552], "cost_range": [75.82881587732733, 92.67966385006673], "k": 4.5140714246268105, "epsilon": 0.29271990739874953, "complexity": 2}
    }
