...
def run_generation():
    ...
    budget = random.uniform(526.4794463869424, 789.7191695804134)
    gain_base = random.uniform(134.3088437837424, 164.15525351346292)
    cost_base = random.uniform(38.996258062522955, 47.66209318752806)
    ...
    result = {
        ...
        "params_used": {"budget_range": [526.4794463869424, 789.7191695804134], "gain_range": [134.3088437837424, 164.15525351346292], "cost_range": [38.996258062522955, 47.66209318752806], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
