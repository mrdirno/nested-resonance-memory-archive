...
def run_generation():
    ...
    budget = random.uniform(4265.820106298066, 6398.730159447099)
    gain_base = random.uniform(862.9388947962049, 1000.0)
    cost_base = random.uniform(41.97618564186562, 51.30422689561354)
    ...
    result = {
        ...
        "params_used": {"budget_range": [4265.820106298066, 6398.730159447099], "gain_range": [862.9388947962049, 1000.0], "cost_range": [41.97618564186562, 51.30422689561354], "k": 3.3136398384246877, "epsilon": 0.47667923498748715, "complexity": 2}
    }
