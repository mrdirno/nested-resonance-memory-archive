...
def run_generation():
    ...
    budget = random.uniform(520.94974366226, 781.4246154933898)
    gain_base = random.uniform(103.3047457826596, 126.26135595658397)
    cost_base = random.uniform(43.53041108772411, 53.20383577388503)
    ...
    result = {
        ...
        "params_used": {"budget_range": [520.94974366226, 781.4246154933898], "gain_range": [103.3047457826596, 126.26135595658397], "cost_range": [43.53041108772411, 53.20383577388503], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
