...
def run_generation():
    ...
    budget = random.uniform(286.15940017842547, 429.23910026763815)
    gain_base = random.uniform(135.01187386423666, 165.0145125007337)
    cost_base = random.uniform(35.400161804703664, 43.26686442797115)
    ...
    result = {
        ...
        "params_used": {"budget_range": [286.15940017842547, 429.23910026763815], "gain_range": [135.01187386423666, 165.0145125007337], "cost_range": [35.400161804703664, 43.26686442797115], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
