...
def run_generation():
    ...
    budget = random.uniform(3672.2951614154344, 5508.442742123151)
    gain_base = random.uniform(135.3967339473293, 165.4848970467358)
    cost_base = random.uniform(25.64242119854604, 31.340737020445157)
    ...
    result = {
        ...
        "params_used": {"budget_range": [3672.2951614154344, 5508.442742123151], "gain_range": [135.3967339473293, 165.4848970467358], "cost_range": [25.64242119854604, 31.340737020445157], "k": 0.6192317898817267, "epsilon": 0.31052203786747046, "complexity": 2}
    }
