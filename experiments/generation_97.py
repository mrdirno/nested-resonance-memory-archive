...
def run_generation():
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=1.7876849238272468, epsilon=0.826558351662993))
    ...
    result = {
        ...
        "params_used": {"budget_range": [1.0, 10000.0], "gain_range": [10.0, 1000.0], "cost_range": [1.0, 100.0], "k": 1.7876849238272468, "epsilon": 0.826558351662993, "complexity": 2}
    }
