...
# Context: 
#   Phase 172 (Environmental) -> Validated Policy/Search.
#   Phase 171 (Telecom) -> Validated Churn Triage.
#   Gap: Manufacturing (Process Control) or Healthcare Ops (Service).
# -----------------------------------------------------------------------------
...
def main():
    ...
    candidates = [
        {"name": "Manufacturing",   "novelty": 0.80, "impact": 0.90, "tractability": 0.75}, 
