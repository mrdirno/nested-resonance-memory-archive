...
def run_generation():
    ...
    budget = random.uniform(1063.8365852543957, 1595.7548778815935)
    gain_base = random.uniform(137.60208689077444, 168.18032842205767)
    cost_base = random.uniform(61.27100521029033, 74.88678414591041)
    ...
    result = {
        ...
        "params_used": {"budget_range": [1063.8365852543957, 1595.7548778815935], "gain_range": [137.60208689077444, 168.18032842205767], "cost_range": [61.27100521029033, 74.88678414591041], "k": 1.022852120251879, "epsilon": 0.6565268865173267, "complexity": 2}
    }
