...
def run_generation():
    ...
    budget = random.uniform(7192.343931475537, 10000.0)
    gain_base = random.uniform(198.35971613879704, 242.43965305852973)
    cost_base = random.uniform(23.666310655796085, 28.92549080152855)
    ...
    result = {
        ...
        "params_used": {"budget_range": [7192.343931475537, 10000.0], "gain_range": [198.35971613879704, 242.43965305852973], "cost_range": [23.666310655796085, 28.92549080152855], "k": 4.552964741471671, "epsilon": 0.5906564314487059, "complexity": 2}
    }
