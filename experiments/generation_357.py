...
def run_generation():
    ...
    budget = random.uniform(1505.3754964178952, 2258.0632446268423)
    gain_base = random.uniform(884.8294348483731, 1000.0)
    cost_base = random.uniform(46.22319832384177, 56.495020173584386)
    ...
    result = {
        ...
        "params_used": {"budget_range": [1505.3754964178952, 2258.0632446268423], "gain_range": [884.8294348483731, 1000.0], "cost_range": [46.22319832384177, 56.495020173584386], "k": 2.0902790366501907, "epsilon": 0.9736883768041519, "complexity": 2}
    }
