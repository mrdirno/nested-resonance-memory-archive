...
def run_generation():
    ...
    budget = random.uniform(532.0153433074842, 798.0230149612263)
    gain_base = random.uniform(129.6035865189299, 158.40438352313654)
    cost_base = random.uniform(36.94514947003647, 45.15518268560013)
    ...
    result = {
        ...
        "params_used": {"budget_range": [532.0153433074842, 798.0230149612263], "gain_range": [129.6035865189299, 158.40438352313654], "cost_range": [36.94514947003647, 45.15518268560013], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
