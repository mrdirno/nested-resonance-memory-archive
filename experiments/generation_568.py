...
def run_generation():
    ...
    budget = random.uniform(1402.5162214402587, 2103.774332160388)
    gain_base = random.uniform(593.5996943026422, 725.5107374810073)
    cost_base = random.uniform(53.87510806457366, 65.84735430114559)
    ...
    result = {
        ...
        "params_used": {"budget_range": [1402.5162214402587, 2103.774332160388], "gain_range": [593.5996943026422, 725.5107374810073], "cost_range": [53.87510806457366, 65.84735430114559], "k": 3.1977982140200343, "epsilon": 0.3284187114965685, "complexity": 2}
    }
