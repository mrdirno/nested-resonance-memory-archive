...
def run_generation():
    ...
    budget = random.uniform(92.3858468150499, 138.57877022257483)
    gain_base = random.uniform(133.143990903706, 162.7315444378629)
    cost_base = random.uniform(18.97156853972176, 23.187472659659928)
    ...
    result = {
        ...
        "params_used": {"budget_range": [92.3858468150499, 138.57877022257483], "gain_range": [133.143990903706, 162.7315444378629], "cost_range": [18.97156853972176, 23.187472659659928], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
