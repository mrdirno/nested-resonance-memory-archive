...
def run_generation():
    ...
    budget = random.uniform(4830.911735635657, 7246.367603453485)
    gain_base = random.uniform(589.3851101624048, 720.3595790873836)
    cost_base = random.uniform(65.91181397572731, 80.55888374811117)
    ...
    result = {
        ...
        "params_used": {"budget_range": [4830.911735635657, 7246.367603453485], "gain_range": [589.3851101624048, 720.3595790873836], "cost_range": [65.91181397572731, 80.55888374811117], "k": 9.262558568547654, "epsilon": 0.6044975830664067, "complexity": 2}
    }
