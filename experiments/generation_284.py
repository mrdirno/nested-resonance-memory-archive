...
def run_generation():
    ...
    budget = random.uniform(14.672239448333546, 22.008359172500317)
    gain_base = random.uniform(152.1108439878062, 185.91325376287426)
    cost_base = random.uniform(5.087993757528073, 6.218659036978756)
    ...
    result = {
        ...
        "params_used": {"budget_range": [14.672239448333546, 22.008359172500317], "gain_range": [152.1108439878062, 185.91325376287426], "cost_range": [5.087993757528073, 6.218659036978756], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
