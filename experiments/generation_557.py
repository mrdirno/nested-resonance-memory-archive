...
def run_generation():
    ...
    budget = random.uniform(337.17209918763797, 505.75814878145684)
    gain_base = random.uniform(122.44643334493868, 149.6567518660362)
    cost_base = random.uniform(46.32896954396903, 56.624296109295486)
    ...
    result = {
        ...
        "params_used": {"budget_range": [337.17209918763797, 505.75814878145684], "gain_range": [122.44643334493868, 149.6567518660362], "cost_range": [46.32896954396903, 56.624296109295486], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
