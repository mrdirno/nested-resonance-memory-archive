...
def run_generation():
    ...
    budget = random.uniform(622.0897432334036, 933.1346148501052)
    gain = random.uniform(853.4394641220264, 1000.0)
    cost = random.uniform(23.646831608159108, 28.90168307663891)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [622.0897432334036, 933.1346148501052], "gain_range": [853.4394641220264, 1000.0], "cost_range": [23.646831608159108, 28.90168307663891], "k": 4.891180113933895, "epsilon": 0.992416018679223}
    }
