...
Test if changing initial energy affects dead zone locations.
"""
...
def main():
    print(f"CYCLE 1751: Initial Energy | {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    print("=" * 70)
    print("Testing different initial energy values")
    print("=" * 70)

    seeds = list(range(1751001, 1751031))

    energies = [0.5, 0.8, 1.0, 1.2, 1.5]
    zone1_range = range(25, 34)

    print(f"\n{'Energy':<10} | {'Zone 1 Min':>15}")
    print("-" * 30)
