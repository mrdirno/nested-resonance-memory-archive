...
def run_generation():
    ...
    budget = random.uniform(5459.449137352165, 8189.173706028247)
    gain_base = random.uniform(24.408087925370012, 29.832107464341128)
    cost_base = random.uniform(49.584148592317426, 60.602848279499085)
    ...
    for i in range(complexity):
        ...
        agents.append(BCPAgent(budget=b, k=8.276252758266143, epsilon=0.7287758911871579))
    ...
    result = {
        ...
        "params_used": {"budget_range": [5459.449137352165, 8189.173706028247], "gain_range": [24.408087925370012, 29.832107464341128], "cost_range": [49.584148592317426, 60.602848279499085], "k": 8.276252758266143, "epsilon": 0.7287758911871579, "complexity": 2}
    }
