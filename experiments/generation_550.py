...
def run_generation():
    ...
    budget = random.uniform(308.85656318062195, 463.28484477093286)
    gain_base = random.uniform(677.1705630973729, 827.6529104523447)
    cost_base = random.uniform(6.364991808168783, 7.779434432206291)
    ...
    result = {
        ...
        "params_used": {"budget_range": [308.85656318062195, 463.28484477093286], "gain_range": [677.1705630973729, 827.6529104523447], "cost_range": [6.364991808168783, 7.779434432206291], "k": 7.113091460707711, "epsilon": 0.07428000042569488, "complexity": 2}
    }
