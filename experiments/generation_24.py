...
def run_generation():
    ...
    budget = random.uniform(598.9681087515349, 898.4521631273022)
    gain = random.uniform(133.24450442282702, 162.85439429456636)
    cost = random.uniform(17.489557462457974, 21.376125787448636)
    ...
    result = {
        ...
        "value": val,
        "survived": val > 0,
        "params_used": {"budget_range": [598.9681087515349, 898.4521631273022], "gain_range": [133.24450442282702, 162.85439429456636], "cost_range": [17.489557462457974, 21.376125787448636], "k": 1.0, "epsilon": 0.1}
    }
