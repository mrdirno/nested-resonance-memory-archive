#!/usr/bin/env python3
"""
CYCLE 342: CRITICAL THRESHOLD MAPPING
...
Purpose:
  Map critical K threshold more precisely.

Research Question:
  Can the food web survive K reduction to 300?

Background:
  C340: K=600→200 - 0% survival (collapse)
  C341: K=600→400 - 95% survival (stable)
  C342: K=600→300 - test intermediate

Design:
  - K starts at 600
  - At cycle 15000, K drops to 300
  - Tests survival vs collapse
  - 20 seeds
...
CYCLE_ID = "C342"
CYCLE_NAME = "Critical Threshold Mapping"
MODE = "CRITICAL_THRESHOLD"
...
SEEDS = list(range(4820, 4840))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run critical threshold experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c342_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 342: CRITICAL THRESHOLD MAPPING")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c342_critical_threshold_results.json"
