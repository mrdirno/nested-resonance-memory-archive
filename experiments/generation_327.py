...
def run_generation():
    ...
    budget = random.uniform(4715.261399601351, 7072.892099402025)
    gain_base = random.uniform(645.0289828531693, 788.3687568205403)
    cost_base = random.uniform(5.30776953237662, 6.487273872904757)
    ...
    result = {
        ...
        "params_used": {"budget_range": [4715.261399601351, 7072.892099402025], "gain_range": [645.0289828531693, 788.3687568205403], "cost_range": [5.30776953237662, 6.487273872904757], "k": 8.080861805504712, "epsilon": 0.980263816546247, "complexity": 2}
    }
