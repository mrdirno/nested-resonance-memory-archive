...
def run_generation():
    ...
    budget = random.uniform(1070.2838945766005, 1605.4258418649003)
    gain_base = random.uniform(127.04887057867438, 155.28195292949093)
    cost_base = random.uniform(57.05556438060077, 69.73457868740094)
    ...
    result = {
        ...
        "params_used": {"budget_range": [1070.2838945766005, 1605.4258418649003], "gain_range": [127.04887057867438, 155.28195292949093], "cost_range": [57.05556438060077, 69.73457868740094], "k": 1.022852120251879, "epsilon": 0.6565268865173267, "complexity": 2}
    }
