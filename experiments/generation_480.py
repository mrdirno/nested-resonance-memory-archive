...
def run_generation():
    ...
    budget = random.uniform(4621.602288127949, 6932.403432191922)
    gain_base = random.uniform(272.45798283689675, 333.00420124509606)
    cost_base = random.uniform(40.9197212800042, 50.01299267556069)
    ...
    result = {
        ...
        "params_used": {"budget_range": [4621.602288127949, 6932.403432191922], "gain_range": [272.45798283689675, 333.00420124509606], "cost_range": [40.9197212800042, 50.01299267556069], "k": 6.935734839559108, "epsilon": 0.059237624643426356, "complexity": 2}
    }
