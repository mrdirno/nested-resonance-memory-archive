...
def run_generation():
    ...
    budget = random.uniform(680.4598064552016, 1020.6897096828023)
    gain_base = random.uniform(208.6500166277784, 255.01668698950695)
    cost_base = random.uniform(45.07347339898717, 55.08980082098432)
    ...
    result = {
        ...
        "params_used": {"budget_range": [680.4598064552016, 1020.6897096828023], "gain_range": [208.6500166277784, 255.01668698950695], "cost_range": [45.07347339898717, 55.08980082098432], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
