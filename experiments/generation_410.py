...
def run_generation():
    ...
    budget = random.uniform(682.3966169071527, 1023.5949253607291)
    gain_base = random.uniform(251.8834484121893, 307.8575480593425)
    cost_base = random.uniform(58.3971767698759, 71.37432716318166)
    ...
    result = {
        ...
        "params_used": {"budget_range": [682.3966169071527, 1023.5949253607291], "gain_range": [251.8834484121893, 307.8575480593425], "cost_range": [58.3971767698759, 71.37432716318166], "k": 0.9390813052558535, "epsilon": 0.2058159053431028, "complexity": 2}
    }
