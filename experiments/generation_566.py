...
def run_generation():
    ...
    budget = random.uniform(1331.6372751236677, 1997.455912685501)
    gain_base = random.uniform(644.6065698456968, 787.8524742558516)
    cost_base = random.uniform(58.52156344942534, 71.52635532707542)
    ...
    result = {
        ...
        "params_used": {"budget_range": [1331.6372751236677, 1997.455912685501], "gain_range": [644.6065698456968, 787.8524742558516], "cost_range": [58.52156344942534, 71.52635532707542], "k": 3.1977982140200343, "epsilon": 0.3284187114965685, "complexity": 2}
    }
