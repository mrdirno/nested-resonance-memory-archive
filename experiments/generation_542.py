...
def run_generation():
    ...
    budget = random.uniform(744.8044315221497, 1117.2066472832244)
    gain_base = random.uniform(103.5027763325265, 126.50339329531016)
    cost_base = random.uniform(41.03505468726481, 50.15395572887921)
    ...
    result = {
        ...
        "params_used": {"budget_range": [744.8044315221497, 1117.2066472832244], "gain_range": [103.5027763325265, 126.50339329531016], "cost_range": [41.03505468726481, 50.15395572887921], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
