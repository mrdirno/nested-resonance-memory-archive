...
def run_generation():
    ...
    budget = random.uniform(4285.580911999072, 6428.371367998607)
    gain_base = random.uniform(140.41412064746984, 171.61725856912983)
    cost_base = random.uniform(25.801184164542967, 31.53478064555252)
    ...
    result = {
        ...
        "params_used": {"budget_range": [4285.580911999072, 6428.371367998607], "gain_range": [140.41412064746984, 171.61725856912983], "cost_range": [25.801184164542967, 31.53478064555252], "k": 0.6192317898817267, "epsilon": 0.31052203786747046, "complexity": 2}
    }
