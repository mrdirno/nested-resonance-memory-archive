...
def run_generation():
    ...
    budget = random.uniform(135.4893502228161, 203.23402533422413)
    gain_base = random.uniform(93.64348087653812, 114.4531432935466)
    cost_base = random.uniform(34.29119245509439, 41.91145744511537)
    ...
    result = {
        ...
        "params_used": {"budget_range": [135.4893502228161, 203.23402533422413], "gain_range": [93.64348087653812, 114.4531432935466], "cost_range": [34.29119245509439, 41.91145744511537], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
