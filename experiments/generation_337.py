...
def run_generation():
    ...
    budget = random.uniform(1925.2264709995882, 2887.839706499382)
    gain_base = random.uniform(860.939108694342, 1000.0)
    cost_base = random.uniform(1.9772284712504171, 2.4166125759727324)
    ...
    result = {
        ...
        "params_used": {"budget_range": [1925.2264709995882, 2887.839706499382], "gain_range": [860.939108694342, 1000.0], "cost_range": [1.9772284712504171, 2.4166125759727324], "k": 0.4521598713923174, "epsilon": 0.4026574009126241, "complexity": 2}
    }
