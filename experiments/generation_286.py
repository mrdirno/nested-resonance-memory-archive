...
def run_generation():
    ...
    budget = random.uniform(13.561086432158033, 20.34162964823705)
    gain_base = random.uniform(158.99814993098204, 194.33107213786695)
    cost_base = random.uniform(4.3996690949030555, 5.377373338214846)
    ...
    result = {
        ...
        "params_used": {"budget_range": [13.561086432158033, 20.34162964823705], "gain_range": [158.99814993098204, 194.33107213786695], "cost_range": [4.3996690949030555, 5.377373338214846], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
