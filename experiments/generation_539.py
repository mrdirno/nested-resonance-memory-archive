...
def run_generation():
    ...
    budget = random.uniform(410.71013918173685, 616.0652087726053)
    gain_base = random.uniform(144.92674681746573, 177.13269055468032)
    cost_base = random.uniform(33.39494600686482, 40.81604511950145)
    ...
    result = {
        ...
        "params_used": {"budget_range": [410.71013918173685, 616.0652087726053], "gain_range": [144.92674681746573, 177.13269055468032], "cost_range": [33.39494600686482, 40.81604511950145], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
