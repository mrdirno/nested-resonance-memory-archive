...
def run_generation():
    ...
    budget = random.uniform(395.84298485971107, 593.7644772895666)
    gain_base = random.uniform(207.41588153587, 253.50829965495222)
    cost_base = random.uniform(41.68670144572985, 50.95041287811427)
    ...
    result = {
        ...
        "params_used": {"budget_range": [395.84298485971107, 593.7644772895666], "gain_range": [207.41588153587, 253.50829965495222], "cost_range": [41.68670144572985, 50.95041287811427], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
