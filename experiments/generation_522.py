...
def run_generation():
    ...
    budget = random.uniform(496.6491105419241, 744.9736658128861)
    gain_base = random.uniform(147.9597559984597, 180.8397017758952)
    cost_base = random.uniform(25.798973264139406, 31.53207843394816)
    ...
    result = {
        ...
        "params_used": {"budget_range": [496.6491105419241, 744.9736658128861], "gain_range": [147.9597559984597, 180.8397017758952], "cost_range": [25.798973264139406, 31.53207843394816], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
