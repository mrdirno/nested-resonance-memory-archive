...
def run_generation():
    ...
    budget = random.uniform(246.8647811452921, 370.2971717179381)
    gain_base = random.uniform(115.30865600949922, 140.93280178938795)
    cost_base = random.uniform(32.107173981857365, 39.24210153338122)
    ...
    result = {
        ...
        "params_used": {"budget_range": [246.8647811452921, 370.2971717179381], "gain_range": [115.30865600949922, 140.93280178938795], "cost_range": [32.107173981857365, 39.24210153338122], "k": 1.0, "epsilon": 0.1, "complexity": 1}
    }
