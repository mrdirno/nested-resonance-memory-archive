...
def run_generation():
    ...
    budget = random.uniform(1908.6381563454152, 2862.9572345181223)
    gain_base = random.uniform(118.32483674898361, 144.61924491542442)
    cost_base = random.uniform(1.6956749874487869, 2.0724916513262954)
    ...
    result = {
        ...
        "params_used": {"budget_range": [1908.6381563454152, 2862.9572345181223], "gain_range": [118.32483674898361, 144.61924491542442], "cost_range": [1.6956749874487869, 2.0724916513262954], "k": 7.698825262071338, "epsilon": 0.31888056002057574, "complexity": 2}
    }
