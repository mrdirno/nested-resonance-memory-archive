...
def run_generation():
    ...
    budget = random.uniform(3613.38153124929, 5420.072296873935)
    gain_base = random.uniform(873.5521400721434, 1000.0)
    cost_base = random.uniform(43.61720478240548, 53.30991695627336)
    ...
    result = {
        ...
        "params_used": {"budget_range": [3613.38153124929, 5420.072296873935], "gain_range": [873.5521400721434, 1000.0], "cost_range": [43.61720478240548, 53.30991695627336], "k": 3.3136398384246877, "epsilon": 0.47667923498748715, "complexity": 2}
    }
