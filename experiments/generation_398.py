...
def run_generation():
    ...
    budget = random.uniform(861.304942678409, 1291.9574140176135)
    gain_base = random.uniform(327.8809508264348, 400.7433843434203)
    cost_base = random.uniform(67.07972289407212, 81.98632798164371)
    ...
    result = {
        ...
        "params_used": {"budget_range": [861.304942678409, 1291.9574140176135], "gain_range": [327.8809508264348, 400.7433843434203], "cost_range": [67.07972289407212, 81.98632798164371], "k": 0.5044925026778514, "epsilon": 0.7786510323888909, "complexity": 2}
    }
