...
# CONFIGURATION
# ==========================================
OUTPUT_FILE = "fabrication/practical_design/LAMP_DESIGN/shaft_qa_v2.stl"
RESOLUTION = 120 
SIZE_Z = 180.0   
MAX_DIAMETER = 40.0
MIN_DIAMETER = 20.0 
...
# GENERATOR
# ==========================================
def generate_shaft_v2():
    print(f"Initializing QA Shaft V2 (Socket Plug)...")
    ...
    for z in range(res_z):
        ...
        for x in range(res_x):
            ...
            for y in range(res_y):
                ...
                # 2. Plug Logic (Priority)
                if is_plug:
                    if r < (PLUG_DIAMETER / 2.0):
                        grid[x,y,z] = True
                    continue # If plug, ignore ribs/profile, just be a cylinder (with hole)
