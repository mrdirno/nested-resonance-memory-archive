...
OUTPUT_FILE = "fabrication/practical_design/LAMP_DESIGN/shaft_qa_v5_reinforced.stl"
RESOLUTION = 120 
SIZE_Z = 180.0   
MAX_DIAMETER = 40.0 
CROWN_DIAMETER = 55.0 
...
def generate_shaft_v5_reinforced():
    print(f"Initializing QA Shaft V5 (Reinforced)...")
    ...
    for z in range(res_z):
        ...
        for x in range(res_x):
            ...
            for y in range(res_y):
                ...
                # REINFORCEMENT: Force solid inner shell
                # The lattice breaks because it's too thin.
                # We force a 2mm solid shell around the cable clearance.
                if r < ((CABLE_CLEARANCE/2.0) + 2.0):
                    grid[x,y,z] = True
