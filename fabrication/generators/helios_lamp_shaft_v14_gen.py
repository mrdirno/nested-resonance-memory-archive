...
# -----------------------------------------------------------------------------
# HELIOS LAMP SERIES V14: THE GRAVITY WELL (SHAFT)
# -----------------------------------------------------------------------------
# Concept: Singularity Core (Ultra-dense Helix).
# Math: Compressed Gyroid (High frequency).
# -----------------------------------------------------------------------------

def generate_shaft(output_path, height=160.0, resolution=120):
    print(f"Generating V14 SHAFT (Singularity Core): {output_path}")
    ...
    base_scale = 2.0 * math.pi / 10.0 # Higher frequency
