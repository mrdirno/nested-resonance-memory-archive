...
# -----------------------------------------------------------------------------
# HELIOS LAMP SERIES V24: THE WIRE (SHADE)
# -----------------------------------------------------------------------------
# Concept: Wireframe Cage (Bent Wire).
# Math: Low-Density Tubular Lattice.
# -----------------------------------------------------------------------------

def generate_shade(output_path, diameter=200.0, height=140.0, resolution=100, hole_diameter=14.0):
    print(f"Generating V24 SHADE (Wireframe Cage): {output_path}")
    ...
    base_scale = 2.0 * math.pi / 40.0 # Very Large holes
        ...
        for x_idx in range(res_x):
            ...
            for y_idx in range(res_y):
                ...
                if in_outer and not in_inner and not in_hand:
                    # Wireframe Logic
                    # Standard Gyroid but large scale and thin walls
