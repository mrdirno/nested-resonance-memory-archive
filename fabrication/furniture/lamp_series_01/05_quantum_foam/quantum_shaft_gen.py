...
# -----------------------------------------------------------------------------
# HELIOS LAMP SERIES 01: THE QUANTUM FOAM (SHAFT)
# -----------------------------------------------------------------------------
# Logic:
# 1. Shape: Wave Function Envelope (Sine Wave Radius).
...
def generate_shaft(output_path, height=160.0, resolution=120):
    print(f"Generating QUANTUM SHAFT: {output_path}")
    ...
    # Wave Params
    # Standing wave
    freq = 2.0 * math.pi / 80.0 # 80mm wavelength (2 nodes)
...
if __name__ == "__main__":
    output_file = "fabrication/furniture/lamp_series_01/05_quantum_foam/quantum_shaft.stl"
