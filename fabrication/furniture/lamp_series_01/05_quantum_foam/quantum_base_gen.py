...
# -----------------------------------------------------------------------------
# HELIOS LAMP SERIES 01: THE QUANTUM FOAM (BASE)
# -----------------------------------------------------------------------------
# Logic:
# 1. Shape: The Observer (Clean Cylinder).
...
def generate_base(output_path, diameter=140.0, height=35.0, resolution=100):
    print(f"Generating QUANTUM BASE: {output_path}")
...
if __name__ == "__main__":
    output_file = "fabrication/furniture/lamp_series_01/05_quantum_foam/quantum_base.stl"
