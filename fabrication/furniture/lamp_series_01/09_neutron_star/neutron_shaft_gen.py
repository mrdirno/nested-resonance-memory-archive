...
# -----------------------------------------------------------------------------
# HELIOS LAMP SERIES 01: THE NEUTRON STAR (SHAFT)
# -----------------------------------------------------------------------------
# Logic:
# 1. Shape: Flux Tube (Cylinder with twisted magnetic ribs).
...
def generate_shaft(output_path, height=160.0, resolution=120):
    print(f"Generating NEUTRON SHAFT: {output_path}")
    ...
    for z_idx in range(res_z):
        ...
        for x_idx in range(res_x):
            ...
            for y_idx in range(res_y):
                ...
                # Rib modulation
                mod = math.cos(num_ribs * angle + current_twist)
                # Radius varies
                r = base_radius + (mod * 2.0)
