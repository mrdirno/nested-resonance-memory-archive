...
*   **Files:**
    ...
    *   `01_redshift/redshift_shade.stl`
...
*   **Files:**
    ...
    *   `02_event_horizon/event_horizon_shaft_medium.stl` (Standard)
    *   `02_event_horizon/event_horizon_shade.stl`
...
*   **Files:**
    ...
    *   `03_singularity/singularity_shade.stl`
...
*   **Files:**
    ...
    *   `04_supernova/supernova_shade.stl`

---

## FABRICATION PROTOCOL (ALL LAMPS)
*   **Material:**
    *   **Shade:** Translucent PETG or PLA (Essential for light diffusion).
    *   **Body:** Matte PLA (Stone/Marble) or Silk PLA (Metallic).
*   **Slicer Settings:**
    *   **Layer Height:** 0.2mm.
    *   **Walls:** 3 (Shade), 4 (Body).
    *   **Infill:** 0% (Shade), 15-100% (Body).
    *   **Supports:** **NONE**. All angles < 50°.
*   **Hardware:**
    *   Standard 1/8 IP Lamp Kit.
    *   E26 Socket.
    *   LED Bulb (Max 9W).
