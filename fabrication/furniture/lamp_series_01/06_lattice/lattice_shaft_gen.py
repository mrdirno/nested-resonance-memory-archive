...
# -----------------------------------------------------------------------------
# HELIOS LAMP SERIES 01: THE LATTICE (SHAFT) - V4 QA
# -----------------------------------------------------------------------------
# Logic: Cubic Lattice Column
# Dims: 50mm Square Column -> Height 200mm
# Core: Hollow Tube for Wire (V4 Std)
# -----------------------------------------------------------------------------
...
def generate_shaft(output_path, width=50.0, height=200.0, resolution=100):
    print(f"Generating LATTICE SHAFT (V4 QA): {output_path}")
    
    # Core Parameters (V4 QA)
    core_hole_radius = 7.0 # 14mm hole
    core_wall_radius = 9.0 # 18mm solid core tube
