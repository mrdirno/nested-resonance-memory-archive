...
# -----------------------------------------------------------------------------
# HELIOS LAMP SERIES 01: THE TIME CRYSTAL (BASE)
# -----------------------------------------------------------------------------
# Logic:
# 1. Shape: Faceted Anchor (Low poly).
...
def generate_base(output_path, diameter=140.0, height=35.0, resolution=100):
    print(f"Generating TIME BASE: {output_path}")
    ...
    for z_idx in range(res_z):
        ...
        for x_idx in range(res_xy):
            ...
            for y_idx in range(res_xy):
                ...
                # Polygon Bound
                if d_poly < (radius * 0.9) and z_mm <= height:
                    is_solid = True
...
if __name__ == "__main__":
    output_file = "fabrication/furniture/lamp_series_01/08_time_crystal/time_base.stl"
