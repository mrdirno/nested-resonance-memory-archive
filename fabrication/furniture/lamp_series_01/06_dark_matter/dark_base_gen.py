...
# -----------------------------------------------------------------------------
# HELIOS LAMP SERIES 01: THE DARK MATTER (BASE)
# -----------------------------------------------------------------------------
# Logic:
# 1. Shape: Void Anchor (Ring-like structure, negative space).
...
def generate_base(output_path, diameter=140.0, height=35.0, resolution=100):
    print(f"Generating DARK MATTER BASE: {output_path}")
    ...
    # Voronoi Void Pattern
    # Same logic as shade but denser
    num_points = 50
    points = []
    random.seed(202)
...
if __name__ == "__main__":
    output_file = "fabrication/furniture/lamp_series_01/06_dark_matter/dark_base.stl"
