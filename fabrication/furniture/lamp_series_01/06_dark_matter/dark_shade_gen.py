...
def generate_shade(output_path, diameter=200.0, height=140.0, resolution=100, hole_diameter=12.5):
    ...
    # Distribute points in the bounding box
    for _ in range(num_points):
        px = random.uniform(-diameter/2 - 20, diameter/2 + 20)
        py = random.uniform(-diameter/2 - 20, diameter/2 + 20)
        pz = random.uniform(-20, height + 20)
        points.append((px, py, pz))
        
    print("Calculating Cosmic Web...")
...
if __name__ == "__main__":
    output_file = "fabrication/furniture/lamp_series_01/06_dark_matter/dark_shade.stl"
