...
# -----------------------------------------------------------------------------
# HELIOS LAMP SERIES 01: THE SINGULARITY (BASE)
# -----------------------------------------------------------------------------
# Logic:
...
def generate_base(output_path, diameter=140.0, height=35.0, resolution=100):
    print(f"Generating SINGULARITY BASE: {output_path}")
    ...
    # Central Hole
    center_hole_radius = 5.0 # 10mm dia
    recess_radius = 20.0
    recess_depth = 5.0
    ...
    for z_idx in range(res_z):
        ...
        # Gravity Well Profile (Concave Top)
        # z_surface = height - k * r^2
        # Let center be lower than rim.
        # Rim height = height
        # Center height = height - 10mm
        ...
        for x_idx in range(res_xy):
            ...
            for y_idx in range(res_xy):
                ...
                # Parabolic dip
                dip = 10.0 * (1.0 - (dist/radius)) # 10mm dip at center
                if dip < 0: dip = 0
                ...
                if z_mm < feet_depth:
                    # 4 feet at 90 deg
                    # Check if point is inside any foot circle
                ...
                # Hardware Recess (Bottom) - Space for nut
...
if __name__ == "__main__":
    output_file = "fabrication/furniture/lamp_series_01/03_singularity/singularity_base.stl"
