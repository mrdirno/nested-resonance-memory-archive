        ...
        for x_idx in range(res_x):
            ...
            for y_idx in range(res_y):
                ...
                if dist <= current_radius:
                    # Square wave angularly
                    spline_phase = (angle * num_splines / (2*math.pi)) % 1.0
                    
                    # Spline is outer part
                    is_spline = spline_phase < 0.5
