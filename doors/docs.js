...
window.TRADE_DOCS = {
  ...
  "docs": [
      ...
      },
      {
        ...
        "halt": "Only if there is no statement of who directed the work to proceed — without the direction this is just a condition report, and the frame notice and the lost-day write-up already exist for that. A note that says the floor wasn't in but never says who said go is a note that proves he knew and hung it anyway. And if the opening he was told to hang has wire at the frame nobody has cleared, this is the wrong document: that holds until whoever owns the wire clears it — it goes on the not-ready note, never hung under direction.",
        "facts": [
  ...
  "overrides": {
    ...
    "handover": {
      ...
      "facts": [
        ...
        "where the pulled construction cores went, by count",
        "who took the keys and the control key, when, and who signed",
        "where the keying schedule lives and who owns it from here — never what is in it",
      ...
      "sections": [
        ...
        { "h": "Cores and keys",
          "r": "Construction cores pulled and permanent cores set, opening by opening. Keys handed over by the count and the ring — how many, to whom, on what date — never the bitting and never the keyway; the schedule those keys were cut to is somebody else's document and this one names where it lives and who owns it from here, nothing more. The control key: who took it, the date, and who signed for it." },
        { "h": "What was operated, and by whom",
          "r": "What you physically operated at each opening and what it did, in your words — latched, closed from where you let it go, the exit device dogged and undogged, the closer brought it home, the labelled leaves let go from open and watched close and latch on their own — and who walked it with you and when. No tolerance, no rating and no 'passes': what it did, never what it is worth. A rated opening's inspection is a certified inspector's form, and this is not it." },
        { "h": "Open, and known",
    ...
    "damage-found": {
      ...
      "sections": [
        ...
        { "h": "What is damaged",
          "r": "Leaf, frame, hardware or finish, and how far: a dent and its size and location off the floor, a bowed leaf and how much, a frame struck out of plumb, a closer arm bent, a finish scratched through. Say whether the opening still operates — latches, closes, swings — in your words. Do not say whether a rated opening still meets its label: quote what the tag reads, photograph it, and that call goes to whoever makes it." },
        { "h": "What it will take",
