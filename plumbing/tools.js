...
window.TOOLKIT_TOOLS = [
  ...
  },
  {
    name: "T&M Tag",
    href: "tm-tag.html",
    desc: "Not on your prints? Write the tag before you roll — who told you, why it's outside your contract, crew and material as counts, and what is NOT in this tag. Reads in the same order as the yellow copy so you're not writing the job twice. En español también.",
    chip: "#7A3F12",
  ...
  },
  {
    ...
    desc: "You need into a room somebody else locks. Send the ask that gets a yes on the first try — the night, the rooms, what you need open, who's coming, and the heads-up that stops a crew getting turned away at the door. It's an ask, not a booking, and it says so.",
    chip: "#B4560F",
