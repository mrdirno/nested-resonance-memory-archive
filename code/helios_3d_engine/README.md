...
**Current Version:** 0.5.0 (The Visionary)
...
3.  **Semantic Reasoning:** Uses Gemini Vision to understand *what* the object is, guiding the reconstruction process.
4.  **Generative Infusion:** Automatically fills objects with mathematical lattices (Gyroids) for strength and aesthetics.
