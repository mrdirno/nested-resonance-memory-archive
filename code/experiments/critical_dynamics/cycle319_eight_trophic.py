...
Purpose:
  Test eight-level food chain with high productivity.

Research Question:
  Can K=1200 support eight trophic levels?

Background:
  C318: K=1200 stabilizes seven levels (600-60-20-10-6-4-2)
  C319: Extend to eight levels (L7 = 1?)

Design:
  - 8 populations
  - K=1200 only (high productivity)
  - Compare seven- vs eight-trophic
...
CYCLE_ID = "C319"
CYCLE_NAME = "Eight-Trophic Chain"
MODE = "EIGHT_TROPHIC"

CYCLES = 30000
K = 1200

# Initial populations for K=1200
INITIAL_SEVEN = [600, 60, 20, 10, 6, 4, 2]
INITIAL_EIGHT = [600, 60, 20, 10, 6, 4, 2, 1]
...
PARAMS = [
    ...
    {"attack": 0.020, "h": 0.08, "e_con": 0.9, "e_gain": 1.6, "conv": 0.08}   # L7 omega
]

CONDITIONS = [
    {"name": "seven_trophic", "n_levels": 7, "initial": INITIAL_SEVEN},
...
def run_experiment(condition: dict, seed: int, cycles: int) -> dict:
    """Run eight-trophic experiment."""

    label = condition["name"]
    n_levels = condition["n_levels"]
    initial = condition["initial"]

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c319_{label}_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 319: EIGHT-TROPHIC CHAIN")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c319_eight_trophic_results.json"
