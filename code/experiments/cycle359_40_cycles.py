...
Purpose:
  Fill transition curve between 30 and 50 cycles.

Background:
  C356: 30 cycles - 45% survival
  C355: 50 cycles - 80% survival
  C359: 40 cycles - test midpoint
...
CYCLE_ID = "C359"
CYCLE_NAME = "40-Cycle K Decline"
MODE = "40_CYCLE_DECLINE"
...
SEEDS = list(range(5160, 5180))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run 40-cycle decline experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c359_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 359: 40-CYCLE K DECLINE")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c359_40_cycles_results.json"
