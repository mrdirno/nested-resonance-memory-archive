#!/usr/bin/env python3
"""
CYCLE 362: 0.75× ATTACK RATE - 40 CYCLES
...
CYCLE_ID = "C362"
CYCLE_NAME = "0.75x Attack Rate 40 Cycles"
MODE = "075_ATTACK_40"
...
BASE_PARAMS = [
    ...
    {"attack": 0.00225, "h": 0.02, "e_con": 0.3, "e_gain": 0.5, "conv": 0.3},
    {"attack": 0.00375, "h": 0.03, "e_con": 0.4, "e_gain": 0.6, "conv": 0.25},
    {"attack": 0.006, "h": 0.04, "e_con": 0.5, "e_gain": 0.8, "conv": 0.2},
    {"attack": 0.009, "h": 0.05, "e_con": 0.6, "e_gain": 1.0, "conv": 0.15},
    {"attack": 0.01125, "h": 0.06, "e_con": 0.7, "e_gain": 1.2, "conv": 0.12},
    {"attack": 0.0135, "h": 0.07, "e_con": 0.8, "e_gain": 1.4, "conv": 0.10}
]

SEEDS = list(range(5220, 5240))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run 0.75× attack rate experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c362_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 362: 0.75× ATTACK RATE - 40 CYCLES")
    ...
    print(f"Attack rates: 0.75× baseline")
    print("=" * 80)
    print()
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c362_075attack_40cycles_results.json"
