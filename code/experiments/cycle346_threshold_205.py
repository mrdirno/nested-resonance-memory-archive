#!/usr/bin/env python3
"""
CYCLE 346: THRESHOLD TEST K=205
...
Purpose:
  Pinpoint exact critical K threshold between 200 and 210.

Background:
  C340: K=600→200 - 0% survival
  C345: K=600→210 - 90% survival
  C346: K=600→205 - exact midpoint
"""
...
CYCLE_ID = "C346"
CYCLE_NAME = "Threshold Test K=205"
MODE = "THRESHOLD_205"
...
def run_experiment(seed: int, cycles: int) -> dict:
    ...
    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c346_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 346: THRESHOLD TEST K=205")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c346_threshold_205_results.json"
