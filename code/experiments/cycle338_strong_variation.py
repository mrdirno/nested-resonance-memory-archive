#!/usr/bin/env python3
"""
CYCLE 338: STRONG ENVIRONMENTAL VARIATION
...
Purpose:
  Test food web response to strong environmental variation.

Research Question:
  At what amplitude does environmental buffering break down?

Background:
  C337: K ± 200 (33%) - buffered (85% coexist)
  C338: K ± 400 (67%) - breakdown expected

Design:
  - K oscillates: 200 to 1000
  - K_mean = 600, K_amplitude = 400
  - Period = 5000 cycles
  - 20 seeds
...
CYCLE_ID = "C338"
CYCLE_NAME = "Strong Environmental Variation"
MODE = "STRONG_VAR"

CYCLES = 30000
K_MEAN = 600
K_AMPLITUDE = 400  # K varies from 200 to 1000
PERIOD = 5000
...
SEEDS = list(range(4500, 4520))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run strong variation experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c338_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 338: STRONG ENVIRONMENTAL VARIATION")
    ...
    print(f"K oscillates: {K_MEAN} ± {K_AMPLITUDE} (200-1000)")
    print("=" * 80)
    print()
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c338_strong_variation_results.json"
