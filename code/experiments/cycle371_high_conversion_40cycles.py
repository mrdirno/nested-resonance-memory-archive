#!/usr/bin/env python3
"""
CYCLE 371: HIGH CONVERSION EFFICIENCY - 40 CYCLES
...
Purpose:
  Test conversion efficiency sensitivity at 40 cycles.

Background:
  C359: 40 cycles, baseline - 50% survival
  C371: 40 cycles, 1.5× conversion efficiency

Hypothesis:
  Higher conversion → more predator reproduction → better tracking

Design:
  - K declines from 600 to 200 over 40 cycles
  - Conversion efficiency: 1.5× baseline
  - 20 seeds
"""
...
CYCLE_ID = "C371"
CYCLE_NAME = "High Conversion 40 Cycles"
MODE = "HIGH_CONV_40"
...
SEEDS = list(range(5400, 5420))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run high conversion efficiency experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c371_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 371: HIGH CONVERSION EFFICIENCY - 40 CYCLES")
    ...
    print(f"Conversion efficiency: 1.5× baseline")
    print("=" * 80)
    print()
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c371_high_conversion_40cycles_results.json"
