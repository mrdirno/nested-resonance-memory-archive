...
Purpose:
  Find inflection point between 20 and 30 cycles.

Background:
  C357: 20 cycles - 25% survival
  C356: 30 cycles - 45% survival
  C358: 25 cycles - test midpoint

Design:
  - K declines from 600 to 200 over 25 cycles
  - Rate: 16 K/cycle
  - 20 seeds
"""
...
CYCLE_ID = "C358"
CYCLE_NAME = "25-Cycle K Decline"
MODE = "25_CYCLE_DECLINE"
...
SEEDS = list(range(5140, 5160))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run 25-cycle decline experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c358_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 358: 25-CYCLE K DECLINE")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c358_25_cycles_results.json"
