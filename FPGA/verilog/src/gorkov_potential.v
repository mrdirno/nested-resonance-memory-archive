/*
 * HELIOS PHYSICS ENGINE (Gate 14.2)
 * Verilog implementation of Gorkov Potential Calculation
 * Target: Generic FPGA (Synthesizable)
 *
 * Upgrade Cycle 2385: Integrated Sine LUT for Real-Time Calculation.
 */
...
module gorkov_potential #(
    ...
    // Sine LUT (Generated by lut_gen.py)
        ...
        if (!rst_n) begin
            ...
            case(state)
                ...
                CALC: begin
                    ...
                    // Cosine(x) = Sine(x + pi/2). With 1024 steps, pi/2 is 256.
                    sum_real <= sum_real + sin_lut[(lut_idx + 256) % 1024];
