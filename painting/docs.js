  ...
  "docs": [
    {
      ...
      "halt": "Only if there is no statement of who directed the work to proceed — without the direction, this is a condition report, and the no-paint note already exists for that. And if what he was told to coat over is old paint nobody's tested, this is the wrong document: that holds until the owner's test clears it — it goes on the no-paint note, never coated under direction.",
      "facts": [
