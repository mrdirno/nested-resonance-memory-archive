...
from src.tsf.data import (
    ObservationalData,
    DiscoveredPattern,
    RefutationResult,
    QuantificationMetrics,
)
from src.tsf.errors import (
    DataLoadError,
...
def _discover_principle_card(
    ...
    try:
        ...
        if pc_id == "PC001":
            from src.tsf.pc001_nrm_population_dynamics import load_pc001
            pc = load_pc001()
        elif pc_id == "PC002":
        ...
        try:
            from src.tsf.teg_adapter import TEGAdapter
