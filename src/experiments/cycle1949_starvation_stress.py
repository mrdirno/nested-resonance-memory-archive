...
def run_experiment():
    print("MOG ONLINE: Cycle 1949 - The Starvation Stress")
    ...
    for cycle in range(CYCLES):
        ...
        for agent in agents:
            ...
            # Apply Physics
            # evolve() usually subtracts 0.01 * dt. We override by manually updating energy.
            agent.update_phase(delta_t=1.0) # Just phase
        ...
        for cluster in new_clusters:
            ...
            # REMOVE constituents from active list (they are inside the cluster)
            # Correct logic: 'agents' contains [singles, existing_clusters, new_clusters, constituents_of_new]
            # We need to filter out constituents_of_new.
