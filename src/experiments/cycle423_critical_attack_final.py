#!/usr/bin/env python3
"""
CYCLE 423: CRITICAL ATTACK FINAL BOUND
...
Purpose:
  Locate final critical attack boundary.

Background:
  At 0.7421875× + 2.5× conv: 100%
  At 0.75× + 2.5× conv: 80%

  C423: 0.74609375× + 2.5× - exact boundary
...
CYCLE_ID = "C423"
CYCLE_NAME = "Critical Attack Final"
MODE = "CRITICAL_ATTACK_FIN"
...
# 0.74609375× attack + 2.5× conversion
BASE_PARAMS = [
    {"f": 0.1, "e_con": 0.2, "e_rech": 0.4},
    {"attack": 0.00223828125, "h": 0.02, "e_con": 0.3, "e_gain": 0.5, "conv": 0.75},
    {"attack": 0.00373046875, "h": 0.03, "e_con": 0.4, "e_gain": 0.6, "conv": 0.625},
    {"attack": 0.00596875, "h": 0.04, "e_con": 0.5, "e_gain": 0.8, "conv": 0.5},
    {"attack": 0.008953125, "h": 0.05, "e_con": 0.6, "e_gain": 1.0, "conv": 0.375},
    {"attack": 0.01119140625, "h": 0.06, "e_con": 0.7, "e_gain": 1.2, "conv": 0.3},
    {"attack": 0.01342969, "h": 0.07, "e_con": 0.8, "e_gain": 1.4, "conv": 0.25}
]

SEEDS = list(range(6440, 6460))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run critical attack final bound experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c423_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 423: CRITICAL ATTACK FINAL BOUND")
    ...
    print(f"Attack: 0.74609375×, Conversion: 2.5×")
    print("=" * 80)
    print()
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c423_critical_attack_final_results.json"
