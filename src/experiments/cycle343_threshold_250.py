#!/usr/bin/env python3
"""
CYCLE 343: THRESHOLD TEST K=250
...
Purpose:
  Narrow critical K threshold between 200 and 300.

Background:
  C340: K=600→200 - 0% survival
  C342: K=600→300 - 85% survival
  C343: K=600→250 - test midpoint
"""
...
CYCLE_ID = "C343"
CYCLE_NAME = "Threshold Test K=250"
MODE = "THRESHOLD_250"
...
def run_experiment(seed: int, cycles: int) -> dict:
    ...
    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c343_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 343: THRESHOLD TEST K=250")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c343_threshold_250_results.json"
