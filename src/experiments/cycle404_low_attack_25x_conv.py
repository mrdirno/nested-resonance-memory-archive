#!/usr/bin/env python3
"""
CYCLE 404: LOW ATTACK + 2.5× CONVERSION - 40 CYCLES
...
Purpose:
  Test if overshoot exists at 0.5× attack.
...
Background:
  ...
  C404: 2.5× conv - overshoot or stable?
...
def run_experiment(seed: int, cycles: int) -> dict:
    ...
    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c404_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 404: LOW ATTACK + 2.5× CONVERSION - 40 CYCLES")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c404_low_attack_25x_conv_results.json"
