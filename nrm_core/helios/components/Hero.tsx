                    ...
                    >
                        <div className="space-y-4">
                            ...
                            <p className="text-xl text-muted-foreground max-w-lg">
                                The Temporal Stewardship Framework is active. Monitor reality coherence, discover principles, and steer the timeline.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-8 pt-8 border-t">
                            <div>
                                ...
                                <div className="text-sm text-muted-foreground">Principles Discovered</div>
                            </div>
                            <div>
                                <div className="text-2xl font-bold">100%</div>
                                <div className="text-sm text-muted-foreground">Reality Anchor</div>
                            </div>
                            <div>
                                <div className="text-2xl font-bold">Active</div>
                                <div className="text-sm text-muted-foreground">Helios Status</div>
                            </div>
                        </div>
                    </motion.div>
                        ...
                        <div className="relative bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-8 border">
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4 pt-4">
                                    <div className="h-20 bg-gradient-to-br from-purple-100 to-blue-100 dark:from-purple-900 dark:to-blue-900 rounded-lg flex items-center justify-center">
                                        <span className="text-2xl">🌌</span>
                                    </div>
                                    <div className="h-20 bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-blue-900 dark:to-indigo-900 rounded-lg flex items-center justify-center">
                                        <span className="text-2xl">⏳</span>
                                    </div>
                                </div>
                            </div>
