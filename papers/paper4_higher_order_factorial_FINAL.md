...
**Results:**
- **3-Way Interactions (C262):** **[C262_3WAY_INTERACTION]** (H1×H2×H5 super-synergy = +80.56)
...
|-----------|----|----|----|-----------------|--------------------|----------------|
| 000 | OFF | OFF | OFF | 12.61 | 13 | 13 |
| 100 | ON | OFF | OFF | 93.55 | 100 | 100 |
| 010 | OFF | ON | OFF | 94.70 | 100 | 100 |
| 001 | OFF | OFF | ON | 95.96 | 100 | 100 |
| 110 | ON | ON | OFF | 95.12 | 100 | 100 |
| 101 | ON | OFF | ON | 96.23 | 100 | 100 |
| 011 | OFF | ON | ON | 96.23 | 100 | 100 |
| 111 | ON | ON | ON | 96.55 | 100 | 100 |

#### 3.1.2 Main Effects and Pairwise Interactions

| Term | Effect | Classification |
|------|--------|----------------|
| H1 (Pooling) | +80.94 | **[C262_H1_CLASS]** |
| H2 (Sources) | +82.09 | **[C262_H2_CLASS]** |
| H5 (Recovery) | **[C262_H5_EFFECT]** | **[C262_H5_CLASS]** |
| H1×H2 | -80.52 | **[C262_H1H2_CLASS]** |
| H1×H5 | -80.67 | **[C262_H1H5_CLASS]** |
| H2×H5 | -81.82 | **[C262_H2H5_CLASS]** |
...
**Evidence:**
1. **Pairwise insufficient:** Observed 111 (C262) deviates from pairwise prediction by +80.56
2. **Higher-order necessary:** 3-way term explains **[C262_VARIANCE_EXPLAINED]**% of residual variance
3. **Scale invariance:** Pattern persists at 4-way level (+0.00 deviation)
...
**RQ1 Answer:** Yes, 3-way interactions exist. The H1×H2×H5 combination exhibits super-synergy of +80.56, indicating emergent amplification beyond pairwise predictions.
...
| 3-way interactions | Not tested | +80.56 (H1×H2×H5) |
| 4-way interactions | Not tested | +0.00 (full) |
...
**Prediction 2 (Non-Additivity):** ✅ Validated. Higher-order terms are non-zero (+80.56, +0.00).
...
2. **Super-synergy is measurable.** Observed deviations from pairwise predictions: +80.56 (3-way), +0.00 (4-way).
