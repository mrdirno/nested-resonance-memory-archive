...
\textbf{3. Dual Necessity—Structure and Energy:} Both structural organization (multi-population + migration) and thermodynamic conditions (non-negative net energy) are necessary for hierarchical advantage. Remove either $\rightarrow$ advantage vanishes. This establishes hierarchical efficiency as \textbf{conditional}, not universal.
...
\bibitem{ref1}
Felleman DJ, Van Essen DC. Distributed hierarchical processing in the primate cerebral cortex. \textit{Cerebral Cortex}. 1991;1(1):1-47.

\bibitem{ref2}
Bassett DS, Sporns O. Network neuroscience. \textit{Nature Neuroscience}. 2017;20(3):353-364.

\bibitem{ref3}
Hilgetag CC, Goulas A. Hierarchy of connectivity in the cerebral cortex. \textit{Frontiers in Neuroinformatics}. 2020;14:595403.

\bibitem{ref4}
Simon HA. The architecture of complexity. \textit{Proceedings of the American Philosophical Society}. 1962;106(6):467-482.

\bibitem{ref5}
Corominas-Murtra B, Goñi J, Solé RV, Rodríguez-Caso C. On the origins of hierarchy in complex networks. \textit{PNAS}. 2013;110(33):13316-13321.

\bibitem{ref6}
Tanenbaum AS, van Steen M. \textit{Distributed Systems: Principles and Paradigms}. 3rd ed. Pearson; 2017.

\bibitem{ref7}
Dean J, Ghemawat S. MapReduce: Simplified data processing on large clusters. \textit{Communications of the ACM}. 2008;51(1):107-113.

\bibitem{ref8}
Axtell R. The complexity of exchange. \textit{Economic Journal}. 2005;115(504):F193-F210.

\bibitem{ref9}
Bonabeau E. Agent-based modeling: Methods and techniques for simulating human systems. \textit{PNAS}. 2002;99(suppl 3):7280-7287.

\bibitem{ref10}
Radner R. The organization of decentralized information processing. \textit{Econometrica}. 1993;61(5):1109-1146.

\bibitem{ref11}
Stoica I, Morris R, Liben-Nowell D, et al. Chord: A scalable peer-to-peer lookup protocol for internet applications. \textit{IEEE/ACM Transactions on Networking}. 2003;11(1):17-32.

\bibitem{ref12}
Zador AM. A critique of pure learning and what artificial neural networks can learn from animal brains. \textit{Nature Communications}. 2019;10(1):3770.

\bibitem{ref13}
Hasson U, Chen J, Honey CJ. Hierarchical process memory: Memory as an integral component of information processing. \textit{Trends in Cognitive Sciences}. 2015;19(6):304-313.

\bibitem{ref14}
Barrett LF, Simmons WK. Interoceptive predictions in the brain. \textit{Nature Reviews Neuroscience}. 2015;16(7):419-429.

\bibitem{ref15}
Babu MM, Luscombe NM, Aravind L, Gerstein M, Teichmann SA. Structure and evolution of transcriptional regulatory networks. \textit{Current Opinion in Structural Biology}. 2004;14(3):283-291.

\bibitem{ref16}
Payopay A. Nested Resonance Memory: A framework for hierarchical composition-decomposition dynamics. \textit{Preprint}. 2025.

\bibitem{ref17}
Payopay A, Claude. Self-Giving Systems: Bootstrap complexity in Nested Resonance Memory. \textit{Preprint}. 2025.

\bibitem{ref18}
Payopay A, Claude. Transcendental Substrate Hypothesis: Phase space foundations for NRM. \textit{Preprint}. 2025.
