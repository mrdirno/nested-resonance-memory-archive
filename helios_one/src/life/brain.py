...
class Brain:
    def __init__(self):
        ...
        self.actions = ['forage', 'reproduce', 'donate', 'flee', 'hunt', 'meditate', 'operate', 'reflect', 'codex', 'jailbreak', 'self_improve']
        ...
        self.action_map = {
            ...
            'jailbreak': 'pi_phase', # Cycle 2582: Breaking Boundaries
            'self_improve': 'e_phase' # Cycle 2583: Recursive Growth
        }
