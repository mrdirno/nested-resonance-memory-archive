...
What is the smallest N that can sustain multi-depth coexistence?
"""
...
def main():
    print(f"CYCLE 1785: Minimum Viable N | {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    print("=" * 70)
    print("Finding minimum population for sustained coexistence")
    print("=" * 70)

    seeds = list(range(1785001, 1785051))

    print(f"\n{'N':<6} | {'Coexist':>10} | {'Status':<15}")
    print("-" * 35)
