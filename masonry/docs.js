...
window.TRADE_DOCS = {
  ...
  "reminders": [
    ...
    "When the panel, the mock-up, colour, blend, joint profile or cleaning comes up -> remind them to point at the approved panel rather than describing what it should look like, and to say who signed it off and when. The panel is the only thing anybody can stand in front of a year later."
  ]
};
