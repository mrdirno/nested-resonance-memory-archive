...
window.COMMONS_TIPS = [
  ...
  { id: "plant-the-flare", t: ["landscape"],
    n: "Set the flare at grade, not the top of the pot.",
    w: "The soil in the container is usually up over the root flare already, so plant it pot-top level and you've buried the trunk twice over. A buried flare rots and the tree dies slow, a year or two out, on your warranty, and nobody standing there at planting sees it coming. Find where the roots actually leave the trunk and set that at the dirt." },
  { id: "native-backfill", t: ["landscape"],
    n: "Backfill with what came out of the hole, not a bag of fluff.",
    w: "A clay hole packed with light amended mix is a bathtub — water runs in, the roots circle in the soft stuff and never push into the wall, and the plant drowns or blows over. The roots have to live in the native ground eventually, so make them start there. Break the spoil up, lose the rocks and the trash, and put it back." },
  { id: "tease-the-roots", t: ["landscape"],
    n: "Open the rootball up before it goes in the hole.",
    w: "A plant that's been in the pot too long keeps growing in the exact circle the pot taught it, right on into the ground, and strangles itself years later. Score the sides, pull the bottom apart, cut the roots that are already wrapping. It feels like damage and it's the opposite — you're the only chance it gets to grow straight out." },
  { id: "stake-only-if", t: ["landscape"],
    n: "Stake a tree only if it won't stand, and put the day you pull it on the calendar.",
    w: "A trunk held rigid never learns to hold itself, and the ties nobody came back for girdle it right where they sit. If it stands on its own rootball, leave it. If it doesn't, tie it low and loose enough to sway — and the stake is temporary the way nothing on a jobsite is unless somebody wrote down when it comes out." },
  { id: "water-to-settle", t: ["landscape"],
    n: "The first watering is to collapse the air pockets, not to hit a number.",
    w: "Backfill goes in with voids all through it, and a root touching air is a dead root by next week no matter what the controller says. Water the hole in as you fill it so the soil flows around the roots and closes every gap. A plant lost to a dry pocket looks exactly like a plant that was fine — right up until it isn't." },
  { id: "protect-the-keepers", t: ["landscape"],
    n: "Fence the trees that are staying before the first machine rolls in.",
    w: "Grade changes and traffic inside the dripline pack the soil the roots breathe through, and the tree the whole design is built around dies three years later with nobody tying it to the summer you drove a skid across its feet. The fence goes at the dripline, not the trunk, and it goes up before the dirt crew, not after somebody notices." },
  { id: "mulch-off-the-trunk", t: ["landscape"],
    n: "Keep the mulch off the stem — a pile against the bark is a slow kill, not a finish.",
    w: "Mulch heaped up the trunk holds water on bark that's built to stay dry, and rot, disease and voles all move into that ring. It looks tidy on the walkthrough and it's the thing that quietly takes the plant out. Pull it back to a flat ring so you can still see the flare you were careful to leave at grade." },
  { id: "grade-drains", t: ["landscape"],
    n: "Shape every bed to shed water, and never toward the building.",
    w: "The final grade is yours, and a bed that ponds against a foundation is a callback with somebody else's name on the damage and yours on the shovel. Crown the beds so water leaves, carry it to where the plan drains, and check it with a hose before the mulch hides the shape. Water finds the low spot you left the day it rains, not the day you're standing there." },
  { id: "dont-dig-wet-clay", t: ["landscape"],
    n: "Don't dig or plant a clay hole when it's wet enough to shine.",
    w: "A spade in wet clay smears the wall into a slick, sealed skin the roots can't cross and water can't leave — you've dug a glazed pot in the ground. If the dirt ribbons and shines off the blade, the hole waits for it to dry back. A day of patience beats a bed of plants sitting in sealed holes you have to come back and open." },
