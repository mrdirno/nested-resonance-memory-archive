...
/**
 * Standalone config for THE SPEED proof (a clip running at its own rate).
 *
 ...
 *
 * SERIAL, one worker. Every assertion is a measurement of which decoded frame a
 * seek landed on, and parallel workers on one machine contend for exactly the
 * decoder that makes those frames mean anything.
 */
