...
| Candidate C3722 — publication pending | Temporary audition → explicit Keep/Replace, a horizontal twelve-template library and numbered kept layers; four original CPU-rendered 3D families. These are internal native-art layers, not global Studio photo/video overlays. |
