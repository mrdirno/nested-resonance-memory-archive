...
- **C3721 — MUSIC TRAVELS WITH THE PROJECT (2026-09-07), local checks passed; publication pending:** manual `.collage` saves now preserve original soundtrack bytes/MIME/name, SHA-256 and authored mute/level/trim/source-fade. Direct restore preserves motion and retires monitor/solo/audition; malformed media/settings fail before adoption and stale Open candidates release their URLs. Video clips still return as frames; SVG/recovery do not carry music. This increment is not yet published. [Release and boundaries](C3721_RELEASE.md).
