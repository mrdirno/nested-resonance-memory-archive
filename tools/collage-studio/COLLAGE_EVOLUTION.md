...
- **September 14 steady-feedback candidate:** resumes the measured C3724 notice-driven canvas jump. Independent review, typecheck/build, 46 final built browser cases and four complete MP4 decodes passed; deployment/live gates pending. [Release and boundaries](STEADY_ART_ROOM_RELEASE.md).
