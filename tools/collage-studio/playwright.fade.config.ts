...
/**
 * Standalone config for THE FADE proof (the take's ends stop hard-cutting).
 *
 ...
 *
 * SERIAL, one worker: F1/F2 drives TWO full offline renders in one page so the
