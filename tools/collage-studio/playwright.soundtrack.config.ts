...
/**
 * Standalone config for THE SOUNDTRACK proof (music under the collage).
 *
 ...
 *
 * SERIAL, one worker: two of the three tests drive a full offline render, and
 * parallel renders on one machine contend for the decoder the measurement is
 * about.
 */
export default defineConfig({
  testDir: './tests/e2e',
  testMatch: /soundtrack\.spec\.ts$/,
  timeout: 420_000,
  workers: 1,
  use: {
