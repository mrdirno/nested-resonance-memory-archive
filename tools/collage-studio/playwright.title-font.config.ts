...
/**
 * Standalone config for THE TITLE FONT proof (the caption's typeface).
 *
...
export default defineConfig({
  ...
  // the port takes the WHOLE suite green against a stranger. See globalSetup.
  globalSetup: './tests/globalSetup.ts',
  testDir: './tests/e2e',
  testMatch: /title-font\.spec\.ts$/,
  timeout: 180_000,
  use: {
