#!/usr/bin/env python3
"""
CYCLE 379: LOW ATTACK + 2.0× CONVERSION - 40 CYCLES
...
Purpose:
  Test if 0.75× attack is also optimal at higher conversion.

Background:
  C373: 1.0× attack + 2.0× conv - 70%
  C376: 0.75× attack + 1.5× conv - 90%
  C379: 0.75× attack + 2.0× conv - expect >70%?
...
SEEDS = list(range(5560, 5580))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run low attack + 2.0× conversion experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c379_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 379: LOW ATTACK + 2.0× CONVERSION - 40 CYCLES")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c379_low_attack_2x_conv_results.json"
