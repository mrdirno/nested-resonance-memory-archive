#!/usr/bin/env python3
"""
CYCLE 426: 0.7× ATTACK AT 2.5× CONVERSION
...
Purpose:
  Test if U-shaped profile exists at lower attack.

Background:
  At 0.75× + 2.5× conv: 80% (minimum)
  Prediction: Lower attack should reduce overshoot

  C426: 0.7× + 2.5× - less severe overshoot?
...
SEEDS = list(range(6500, 6520))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run 0.7× attack at 2.5× conversion experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c426_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 426: 0.7× ATTACK AT 2.5× CONVERSION")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c426_07x_at_25x_conv_results.json"
