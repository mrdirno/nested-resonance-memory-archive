#!/usr/bin/env python3
"""
CYCLE 412: STABLE REGION AT 2.0× CONVERSION
...
Purpose:
  Confirm stable region at 2.0× conversion.

Background:
  At 2.5× conversion: 0.625× = 100% (stable)
  At 2.0× conversion: 0.5× = 100%

  C412: 0.625× + 2.0× - stable at lower conv?
...
CYCLE_ID = "C412"
CYCLE_NAME = "Stable Region 2x Conv"
MODE = "STABLE_2XCONV"
...
# 0.625× attack + 2.0× conversion
BASE_PARAMS = [
    {"f": 0.1, "e_con": 0.2, "e_rech": 0.4},
    {"attack": 0.001875, "h": 0.02, "e_con": 0.3, "e_gain": 0.5, "conv": 0.6},
    {"attack": 0.003125, "h": 0.03, "e_con": 0.4, "e_gain": 0.6, "conv": 0.5},
    {"attack": 0.005, "h": 0.04, "e_con": 0.5, "e_gain": 0.8, "conv": 0.4},
    {"attack": 0.0075, "h": 0.05, "e_con": 0.6, "e_gain": 1.0, "conv": 0.3},
    {"attack": 0.009375, "h": 0.06, "e_con": 0.7, "e_gain": 1.2, "conv": 0.24},
    {"attack": 0.01125, "h": 0.07, "e_con": 0.8, "e_gain": 1.4, "conv": 0.2}
]

SEEDS = list(range(6220, 6240))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run stable region at 2.0× conversion experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c412_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 412: STABLE REGION AT 2.0× CONVERSION")
    ...
    print(f"Attack: 0.625×, Conversion: 2.0×")
    print("=" * 80)
    print()
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c412_stable_region_2x_conv_results.json"
