#!/usr/bin/env python3
"""
CYCLE 354: MINIMAL RAMP K DECLINE
...
Purpose:
  Test minimal ramp to find collapse transition.

Background:
  C340: Instant (0 cycles) - 0% survival
  C353: 100 cycles - 90% survival
  C354: 10 cycles - test near-instant

Design:
  - K declines from 600 to 200 over 10 cycles
  - Rate: 40 K/cycle
  - 20 seeds
"""
...
CYCLE_ID = "C354"
CYCLE_NAME = "Minimal Ramp K Decline"
MODE = "MINIMAL_RAMP"

CYCLES = 30000
K_START = 600
K_END = 200
DECLINE_CYCLES = 10  # Minimal ramp
...
SEEDS = list(range(5060, 5080))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run minimal ramp experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c354_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 354: MINIMAL RAMP K DECLINE")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c354_minimal_ramp_results.json"
