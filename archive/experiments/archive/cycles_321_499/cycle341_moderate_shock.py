#!/usr/bin/env python3
"""
CYCLE 341: MODERATE ENVIRONMENTAL SHOCK
...
Purpose:
  Test food web response to moderate resource reduction.

Research Question:
  Can the food web survive K reduction to 400?

Background:
  C340: K=600→200 - complete collapse
  C341: K=600→400 - moderate shock

Design:
  - K starts at 600
  - At cycle 15000, K drops to 400
...
CYCLE_ID = "C341"
CYCLE_NAME = "Moderate Environmental Shock"
MODE = "MODERATE_SHOCK"
...
SEEDS = list(range(4800, 4820))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run moderate shock experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c341_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 341: MODERATE ENVIRONMENTAL SHOCK")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c341_moderate_shock_results.json"
