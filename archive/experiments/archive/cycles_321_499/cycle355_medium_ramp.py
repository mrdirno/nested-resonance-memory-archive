#!/usr/bin/env python3
"""
CYCLE 355: MEDIUM RAMP K DECLINE
...
Purpose:
  Narrow critical rate between 10 and 100 cycles.

Background:
  C354: 10 cycles - 25% survival
  C353: 100 cycles - 90% survival
  C355: 50 cycles - test midpoint
...
CYCLE_ID = "C355"
CYCLE_NAME = "Medium Ramp K Decline"
MODE = "MEDIUM_RAMP"

CYCLES = 30000
K_START = 600
K_END = 200
DECLINE_CYCLES = 50  # Medium ramp
...
SEEDS = list(range(5080, 5100))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run medium ramp experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c355_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 355: MEDIUM RAMP K DECLINE")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c355_medium_ramp_results.json"
