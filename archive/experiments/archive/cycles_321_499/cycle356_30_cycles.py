...
Purpose:
  Narrow critical rate between 10 and 50 cycles.

Background:
  C354: 10 cycles - 25% survival
  C355: 50 cycles - 80% survival
  C356: 30 cycles - test midpoint
...
CYCLE_ID = "C356"
CYCLE_NAME = "30-Cycle K Decline"
MODE = "30_CYCLE_DECLINE"
...
SEEDS = list(range(5100, 5120))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run 30-cycle decline experiment."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c356_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 356: 30-CYCLE K DECLINE")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c356_30_cycles_results.json"
