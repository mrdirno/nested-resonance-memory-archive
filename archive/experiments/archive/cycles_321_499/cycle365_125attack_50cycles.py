#!/usr/bin/env python3
"""
CYCLE 365: 1.25× ATTACK RATE - 50 CYCLES
...
Purpose:
  Test parameter interaction - optimal attack at slow K decline.

Background:
  C355: 50 cycles, 1.0× attack - 80% survival
  C363: 40 cycles, 1.25× attack - 60% survival
  C364: 30 cycles, 1.25× attack - 50% survival
  C365: 50 cycles, 1.25× attack - test continuation

Design:
  - K declines from 600 to 200 over 50 cycles
  - Rate: 8 K/cycle
...
CYCLE_ID = "C365"
CYCLE_NAME = "1.25x Attack Rate 50 Cycles"
MODE = "125_ATTACK_50"
...
SEEDS = list(range(5280, 5300))


def run_experiment(seed: int, cycles: int) -> dict:
    """Run 1.25× attack at 50 cycles."""

    n_levels = 7

    db_path = f"/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c365_seed{seed}.db"
...
def main():
    print("=" * 80)
    print(f"CYCLE 365: 1.25× ATTACK RATE - 50 CYCLES")
    ...
    output_path = "/Volumes/dual/DUALITY-ZERO-V2/experiments/results/c365_125attack_50cycles_results.json"
