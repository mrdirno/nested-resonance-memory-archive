...
* **Memory-test falsification:** Static profiles and radialized recorded meshes expose an estimator confound. This is a result about the instrument, not a verdict on NRM. [Audit](analysis/2026-09-02_cross_epoch_memory_preregistered.md)
